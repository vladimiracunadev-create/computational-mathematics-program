# Evaluación — Embeddings como espacios vectoriales
...
| Implementación y verificación | 25 % | ejecuta `embeddings`, interpreta sus salidas y comprueba al menos un invariante |
