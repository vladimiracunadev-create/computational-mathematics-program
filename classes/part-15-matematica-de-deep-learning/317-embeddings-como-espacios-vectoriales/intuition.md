# Intuición — Embeddings como espacios vectoriales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Embeddings como espacios vectoriales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `embeddings`: embeddings: geometría del significado y similitud coseno.
