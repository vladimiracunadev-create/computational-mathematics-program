# Teoría — Embeddings como espacios vectoriales

## Definición operativa

En esta clase, **Embeddings como espacios vectoriales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`embeddings`) devuelve 9 valores. Varios de ellos
