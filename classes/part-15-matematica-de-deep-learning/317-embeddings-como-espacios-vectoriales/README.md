...
- [Mikolov, T. et al. *Efficient estimation of word representations in vector space*, 2013](https://arxiv.org/abs/1301.3781) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1301.3781` verificado en DataCite (2026-08-19).
- [Bolukbasi, T. et al. *Man is to computer programmer as woman is to homemaker?*, NeurIPS, 2016](https://arxiv.org/abs/1607.06520) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1607.06520` verificado en DataCite (2026-08-19).
