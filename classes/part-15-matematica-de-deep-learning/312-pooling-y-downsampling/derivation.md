# Derivación y razonamiento — Pooling y downsampling
...
Construye una derivación de 5 a 10 pasos relacionada con **Pooling y downsampling**.
...
La demostración `pooling` recorre este mismo razonamiento en código.
