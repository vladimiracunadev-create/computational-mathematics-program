# Teoría — Pooling y downsampling

## Definición operativa

En esta clase, **Pooling y downsampling** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`pooling`) devuelve 9 valores. Varios de ellos
