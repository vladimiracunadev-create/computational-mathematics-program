# Intuición — Pooling y downsampling

## La pregunta antes de la fórmula

¿Qué problema resuelve **Pooling y downsampling**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `pooling`: max y average pooling: reducción con y sin pérdida de posición.
