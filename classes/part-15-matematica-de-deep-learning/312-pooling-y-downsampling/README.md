...
3. Ejecutar y modificar `lab.py`, que corre la demostración `pooling` del motor de la parte.
...
- `avg_pool_2x2`
- `salida_shape`
- `reduccion_de_elementos`
- `parametros_aprendidos`
- `gradiente_del_max_pool`
- `gradiente_del_avg_pool`
- `invarianza`
