...
- [Simonyan, K.; Zisserman, A. *Very Deep Convolutional Networks (VGG)*, ICLR, 2015](https://arxiv.org/abs/1409.1556) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1409.1556` verificado en DataCite (2026-08-19).
- [Luo, W. et al. *Understanding the effective receptive field*, NeurIPS, 2016](https://arxiv.org/abs/1701.04128) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1701.04128` verificado en DataCite (2026-08-19).
