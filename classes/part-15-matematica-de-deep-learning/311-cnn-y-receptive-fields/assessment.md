# Evaluación — CNN y receptive fields
...
| Implementación y verificación | 25 % | ejecuta `cnn_receptive_fields`, interpreta sus salidas y comprueba al menos un invariante |
