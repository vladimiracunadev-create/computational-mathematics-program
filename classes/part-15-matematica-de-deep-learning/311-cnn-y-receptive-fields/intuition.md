# Intuición — CNN y receptive fields

## La pregunta antes de la fórmula

¿Qué problema resuelve **CNN y receptive fields**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `cnn_receptive_fields`: campo receptivo: cómo crece al apilar capas.
