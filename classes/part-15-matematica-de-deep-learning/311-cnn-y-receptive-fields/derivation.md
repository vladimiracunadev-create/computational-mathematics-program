# Derivación y razonamiento — CNN y receptive fields
...
Construye una derivación de 5 a 10 pasos relacionada con **CNN y receptive fields**.
...
La demostración `cnn_receptive_fields` recorre este mismo razonamiento en código.
