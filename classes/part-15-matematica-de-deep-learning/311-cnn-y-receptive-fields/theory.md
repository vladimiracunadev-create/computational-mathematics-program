# Teoría — CNN y receptive fields

## Definición operativa

En esta clase, **CNN y receptive fields** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`cnn_receptive_fields`) devuelve 8 valores. Varios de ellos
