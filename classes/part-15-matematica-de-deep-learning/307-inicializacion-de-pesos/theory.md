# Teoría — Inicialización de pesos

## Definición operativa

En esta clase, **Inicialización de pesos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`weight_initialization`) devuelve 10 valores. Varios de ellos
