# Derivación y razonamiento — Inicialización de pesos
...
Construye una derivación de 5 a 10 pasos relacionada con **Inicialización de pesos**.
...
La demostración `weight_initialization` recorre este mismo razonamiento en código.
