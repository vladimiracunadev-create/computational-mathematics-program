# Intuición — Inicialización de pesos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Inicialización de pesos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `weight_initialization`: xavier y he: controlar la varianza de las activaciones capa a capa.
