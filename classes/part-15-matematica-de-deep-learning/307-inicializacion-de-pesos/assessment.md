# Evaluación — Inicialización de pesos
...
| Implementación y verificación | 25 % | ejecuta `weight_initialization`, interpreta sus salidas y comprueba al menos un invariante |
