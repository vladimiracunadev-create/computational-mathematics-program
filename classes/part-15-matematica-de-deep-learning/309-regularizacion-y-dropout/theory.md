# Teoría — Regularización y dropout

## Definición operativa

En esta clase, **Regularización y dropout** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`dropout_regularization`) devuelve 9 valores. Varios de ellos
