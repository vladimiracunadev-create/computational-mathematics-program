# Evaluación — Regularización y dropout
...
| Implementación y verificación | 25 % | ejecuta `dropout_regularization`, interpreta sus salidas y comprueba al menos un invariante |
