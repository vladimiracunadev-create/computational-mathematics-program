# Intuición — Regularización y dropout

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regularización y dropout**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `dropout_regularization`: dropout: ruido en entrenamiento, escalado coherente en inferencia.
