...
**Motor:** `computational_math.engines.part15` · demostración `dropout_regularization`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `dropout_regularization` del motor de la parte.
...
- `neuronas`
- `probabilidad_de_apagado`
- `media_sin_dropout`
- `media_con_inverted_dropout`
- `la_esperanza_se_conserva`
- `varianza_introducida`
- `en_inferencia`
- `interpretacion`
- `no_combinar_a_ciegas_con_batchnorm`
