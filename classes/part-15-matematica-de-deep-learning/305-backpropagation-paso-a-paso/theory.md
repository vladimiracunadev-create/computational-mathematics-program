# Teoría — Backpropagation paso a paso

## Definición operativa

En esta clase, **Backpropagation paso a paso** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`backpropagation`) devuelve 13 valores. Varios de ellos
