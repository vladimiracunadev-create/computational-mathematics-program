# Intuición — Backpropagation paso a paso

## La pregunta antes de la fórmula

¿Qué problema resuelve **Backpropagation paso a paso**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `backpropagation`: backpropagation paso a paso sobre una red 2-2-1.
