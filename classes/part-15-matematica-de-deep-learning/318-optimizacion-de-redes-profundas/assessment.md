# Evaluación — Optimización de redes profundas
...
| Implementación y verificación | 25 % | ejecuta `deep_optimization`, interpreta sus salidas y comprueba al menos un invariante |
