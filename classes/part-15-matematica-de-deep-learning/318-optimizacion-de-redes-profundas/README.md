...
- [Goyal, P. et al. *Accurate, Large Minibatch SGD*, 2017](https://arxiv.org/abs/1706.02677) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1706.02677` verificado en DataCite (2026-08-19).
- [Loshchilov, I.; Hutter, F. *SGDR: Stochastic Gradient Descent with Warm Restarts*, ICLR, 2017](https://arxiv.org/abs/1608.03983) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1608.03983` verificado en DataCite (2026-08-19).
