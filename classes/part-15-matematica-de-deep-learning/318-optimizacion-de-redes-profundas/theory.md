# Teoría — Optimización de redes profundas

## Definición operativa

En esta clase, **Optimización de redes profundas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`deep_optimization`) devuelve 9 valores. Varios de ellos
