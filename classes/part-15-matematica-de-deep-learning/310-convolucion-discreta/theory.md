# Teoría — Convolución discreta

## Definición operativa

En esta clase, **Convolución discreta** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`discrete_convolution`) devuelve 11 valores. Varios de ellos
