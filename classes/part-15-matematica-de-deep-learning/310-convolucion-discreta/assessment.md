# Evaluación — Convolución discreta
...
| Implementación y verificación | 25 % | ejecuta `discrete_convolution`, interpreta sus salidas y comprueba al menos un invariante |
