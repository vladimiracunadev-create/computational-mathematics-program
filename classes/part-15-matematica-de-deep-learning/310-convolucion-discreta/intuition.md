# Intuición — Convolución discreta

## La pregunta antes de la fórmula

¿Qué problema resuelve **Convolución discreta**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `discrete_convolution`: convolución 2d con padding y stride: el cálculo de la forma de salida.
