# Intuición — MLP como composición de funciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **MLP como composición de funciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `mlp`: mlp resolviendo xor: la capa oculta crea una representación separable.
