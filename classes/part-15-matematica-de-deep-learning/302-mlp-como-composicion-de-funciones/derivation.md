# Derivación y razonamiento — MLP como composición de funciones
...
Construye una derivación de 5 a 10 pasos relacionada con **MLP como composición de funciones**.
...
La demostración `mlp` recorre este mismo razonamiento en código.
