# Teoría — MLP como composición de funciones

## Definición operativa

En esta clase, **MLP como composición de funciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`mlp`) devuelve 7 valores. Varios de ellos
