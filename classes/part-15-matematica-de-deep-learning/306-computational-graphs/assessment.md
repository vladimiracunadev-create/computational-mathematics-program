# Evaluación — Computational graphs
...
| Implementación y verificación | 25 % | ejecuta `computational_graphs`, interpreta sus salidas y comprueba al menos un invariante |
