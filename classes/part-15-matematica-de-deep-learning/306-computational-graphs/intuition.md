# Intuición — Computational graphs

## La pregunta antes de la fórmula

¿Qué problema resuelve **Computational graphs**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `computational_graphs`: el grafo de cómputo y la acumulación de gradientes en nodos reutilizados.
