# Derivación y razonamiento — Computational graphs
...
Construye una derivación de 5 a 10 pasos relacionada con **Computational graphs**.
...
La demostración `computational_graphs` recorre este mismo razonamiento en código.
