# Teoría — Computational graphs

## Definición operativa

En esta clase, **Computational graphs** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`computational_graphs`) devuelve 11 valores. Varios de ellos
