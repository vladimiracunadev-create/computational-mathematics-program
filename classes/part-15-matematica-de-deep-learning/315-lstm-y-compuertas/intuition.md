# Intuición — LSTM y compuertas

## La pregunta antes de la fórmula

¿Qué problema resuelve **LSTM y compuertas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `lstm`: lstm: la celda mantiene un camino aditivo para el gradiente.
