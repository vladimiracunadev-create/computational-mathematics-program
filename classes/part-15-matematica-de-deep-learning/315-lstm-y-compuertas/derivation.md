# Derivación y razonamiento — LSTM y compuertas
...
Construye una derivación de 5 a 10 pasos relacionada con **LSTM y compuertas**.
...
La demostración `lstm` recorre este mismo razonamiento en código.
