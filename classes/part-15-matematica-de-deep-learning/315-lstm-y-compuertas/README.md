...
- [Hochreiter, S.; Schmidhuber, J. *Long Short-Term Memory*, Neural Computation, 1997](https://doi.org/10.1162/neco.1997.9.8.1735) — Deep learning: el tema de esta clase · DOI `10.1162/neco.1997.9.8.1735` verificado en Crossref (2026-08-19).
- [Olah, C. *Understanding LSTM Networks*, 2015](https://colah.github.io/posts/2015-08-Understanding-LSTMs/) — Deep learning: el tema de esta clase · URL de la fuente primaria comprobada en colah.github.io (2026-08-19).
