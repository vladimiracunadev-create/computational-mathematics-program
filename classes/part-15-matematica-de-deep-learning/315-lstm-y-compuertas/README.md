...
3. Ejecutar y modificar `lab.py`, que corre la demostración `lstm` del motor de la parte.
...
- `puertas`
- `traza`
- `bf_inicializado_en_1`
- `camino_del_gradiente`
- `si_f≈1_el_gradiente_no_se_atenua`
