# Intuición — RNN y recurrencia

## La pregunta antes de la fórmula

¿Qué problema resuelve **RNN y recurrencia**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `rnn`: rnn: el estado oculto acumula historia con pesos compartidos.
