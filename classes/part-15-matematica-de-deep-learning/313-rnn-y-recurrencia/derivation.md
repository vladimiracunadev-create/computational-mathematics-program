# Derivación y razonamiento — RNN y recurrencia
...
Construye una derivación de 5 a 10 pasos relacionada con **RNN y recurrencia**.
...
La demostración `rnn` recorre este mismo razonamiento en código.
