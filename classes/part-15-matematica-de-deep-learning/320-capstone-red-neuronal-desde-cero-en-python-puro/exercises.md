# Ejercicios — Capstone: red neuronal desde cero en Python puro

## Básico

1. Define **Capstone: red neuronal desde cero en Python puro** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 14 salidas.
...
7. Conecta esta clase con visión, lenguaje, audio, series temporales y sistemas de recomendación mediante un caso concreto y realista.
