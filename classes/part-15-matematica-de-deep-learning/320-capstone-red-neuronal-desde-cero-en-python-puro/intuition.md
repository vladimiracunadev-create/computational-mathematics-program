# Intuición — Capstone: red neuronal desde cero en Python puro

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: red neuronal desde cero en Python puro**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Matemática de Deep Learning**. Perceptrón, MLP, activaciones, pérdidas, backpropagation paso a paso, grafos de cómputo, inicialización, normalización, convolución, recurrencia y embeddings.
...
El laboratorio ejecuta `capstone_neural_network`: capstone: red neuronal completa desde cero, entrenada y evaluada.
