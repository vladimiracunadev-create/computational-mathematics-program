"""Laboratorio 320 — Capstone: red neuronal desde cero en Python puro.
...
DEMO = "capstone_neural_network"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 320 — Capstone: red neuronal desde cero en Python puro")
