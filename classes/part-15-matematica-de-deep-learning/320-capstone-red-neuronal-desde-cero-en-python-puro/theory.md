# Teoría — Capstone: red neuronal desde cero en Python puro

## Definición operativa

En esta clase, **Capstone: red neuronal desde cero en Python puro** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_neural_network`) devuelve 14 valores. Varios de ellos
