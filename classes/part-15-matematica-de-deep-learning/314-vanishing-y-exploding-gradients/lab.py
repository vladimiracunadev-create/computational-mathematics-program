"""Laboratorio 314 — Vanishing y exploding gradients.

Parte 15 · Matemática de Deep Learning
Motor: computational_math.engines.part15 · demostración `vanishing_exploding`
...
from computational_math.engines import part15 as motor  # noqa: E402

DEMO = "vanishing_exploding"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 314 — Vanishing y exploding gradients")
    print(f"Parte 15 · Matemática de Deep Learning")
