# Teoría — Vanishing y exploding gradients

## Definición operativa

En esta clase, **Vanishing y exploding gradients** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`vanishing_exploding`) devuelve 8 valores. Varios de ellos
