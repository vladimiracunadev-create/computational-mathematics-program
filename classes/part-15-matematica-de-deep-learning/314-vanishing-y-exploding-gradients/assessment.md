# Evaluación — Vanishing y exploding gradients
...
| Implementación y verificación | 25 % | ejecuta `vanishing_exploding`, interpreta sus salidas y comprueba al menos un invariante |
