# Intuición — Vanishing y exploding gradients

## La pregunta antes de la fórmula

¿Qué problema resuelve **Vanishing y exploding gradients**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `vanishing_exploding`: gradientes que se desvanecen o explotan: un producto de derivadas.
