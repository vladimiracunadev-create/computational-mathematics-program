# Derivación y razonamiento — Vanishing y exploding gradients
...
Construye una derivación de 5 a 10 pasos relacionada con **Vanishing y exploding gradients**.
...
La demostración `vanishing_exploding` recorre este mismo razonamiento en código.
