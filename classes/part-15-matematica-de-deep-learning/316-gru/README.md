...
- [Cho, K. et al. *Learning phrase representations using RNN encoder-decoder*, EMNLP, 2014](https://arxiv.org/abs/1406.1078) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1406.1078` verificado en DataCite (2026-08-19).
- [Chung, J. et al. *Empirical evaluation of gated recurrent neural networks*, 2014](https://arxiv.org/abs/1412.3555) — Deep learning: el tema de esta clase · DOI `10.48550/arxiv.1412.3555` verificado en DataCite (2026-08-19).
