# Teoría — Perceptrón y separabilidad

## Definición operativa

En esta clase, **Perceptrón y separabilidad** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`perceptron`) devuelve 9 valores. Varios de ellos
