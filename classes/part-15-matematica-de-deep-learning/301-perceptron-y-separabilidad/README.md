...
- [Rosenblatt, F. *The perceptron: a probabilistic model*, Psychological Review, 1958](https://doi.org/10.1037/h0042519) — Deep learning: el tema de esta clase · DOI `10.1037/h0042519` verificado en Crossref (2026-08-19).
- [Minsky, M.; Papert, S. *Perceptrons*, MIT Press, 1969](https://mitpress.mit.edu/9780262534772/perceptrons/) — Deep learning: el tema de esta clase · ISBN-13 `9780262534772` verificado en International ISBN Agency (2026-08-19).
