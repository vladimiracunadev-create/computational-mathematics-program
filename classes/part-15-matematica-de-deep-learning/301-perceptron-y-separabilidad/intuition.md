# Intuición — Perceptrón y separabilidad

## La pregunta antes de la fórmula

¿Qué problema resuelve **Perceptrón y separabilidad**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `perceptron`: perceptrón: converge si y solo si los datos son linealmente separables.
