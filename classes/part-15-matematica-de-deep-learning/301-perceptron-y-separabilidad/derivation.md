# Derivación y razonamiento — Perceptrón y separabilidad
...
Construye una derivación de 5 a 10 pasos relacionada con **Perceptrón y separabilidad**.
...
La demostración `perceptron` recorre este mismo razonamiento en código.
