# Derivación y razonamiento — Autodiff con PyTorch/JAX
...
Construye una derivación de 5 a 10 pasos relacionada con **Autodiff con PyTorch/JAX**.
...
La demostración `autodiff_frameworks` recorre este mismo razonamiento en código.
