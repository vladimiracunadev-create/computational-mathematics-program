# Intuición — Autodiff con PyTorch/JAX

## La pregunta antes de la fórmula

¿Qué problema resuelve **Autodiff con PyTorch/JAX**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `autodiff_frameworks`: nuestro var frente a pytorch/jax: mismo principio, distinta escala.
