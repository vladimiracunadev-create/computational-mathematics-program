# Teoría — Autodiff con PyTorch/JAX

## Definición operativa

En esta clase, **Autodiff con PyTorch/JAX** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`autodiff_frameworks`) devuelve 9 valores. Varios de ellos
