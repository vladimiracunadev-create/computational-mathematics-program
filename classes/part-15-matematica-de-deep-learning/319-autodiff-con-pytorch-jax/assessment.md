# Evaluación — Autodiff con PyTorch/JAX
...
| Implementación y verificación | 25 % | ejecuta `autodiff_frameworks`, interpreta sus salidas y comprueba al menos un invariante |
