# Intuición — Funciones de activación

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones de activación**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `activations`: activaciones y sus derivadas: dónde se saturan.
