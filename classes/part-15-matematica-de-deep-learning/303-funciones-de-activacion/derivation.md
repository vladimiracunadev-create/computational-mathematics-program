# Derivación y razonamiento — Funciones de activación
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones de activación**.
...
La demostración `activations` recorre este mismo razonamiento en código.
