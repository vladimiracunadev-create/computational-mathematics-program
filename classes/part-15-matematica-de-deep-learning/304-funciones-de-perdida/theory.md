# Teoría — Funciones de pérdida

## Definición operativa

En esta clase, **Funciones de pérdida** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`loss_functions`) devuelve 11 valores. Varios de ellos
