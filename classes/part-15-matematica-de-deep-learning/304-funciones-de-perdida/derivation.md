# Derivación y razonamiento — Funciones de pérdida
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones de pérdida**.
...
La demostración `loss_functions` recorre este mismo razonamiento en código.
