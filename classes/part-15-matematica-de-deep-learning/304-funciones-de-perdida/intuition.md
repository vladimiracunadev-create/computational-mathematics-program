# Intuición — Funciones de pérdida

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones de pérdida**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `loss_functions`: mse, mae, huber y cross-entropy frente a un valor atípico.
