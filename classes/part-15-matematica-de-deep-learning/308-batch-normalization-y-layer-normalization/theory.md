# Teoría — Batch normalization y layer normalization

## Definición operativa

En esta clase, **Batch normalization y layer normalization** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`normalization`) devuelve 10 valores. Varios de ellos
