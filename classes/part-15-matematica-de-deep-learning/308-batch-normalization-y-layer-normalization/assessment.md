# Evaluación — Batch normalization y layer normalization
...
| Implementación y verificación | 25 % | ejecuta `normalization`, interpreta sus salidas y comprueba al menos un invariante |
