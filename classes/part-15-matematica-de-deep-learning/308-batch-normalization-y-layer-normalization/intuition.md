# Intuición — Batch normalization y layer normalization

## La pregunta antes de la fórmula

¿Qué problema resuelve **Batch normalization y layer normalization**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `normalization`: batch norm y layer norm: qué eje se normaliza.
