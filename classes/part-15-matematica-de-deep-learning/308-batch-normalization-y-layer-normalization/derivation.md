# Derivación y razonamiento — Batch normalization y layer normalization
...
Construye una derivación de 5 a 10 pasos relacionada con **Batch normalization y layer normalization**.
...
La demostración `normalization` recorre este mismo razonamiento en código.
