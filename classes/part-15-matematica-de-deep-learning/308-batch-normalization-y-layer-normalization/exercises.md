# Ejercicios — Batch normalization y layer normalization

## Básico

1. Define **Batch normalization y layer normalization** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 10 salidas.
