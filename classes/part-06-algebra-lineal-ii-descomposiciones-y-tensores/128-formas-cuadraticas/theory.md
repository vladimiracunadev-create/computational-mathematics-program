# Teoría — Formas cuadráticas

## Definición operativa

En esta clase, **Formas cuadráticas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`quadratic_forms`) devuelve 7 valores. Varios de ellos
