# Derivación y razonamiento — Formas cuadráticas
...
Construye una derivación de 5 a 10 pasos relacionada con **Formas cuadráticas**.
...
La demostración `quadratic_forms` recorre este mismo razonamiento en código.
