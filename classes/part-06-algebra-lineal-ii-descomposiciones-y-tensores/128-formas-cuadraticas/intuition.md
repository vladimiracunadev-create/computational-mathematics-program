# Intuición — Formas cuadráticas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Formas cuadráticas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `quadratic_forms`: la forma cuadrática xᵀax y sus curvas de nivel.
