# Teoría — SVD desde la intuición

## Definición operativa

En esta clase, **SVD desde la intuición** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`svd_intuition`) devuelve 8 valores. Varios de ellos
