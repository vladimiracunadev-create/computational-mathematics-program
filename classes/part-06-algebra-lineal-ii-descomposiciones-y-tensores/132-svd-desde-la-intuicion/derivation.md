# Derivación y razonamiento — SVD desde la intuición
...
Construye una derivación de 5 a 10 pasos relacionada con **SVD desde la intuición**.
...
La demostración `svd_intuition` recorre este mismo razonamiento en código.
