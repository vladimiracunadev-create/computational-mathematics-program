# Intuición — SVD desde la intuición

## La pregunta antes de la fórmula

¿Qué problema resuelve **SVD desde la intuición**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `svd_intuition`: svd: rotar, escalar, rotar. existe siempre.
