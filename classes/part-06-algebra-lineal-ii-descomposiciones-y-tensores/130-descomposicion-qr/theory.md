# Teoría — Descomposición QR

## Definición operativa

En esta clase, **Descomposición QR** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`qr_decomposition`) devuelve 7 valores. Varios de ellos
