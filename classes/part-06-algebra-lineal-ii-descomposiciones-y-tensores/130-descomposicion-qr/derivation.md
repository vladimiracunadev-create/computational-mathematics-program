# Derivación y razonamiento — Descomposición QR
...
Construye una derivación de 5 a 10 pasos relacionada con **Descomposición QR**.
...
La demostración `qr_decomposition` recorre este mismo razonamiento en código.
