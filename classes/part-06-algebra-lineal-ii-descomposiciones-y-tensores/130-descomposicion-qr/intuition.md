# Intuición — Descomposición QR

## La pregunta antes de la fórmula

¿Qué problema resuelve **Descomposición QR**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `qr_decomposition`: qr por gram-schmidt: base ortonormal del espacio columna.
