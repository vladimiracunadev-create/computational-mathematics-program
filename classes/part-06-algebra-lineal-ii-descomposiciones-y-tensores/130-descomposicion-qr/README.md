...
**Motor:** `computational_math.engines.part06` · demostración `qr_decomposition`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `qr_decomposition` del motor de la parte.
