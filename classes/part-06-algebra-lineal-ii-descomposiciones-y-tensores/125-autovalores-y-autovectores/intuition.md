# Intuición — Autovalores y autovectores

## La pregunta antes de la fórmula

¿Qué problema resuelve **Autovalores y autovectores**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `eigen`: autovalores: direcciones que la transformación solo escala.
