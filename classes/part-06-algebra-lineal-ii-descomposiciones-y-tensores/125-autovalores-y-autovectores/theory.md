# Teoría — Autovalores y autovectores

## Definición operativa

En esta clase, **Autovalores y autovectores** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`eigen`) devuelve 8 valores. Varios de ellos
