...
- [Van Loan, C. *The ubiquitous Kronecker product*. J. Comput. Appl. Math., 2000](https://www.sciencedirect.com/science/article/pii/S0377042700003939) — Álgebra lineal: el tema de esta clase · URL de la fuente primaria, pendiente de resolver.
- [Martens, J.; Grosse, R. *Optimizing Neural Networks with Kronecker-factored Approximate Curvature*. ICML, 2015](https://arxiv.org/abs/1503.05671) — Álgebra lineal: el tema de esta clase · DOI `10.48550/arxiv.1503.05671` verificado en DataCite (2026-08-19).
