# Teoría — Producto de Kronecker

## Definición operativa

En esta clase, **Producto de Kronecker** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`kronecker`) devuelve 7 valores. Varios de ellos
