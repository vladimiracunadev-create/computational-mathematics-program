# Intuición — Producto de Kronecker

## La pregunta antes de la fórmula

¿Qué problema resuelve **Producto de Kronecker**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `kronecker`: producto de kronecker: estructura en bloques.
