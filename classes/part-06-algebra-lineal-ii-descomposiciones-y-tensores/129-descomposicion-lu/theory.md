# Teoría — Descomposición LU

## Definición operativa

En esta clase, **Descomposición LU** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`lu_decomposition`) devuelve 8 valores. Varios de ellos
