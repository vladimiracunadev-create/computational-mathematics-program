# Intuición — Descomposición LU

## La pregunta antes de la fórmula

¿Qué problema resuelve **Descomposición LU**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `lu_decomposition`: lu: factorizar una vez, resolver muchos sistemas.
