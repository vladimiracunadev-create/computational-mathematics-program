# Derivación y razonamiento — Descomposición LU
...
Construye una derivación de 5 a 10 pasos relacionada con **Descomposición LU**.
...
La demostración `lu_decomposition` recorre este mismo razonamiento en código.
