# Derivación y razonamiento — Mínimos cuadrados lineales
...
Construye una derivación de 5 a 10 pasos relacionada con **Mínimos cuadrados lineales**.
...
La demostración `least_squares` recorre este mismo razonamiento en código.
