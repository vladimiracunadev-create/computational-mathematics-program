# Intuición — Mínimos cuadrados lineales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Mínimos cuadrados lineales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `least_squares`: mínimos cuadrados por ecuaciones normales.
