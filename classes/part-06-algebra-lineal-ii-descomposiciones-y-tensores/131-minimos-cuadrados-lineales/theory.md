# Teoría — Mínimos cuadrados lineales

## Definición operativa

En esta clase, **Mínimos cuadrados lineales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`least_squares`) devuelve 7 valores. Varios de ellos
