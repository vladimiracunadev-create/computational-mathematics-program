...
**Motor:** `computational_math.engines.part06` · demostración `least_squares`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `least_squares` del motor de la parte.
...
- `residuos`
- `SSE`
- `residuo_ortogonal_a_las_columnas`
