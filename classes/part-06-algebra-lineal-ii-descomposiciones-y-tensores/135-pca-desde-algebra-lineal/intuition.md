# Intuición — PCA desde álgebra lineal

## La pregunta antes de la fórmula

¿Qué problema resuelve **PCA desde álgebra lineal**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `pca`: pca como autodescomposición de la covarianza.
