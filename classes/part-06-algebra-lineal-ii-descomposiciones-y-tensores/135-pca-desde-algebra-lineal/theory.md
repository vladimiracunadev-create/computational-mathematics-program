# Teoría — PCA desde álgebra lineal

## Definición operativa

En esta clase, **PCA desde álgebra lineal** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`pca`) devuelve 8 valores. Varios de ellos
