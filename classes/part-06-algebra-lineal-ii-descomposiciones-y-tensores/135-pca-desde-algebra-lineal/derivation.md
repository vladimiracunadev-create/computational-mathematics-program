# Derivación y razonamiento — PCA desde álgebra lineal
...
Construye una derivación de 5 a 10 pasos relacionada con **PCA desde álgebra lineal**.
...
La demostración `pca` recorre este mismo razonamiento en código.
