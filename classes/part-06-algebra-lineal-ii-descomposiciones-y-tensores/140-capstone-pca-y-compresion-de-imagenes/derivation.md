# Derivación y razonamiento — Capstone: PCA y compresión de imágenes
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: PCA y compresión de imágenes**.
...
La demostración `capstone_pca_compression` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part06.py` y responde:
