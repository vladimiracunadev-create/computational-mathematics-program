# Evaluación — Capstone: PCA y compresión de imágenes
...
| Implementación y verificación | 25 % | ejecuta `capstone_pca_compression`, interpreta sus salidas y comprueba al menos un invariante |
