# Teoría — Capstone: PCA y compresión de imágenes

## Definición operativa

En esta clase, **Capstone: PCA y compresión de imágenes** se trata como un objeto con tres capas
separadas:
...
## Ideas centrales de la parte 06
...
El laboratorio (`capstone_pca_compression`) devuelve 6 valores. Varios de ellos
