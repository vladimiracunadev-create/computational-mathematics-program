"""Laboratorio 140 — Capstone: PCA y compresión de imágenes.

Parte 06 · Álgebra lineal II: descomposiciones y tensores
Motor: computational_math.engines.part06 · demostración `capstone_pca_compression`
