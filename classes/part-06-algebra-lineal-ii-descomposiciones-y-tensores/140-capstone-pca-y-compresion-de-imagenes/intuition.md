# Intuición — Capstone: PCA y compresión de imágenes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: PCA y compresión de imágenes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `capstone_pca_compression`: capstone: comprimir una matriz con svd y medir la pérdida.
