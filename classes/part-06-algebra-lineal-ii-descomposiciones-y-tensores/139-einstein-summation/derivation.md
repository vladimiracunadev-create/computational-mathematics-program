# Derivación y razonamiento — Einstein summation
...
Construye una derivación de 5 a 10 pasos relacionada con **Einstein summation**.
...
La demostración `einsum` recorre este mismo razonamiento en código.
