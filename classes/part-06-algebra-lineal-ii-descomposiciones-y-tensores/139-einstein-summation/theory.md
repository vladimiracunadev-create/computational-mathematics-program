# Teoría — Einstein summation

## Definición operativa

En esta clase, **Einstein summation** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`einsum`) devuelve 6 valores. Varios de ellos
