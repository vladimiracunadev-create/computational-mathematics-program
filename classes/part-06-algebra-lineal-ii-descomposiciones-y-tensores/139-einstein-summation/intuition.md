# Intuición — Einstein summation

## La pregunta antes de la fórmula

¿Qué problema resuelve **Einstein summation**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `einsum`: notación de einstein: índices repetidos se suman.
