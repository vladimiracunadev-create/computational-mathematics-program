# Teoría — Cambio de base

## Definición operativa

En esta clase, **Cambio de base** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`change_of_basis`) devuelve 6 valores. Varios de ellos
