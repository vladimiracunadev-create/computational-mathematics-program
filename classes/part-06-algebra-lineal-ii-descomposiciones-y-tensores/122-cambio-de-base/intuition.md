# Intuición — Cambio de base

## La pregunta antes de la fórmula

¿Qué problema resuelve **Cambio de base**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `change_of_basis`: matriz de cambio de base y su inversa.
