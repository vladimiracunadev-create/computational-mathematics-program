...
**Motor:** `computational_math.engines.part06` · demostración `change_of_basis`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `change_of_basis` del motor de la parte.
