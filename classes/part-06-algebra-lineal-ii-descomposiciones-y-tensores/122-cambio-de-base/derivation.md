# Derivación y razonamiento — Cambio de base
...
Construye una derivación de 5 a 10 pasos relacionada con **Cambio de base**.
...
La demostración `change_of_basis` recorre este mismo razonamiento en código.
