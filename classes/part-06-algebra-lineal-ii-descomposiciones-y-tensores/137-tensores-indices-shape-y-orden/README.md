...
**Motor:** `computational_math.engines.part06` · demostración `tensors`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `tensors` del motor de la parte.
...
- `elemento_[1][0][1]`
- `indice_lineal`
- `un_batch_de_imagenes_es_orden_4`
