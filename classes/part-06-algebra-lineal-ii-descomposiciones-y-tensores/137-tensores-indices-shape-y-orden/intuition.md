# Intuición — Tensores: índices, shape y orden

## La pregunta antes de la fórmula

¿Qué problema resuelve **Tensores: índices, shape y orden**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `tensors`: orden, shape y reordenamiento de índices.
