# Teoría — Tensores: índices, shape y orden

## Definición operativa

En esta clase, **Tensores: índices, shape y orden** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`tensors`) devuelve 8 valores. Varios de ellos
