# Derivación y razonamiento — Tensores: índices, shape y orden
...
Construye una derivación de 5 a 10 pasos relacionada con **Tensores: índices, shape y orden**.
...
La demostración `tensors` recorre este mismo razonamiento en código.
