# Intuición — Núcleo e imagen

## La pregunta antes de la fórmula

¿Qué problema resuelve **Núcleo e imagen**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `kernel_image`: núcleo, imagen y teorema del rango-nulidad.
