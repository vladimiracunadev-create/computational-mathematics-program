# Derivación y razonamiento — Núcleo e imagen
...
Construye una derivación de 5 a 10 pasos relacionada con **Núcleo e imagen**.
...
La demostración `kernel_image` recorre este mismo razonamiento en código.
