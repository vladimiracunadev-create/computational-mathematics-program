# Teoría — Núcleo e imagen

## Definición operativa

En esta clase, **Núcleo e imagen** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`kernel_image`) devuelve 8 valores. Varios de ellos
