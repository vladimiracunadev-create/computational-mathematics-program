# Derivación y razonamiento — Bases y coordenadas
...
Construye una derivación de 5 a 10 pasos relacionada con **Bases y coordenadas**.
...
La demostración `bases_coordinates` recorre este mismo razonamiento en código.
