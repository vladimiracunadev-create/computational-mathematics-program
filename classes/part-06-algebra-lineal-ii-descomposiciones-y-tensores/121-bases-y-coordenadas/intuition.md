# Intuición — Bases y coordenadas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Bases y coordenadas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bases_coordinates`: las coordenadas dependen de la base elegida.
