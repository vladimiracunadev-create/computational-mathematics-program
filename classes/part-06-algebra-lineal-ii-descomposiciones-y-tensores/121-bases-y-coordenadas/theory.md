# Teoría — Bases y coordenadas

## Definición operativa

En esta clase, **Bases y coordenadas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`bases_coordinates`) devuelve 7 valores. Varios de ellos
