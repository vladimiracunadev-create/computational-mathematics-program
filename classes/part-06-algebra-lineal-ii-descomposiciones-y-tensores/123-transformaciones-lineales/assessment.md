# Evaluación — Transformaciones lineales
...
| Implementación y verificación | 25 % | ejecuta `linear_transformations`, interpreta sus salidas y comprueba al menos un invariante |
