# Derivación y razonamiento — Transformaciones lineales
...
Construye una derivación de 5 a 10 pasos relacionada con **Transformaciones lineales**.
...
La demostración `linear_transformations` recorre este mismo razonamiento en código.
