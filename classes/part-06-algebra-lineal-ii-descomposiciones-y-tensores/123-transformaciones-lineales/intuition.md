# Intuición — Transformaciones lineales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Transformaciones lineales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_transformations`: una transformación lineal preserva sumas y escalados.
