...
En esta clase, **Transformaciones lineales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_transformations`) devuelve 8 valores. Varios de ellos
