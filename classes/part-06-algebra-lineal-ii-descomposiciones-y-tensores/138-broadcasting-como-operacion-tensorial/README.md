...
**Motor:** `computational_math.engines.part06` · demostración `broadcasting`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `broadcasting` del motor de la parte.
