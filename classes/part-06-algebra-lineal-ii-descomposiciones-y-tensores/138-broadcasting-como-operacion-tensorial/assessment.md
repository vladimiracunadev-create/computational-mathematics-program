# Evaluación — Broadcasting como operación tensorial
...
| Implementación y verificación | 25 % | ejecuta `broadcasting`, interpreta sus salidas y comprueba al menos un invariante |
