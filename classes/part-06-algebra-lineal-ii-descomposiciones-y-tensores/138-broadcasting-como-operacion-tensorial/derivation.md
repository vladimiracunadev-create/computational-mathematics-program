# Derivación y razonamiento — Broadcasting como operación tensorial
...
Construye una derivación de 5 a 10 pasos relacionada con **Broadcasting como operación tensorial**.
...
La demostración `broadcasting` recorre este mismo razonamiento en código.
