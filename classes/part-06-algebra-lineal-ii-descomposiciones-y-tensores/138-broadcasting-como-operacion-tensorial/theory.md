# Teoría — Broadcasting como operación tensorial

## Definición operativa

En esta clase, **Broadcasting como operación tensorial** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`broadcasting`) devuelve 8 valores. Varios de ellos
