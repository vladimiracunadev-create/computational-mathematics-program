# Ejercicios — Broadcasting como operación tensorial

## Básico

1. Define **Broadcasting como operación tensorial** con tus palabras y da un ejemplo válido y uno inválido.
...
7. Conecta esta clase con compresión, reducción de dimensionalidad, sistemas mal condicionados y motores de recomendación mediante un caso concreto y realista.
