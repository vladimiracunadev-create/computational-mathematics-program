# Intuición — Broadcasting como operación tensorial

## La pregunta antes de la fórmula

¿Qué problema resuelve **Broadcasting como operación tensorial**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `broadcasting`: broadcasting: reglas de compatibilidad de shapes.
