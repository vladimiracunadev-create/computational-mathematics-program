# Evaluación — Pseudoinversa de Moore-Penrose
...
| Implementación y verificación | 25 % | ejecuta `pseudoinverse`, interpreta sus salidas y comprueba al menos un invariante |
