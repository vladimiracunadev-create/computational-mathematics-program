...
**Motor:** `computational_math.engines.part06` · demostración `pseudoinverse`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `pseudoinverse` del motor de la parte.
