# Intuición — Pseudoinversa de Moore-Penrose

## La pregunta antes de la fórmula

¿Qué problema resuelve **Pseudoinversa de Moore-Penrose**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `pseudoinverse`: pseudoinversa de moore-penrose para sistemas sobredeterminados.
