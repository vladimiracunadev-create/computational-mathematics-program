# Teoría — SVD y compresión

## Definición operativa

En esta clase, **SVD y compresión** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`svd_compression`) devuelve 7 valores. Varios de ellos
