# Teoría — Matrices positivas definidas

## Definición operativa

En esta clase, **Matrices positivas definidas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`positive_definite`) devuelve 8 valores. Varios de ellos
