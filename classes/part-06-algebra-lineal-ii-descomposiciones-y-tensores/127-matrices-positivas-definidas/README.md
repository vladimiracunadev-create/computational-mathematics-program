...
- [Boyd & Vandenberghe. *Convex Optimization*. Cambridge, 2004, apéndice A](https://web.stanford.edu/~boyd/cvxbook/) — Optimización: conexión declarada de esta parte · ISBN-13 `9780511804441` verificado en International ISBN Agency (2026-08-19).
- [Horn & Johnson. *Matrix Analysis*, 2ª ed., Cambridge, 2012](https://www.cambridge.org/core/books/matrix-analysis/8C8B0C4A0C8E4B9C0C0C0C0C0C0C0C0C) — Álgebra lineal: el tema de esta clase · ISBN-13 `9781283741392` verificado en International ISBN Agency (2026-08-19).
