# Evaluación — Matrices positivas definidas
...
| Implementación y verificación | 25 % | ejecuta `positive_definite`, interpreta sus salidas y comprueba al menos un invariante |
