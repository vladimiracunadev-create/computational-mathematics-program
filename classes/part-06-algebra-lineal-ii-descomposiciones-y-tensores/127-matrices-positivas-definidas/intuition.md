# Intuición — Matrices positivas definidas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Matrices positivas definidas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `positive_definite`: definida positiva: todos los autovalores positivos, xᵀax > 0.
