# Teoría — Diagonalización

## Definición operativa

En esta clase, **Diagonalización** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`diagonalization`) devuelve 7 valores. Varios de ellos
