...
**Motor:** `computational_math.engines.part06` · demostración `diagonalization`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `diagonalization` del motor de la parte.
