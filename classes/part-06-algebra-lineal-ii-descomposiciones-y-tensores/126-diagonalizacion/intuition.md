# Intuición — Diagonalización

## La pregunta antes de la fórmula

¿Qué problema resuelve **Diagonalización**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `diagonalization`: a = pdp⁻¹: la base donde la transformación solo escala.
