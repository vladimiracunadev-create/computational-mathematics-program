# Derivación y razonamiento — Diagonalización
...
Construye una derivación de 5 a 10 pasos relacionada con **Diagonalización**.
...
La demostración `diagonalization` recorre este mismo razonamiento en código.
