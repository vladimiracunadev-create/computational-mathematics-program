# Intuición — Newton-Raphson

## La pregunta antes de la fórmula

¿Qué problema resuelve **Newton-Raphson**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `newton_raphson`: newton: convergencia cuadrática cerca de la raíz.
