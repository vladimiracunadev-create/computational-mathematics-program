# Teoría — Newton-Raphson

## Definición operativa

En esta clase, **Newton-Raphson** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`newton_raphson`) devuelve 8 valores. Varios de ellos
