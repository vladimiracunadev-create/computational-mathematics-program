# Derivación y razonamiento — Newton-Raphson
...
Construye una derivación de 5 a 10 pasos relacionada con **Newton-Raphson**.
...
La demostración `newton_raphson` recorre este mismo razonamiento en código.
