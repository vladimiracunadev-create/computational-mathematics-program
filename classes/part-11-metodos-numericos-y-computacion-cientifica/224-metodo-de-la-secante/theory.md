# Teoría — Método de la secante

## Definición operativa

En esta clase, **Método de la secante** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`secant`) devuelve 7 valores. Varios de ellos
