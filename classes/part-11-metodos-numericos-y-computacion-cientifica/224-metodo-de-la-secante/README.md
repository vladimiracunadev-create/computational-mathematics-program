...
- [Burden, R.; Faires, J. *Numerical Analysis*, 10ª ed., Cengage, 2015, cap. 2](https://www.cengage.com/) — *uso:* obra de referencia consultada en «Método de la secante».
- [Press, W. et al. *Numerical Recipes*, 3ª ed., Cambridge, 2007, cap. 9](https://numerical.recipes/) — *uso:* obra de referencia consultada en «Método de la secante».
