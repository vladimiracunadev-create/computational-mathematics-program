# Derivación y razonamiento — Método de la secante
...
Construye una derivación de 5 a 10 pasos relacionada con **Método de la secante**.
...
La demostración `secant` recorre este mismo razonamiento en código.
