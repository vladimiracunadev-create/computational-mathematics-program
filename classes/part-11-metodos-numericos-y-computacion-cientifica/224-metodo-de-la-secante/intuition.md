# Intuición — Método de la secante

## La pregunta antes de la fórmula

¿Qué problema resuelve **Método de la secante**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `secant`: secante: casi tan rápida como newton sin necesitar la derivada.
