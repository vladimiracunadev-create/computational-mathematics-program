# Intuición — Errores numéricos y convergencia

## La pregunta antes de la fórmula

¿Qué problema resuelve **Errores numéricos y convergencia**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `numerical_errors`: error de truncamiento frente a error de redondeo.
