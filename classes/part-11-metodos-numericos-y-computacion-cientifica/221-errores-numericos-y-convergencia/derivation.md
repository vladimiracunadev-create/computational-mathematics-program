# Derivación y razonamiento — Errores numéricos y convergencia
...
Construye una derivación de 5 a 10 pasos relacionada con **Errores numéricos y convergencia**.
...
La demostración `numerical_errors` recorre este mismo razonamiento en código.
