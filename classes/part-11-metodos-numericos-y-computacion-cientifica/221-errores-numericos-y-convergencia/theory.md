# Teoría — Errores numéricos y convergencia

## Definición operativa

En esta clase, **Errores numéricos y convergencia** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`numerical_errors`) devuelve 6 valores. Varios de ellos
