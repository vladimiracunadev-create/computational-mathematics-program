# Evaluación — Errores numéricos y convergencia
...
| Implementación y verificación | 25 % | ejecuta `numerical_errors`, interpreta sus salidas y comprueba al menos un invariante |
