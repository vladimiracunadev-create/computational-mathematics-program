# Intuición — Métodos iterativos y tolerancias

## La pregunta antes de la fórmula

¿Qué problema resuelve **Métodos iterativos y tolerancias**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `iterative_tolerances`: criterio de parada: absoluto, relativo y residuo.
