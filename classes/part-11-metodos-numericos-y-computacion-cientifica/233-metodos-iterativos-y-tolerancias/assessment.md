# Evaluación — Métodos iterativos y tolerancias
...
| Implementación y verificación | 25 % | ejecuta `iterative_tolerances`, interpreta sus salidas y comprueba al menos un invariante |
