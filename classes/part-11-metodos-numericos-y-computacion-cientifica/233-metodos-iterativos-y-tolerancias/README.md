...
**Motor:** `computational_math.engines.part11` · demostración `iterative_tolerances`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `iterative_tolerances` del motor de la parte.
...
- `informe`
- `iteraciones_hasta_1e-14`
- `solucion`
- `criterio_recomendado`
- `peligro_de_solo_absoluto`
- `siempre_declarar_max_iter`
