# Teoría — Métodos iterativos y tolerancias

## Definición operativa

En esta clase, **Métodos iterativos y tolerancias** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`iterative_tolerances`) devuelve 6 valores. Varios de ellos
