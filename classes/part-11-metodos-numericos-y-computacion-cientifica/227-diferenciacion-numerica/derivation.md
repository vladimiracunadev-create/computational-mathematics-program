# Derivación y razonamiento — Diferenciación numérica
...
Construye una derivación de 5 a 10 pasos relacionada con **Diferenciación numérica**.
...
La demostración `numerical_differentiation` recorre este mismo razonamiento en código.
