# Teoría — Diferenciación numérica

## Definición operativa

En esta clase, **Diferenciación numérica** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`numerical_differentiation`) devuelve 11 valores. Varios de ellos
