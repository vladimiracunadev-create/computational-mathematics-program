# Evaluación — Diferenciación numérica
...
| Implementación y verificación | 25 % | ejecuta `numerical_differentiation`, interpreta sus salidas y comprueba al menos un invariante |
