# Intuición — Diferenciación numérica

## La pregunta antes de la fórmula

¿Qué problema resuelve **Diferenciación numérica**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `numerical_differentiation`: fórmulas de diferencias y su orden de error.
