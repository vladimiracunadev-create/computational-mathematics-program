# Derivación y razonamiento — Bisección
...
Construye una derivación de 5 a 10 pasos relacionada con **Bisección**.
...
La demostración `bisection` recorre este mismo razonamiento en código.
