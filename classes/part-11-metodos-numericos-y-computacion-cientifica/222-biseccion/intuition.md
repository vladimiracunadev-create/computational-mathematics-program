...
¿Qué problema resuelve **Bisección**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bisection`: bisección: lenta pero garantizada si hay cambio de signo.
