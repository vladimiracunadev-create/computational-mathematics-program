# Evaluación — Interpolación de Lagrange
...
| Implementación y verificación | 25 % | ejecuta `lagrange_interpolation`, interpreta sus salidas y comprueba al menos un invariante |
