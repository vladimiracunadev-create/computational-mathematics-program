# Teoría — Interpolación de Lagrange

## Definición operativa

En esta clase, **Interpolación de Lagrange** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`lagrange_interpolation`) devuelve 5 valores. Varios de ellos
