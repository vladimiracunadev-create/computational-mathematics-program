# Intuición — Interpolación de Lagrange

## La pregunta antes de la fórmula

¿Qué problema resuelve **Interpolación de Lagrange**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `lagrange_interpolation`: interpolación de lagrange y el fenómeno de runge.
