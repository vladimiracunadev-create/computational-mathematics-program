...
**Motor:** `computational_math.engines.part11` · demostración `lagrange_interpolation`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `lagrange_interpolation` del motor de la parte.
