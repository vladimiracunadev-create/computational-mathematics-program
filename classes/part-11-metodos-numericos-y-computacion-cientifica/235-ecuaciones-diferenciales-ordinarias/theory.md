# Teoría — Ecuaciones diferenciales ordinarias

## Definición operativa

En esta clase, **Ecuaciones diferenciales ordinarias** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`odes`) devuelve 8 valores. Varios de ellos
