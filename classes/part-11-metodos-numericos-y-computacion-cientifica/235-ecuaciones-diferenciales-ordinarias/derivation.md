# Derivación y razonamiento — Ecuaciones diferenciales ordinarias
...
Construye una derivación de 5 a 10 pasos relacionada con **Ecuaciones diferenciales ordinarias**.
...
La demostración `odes` recorre este mismo razonamiento en código.
