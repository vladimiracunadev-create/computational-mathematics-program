# Intuición — Ecuaciones diferenciales ordinarias

## La pregunta antes de la fórmula

¿Qué problema resuelve **Ecuaciones diferenciales ordinarias**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `odes`: edo con solución analítica para medir el error de cada método.
