# Evaluación — Capstone: solver numérico con informe de error
...
| Implementación y verificación | 25 % | ejecuta `capstone_numerical_solver`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con simulación física o con IA |
...
5. ¿Dónde aparece este concepto en simulación física?
