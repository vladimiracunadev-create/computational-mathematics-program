# Teoría — Capstone: solver numérico con informe de error

## Definición operativa

En esta clase, **Capstone: solver numérico con informe de error** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_numerical_solver`) devuelve 9 valores. Varios de ellos
