# Ejercicios — Capstone: solver numérico con informe de error

## Básico

1. Define **Capstone: solver numérico con informe de error** con tus palabras y da un ejemplo válido y uno inválido.
