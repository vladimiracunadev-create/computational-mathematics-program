# Derivación y razonamiento — Capstone: solver numérico con informe de error
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: solver numérico con informe de error**.
...
La demostración `capstone_numerical_solver` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part11.py` y responde:
