# Intuición — Capstone: solver numérico con informe de error

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: solver numérico con informe de error**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `capstone_numerical_solver`: capstone: solver con informe de error y criterio de parada declarado.
