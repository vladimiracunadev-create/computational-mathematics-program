# Derivación y razonamiento — Mínimos cuadrados numéricos
...
Construye una derivación de 5 a 10 pasos relacionada con **Mínimos cuadrados numéricos**.
...
La demostración `numerical_least_squares` recorre este mismo razonamiento en código.
