# Evaluación — Mínimos cuadrados numéricos
...
| Implementación y verificación | 25 % | ejecuta `numerical_least_squares`, interpreta sus salidas y comprueba al menos un invariante |
