# Intuición — Mínimos cuadrados numéricos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Mínimos cuadrados numéricos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `numerical_least_squares`: mínimos cuadrados: ecuaciones normales frente a qr.
