# Teoría — Mínimos cuadrados numéricos

## Definición operativa

En esta clase, **Mínimos cuadrados numéricos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`numerical_least_squares`) devuelve 8 valores. Varios de ellos
