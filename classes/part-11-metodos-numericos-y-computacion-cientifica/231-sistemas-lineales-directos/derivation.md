# Derivación y razonamiento — Sistemas lineales directos
...
Construye una derivación de 5 a 10 pasos relacionada con **Sistemas lineales directos**.
...
La demostración `direct_linear_solvers` recorre este mismo razonamiento en código.
