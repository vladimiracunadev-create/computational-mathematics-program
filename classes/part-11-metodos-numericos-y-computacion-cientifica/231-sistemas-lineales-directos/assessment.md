# Evaluación — Sistemas lineales directos
...
| Implementación y verificación | 25 % | ejecuta `direct_linear_solvers`, interpreta sus salidas y comprueba al menos un invariante |
