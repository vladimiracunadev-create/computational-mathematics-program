# Teoría — Sistemas lineales directos

## Definición operativa

En esta clase, **Sistemas lineales directos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`direct_linear_solvers`) devuelve 10 valores. Varios de ellos
