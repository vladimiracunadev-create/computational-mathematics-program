# Intuición — Introducción a PDE y discretización

## La pregunta antes de la fórmula

¿Qué problema resuelve **Introducción a PDE y discretización**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `pde_discretization`: discretización de la ecuación del calor en 1d (esquema explícito).
