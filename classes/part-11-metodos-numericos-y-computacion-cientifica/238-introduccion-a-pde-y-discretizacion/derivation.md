# Derivación y razonamiento — Introducción a PDE y discretización
...
Construye una derivación de 5 a 10 pasos relacionada con **Introducción a PDE y discretización**.
...
La demostración `pde_discretization` recorre este mismo razonamiento en código.
