# Teoría — Introducción a PDE y discretización

## Definición operativa

En esta clase, **Introducción a PDE y discretización** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`pde_discretization`) devuelve 10 valores. Varios de ellos
