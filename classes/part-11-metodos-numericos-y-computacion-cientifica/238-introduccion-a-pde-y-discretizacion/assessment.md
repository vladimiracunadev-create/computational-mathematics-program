# Evaluación — Introducción a PDE y discretización
...
| Implementación y verificación | 25 % | ejecuta `pde_discretization`, interpreta sus salidas y comprueba al menos un invariante |
