...
- [LeVeque, R. *Finite Difference Methods for Ordinary and Partial Differential Equations*, SIAM, 2007](https://doi.org/10.1137/1.9780898717839) — Ecuaciones diferenciales y Métodos numéricos: el tema de esta clase · ISBN-13 `9780898717839` verificado en International ISBN Agency (2026-08-19).
- [Courant, R.; Friedrichs, K.; Lewy, H. *Über die partiellen Differenzengleichungen der mathematischen Physik*, 1928](https://doi.org/10.1007/BF01448839) — Ecuaciones diferenciales y Métodos numéricos: el tema de esta clase · DOI `10.1007/bf01448839` verificado en Crossref (2026-08-19).
