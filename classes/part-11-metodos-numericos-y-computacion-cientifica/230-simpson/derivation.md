# Derivación y razonamiento — Simpson
...
Construye una derivación de 5 a 10 pasos relacionada con **Simpson**.
...
La demostración `simpson_rule` recorre este mismo razonamiento en código.
