# Derivación y razonamiento — Cuadratura numérica
...
Construye una derivación de 5 a 10 pasos relacionada con **Cuadratura numérica**.
...
La demostración `quadrature` recorre este mismo razonamiento en código.
