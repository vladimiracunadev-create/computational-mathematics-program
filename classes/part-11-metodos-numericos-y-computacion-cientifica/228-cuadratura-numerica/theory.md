# Teoría — Cuadratura numérica

## Definición operativa

En esta clase, **Cuadratura numérica** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`quadrature`) devuelve 8 valores. Varios de ellos
