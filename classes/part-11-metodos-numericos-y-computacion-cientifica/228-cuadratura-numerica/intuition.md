# Intuición — Cuadratura numérica

## La pregunta antes de la fórmula

¿Qué problema resuelve **Cuadratura numérica**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `quadrature`: cuadratura gaussiana: máxima exactitud con mínimos nodos.
