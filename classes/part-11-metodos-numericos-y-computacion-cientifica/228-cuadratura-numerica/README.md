...
**Motor:** `computational_math.engines.part11` · demostración `quadrature`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `quadrature` del motor de la parte.
...
- `gauss_3_nodos`
- `error_gauss`
- `trapecio_3_subintervalos`
- `error_trapecio`
- `gauss_n_puntos_es_exacta_hasta_grado`
- `evaluaciones_usadas`
