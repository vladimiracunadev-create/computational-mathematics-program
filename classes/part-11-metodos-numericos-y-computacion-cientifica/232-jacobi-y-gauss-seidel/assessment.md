# Evaluación — Jacobi y Gauss-Seidel
...
| Implementación y verificación | 25 % | ejecuta `jacobi_gauss_seidel`, interpreta sus salidas y comprueba al menos un invariante |
