# Derivación y razonamiento — Jacobi y Gauss-Seidel
...
Construye una derivación de 5 a 10 pasos relacionada con **Jacobi y Gauss-Seidel**.
...
La demostración `jacobi_gauss_seidel` recorre este mismo razonamiento en código.
