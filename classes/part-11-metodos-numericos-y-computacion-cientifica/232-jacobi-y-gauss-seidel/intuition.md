# Intuición — Jacobi y Gauss-Seidel

## La pregunta antes de la fórmula

¿Qué problema resuelve **Jacobi y Gauss-Seidel**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `jacobi_gauss_seidel`: métodos iterativos sobre una matriz diagonalmente dominante.
