# Teoría — Jacobi y Gauss-Seidel

## Definición operativa

En esta clase, **Jacobi y Gauss-Seidel** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`jacobi_gauss_seidel`) devuelve 8 valores. Varios de ellos
