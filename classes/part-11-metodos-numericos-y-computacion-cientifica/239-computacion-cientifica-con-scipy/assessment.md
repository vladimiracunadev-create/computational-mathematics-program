# Evaluación — Computación científica con SciPy
...
| Implementación y verificación | 25 % | ejecuta `scientific_computing`, interpreta sus salidas y comprueba al menos un invariante |
