# Derivación y razonamiento — Computación científica con SciPy
...
Construye una derivación de 5 a 10 pasos relacionada con **Computación científica con SciPy**.
...
La demostración `scientific_computing` recorre este mismo razonamiento en código.
