# Intuición — Computación científica con SciPy

## La pregunta antes de la fórmula

¿Qué problema resuelve **Computación científica con SciPy**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `scientific_computing`: qué aporta scipy sobre una implementación propia.
