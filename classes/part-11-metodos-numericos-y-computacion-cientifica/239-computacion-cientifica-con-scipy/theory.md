# Teoría — Computación científica con SciPy

## Definición operativa

En esta clase, **Computación científica con SciPy** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`scientific_computing`) devuelve 6 valores. Varios de ellos
