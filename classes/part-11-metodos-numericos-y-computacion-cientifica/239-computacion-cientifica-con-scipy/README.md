...
**Motor:** `computational_math.engines.part11` · demostración `scientific_computing`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `scientific_computing` del motor de la parte.
...
- `version`
- `equivalencias`
- `por_que_implementar_a_mano`
- `por_que_usar_la_biblioteca`
- `este_motor_no_requiere_scipy`
