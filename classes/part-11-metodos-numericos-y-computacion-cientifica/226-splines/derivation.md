# Derivación y razonamiento — Splines
...
Construye una derivación de 5 a 10 pasos relacionada con **Splines**.
...
La demostración `splines` recorre este mismo razonamiento en código.
