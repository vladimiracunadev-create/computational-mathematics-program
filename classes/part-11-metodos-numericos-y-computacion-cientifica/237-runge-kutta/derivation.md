# Derivación y razonamiento — Runge-Kutta
...
Construye una derivación de 5 a 10 pasos relacionada con **Runge-Kutta**.
...
La demostración `runge_kutta` recorre este mismo razonamiento en código.
