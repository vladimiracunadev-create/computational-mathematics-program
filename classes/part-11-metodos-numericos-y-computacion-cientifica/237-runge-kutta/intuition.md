# Intuición — Runge-Kutta

## La pregunta antes de la fórmula

¿Qué problema resuelve **Runge-Kutta**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `runge_kutta`: rk4: cuatro evaluaciones por paso, error o(h⁴).
