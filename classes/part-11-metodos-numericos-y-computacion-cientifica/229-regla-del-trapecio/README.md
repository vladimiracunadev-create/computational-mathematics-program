...
**Motor:** `computational_math.engines.part11` · demostración `trapezoid_rule`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `trapezoid_rule` del motor de la parte.
...
- `valor_exacto_pi/4`
- `informe`
- `duplicar_n_divide_el_error_por_4`
- `orden`
