# Teoría — Regla del trapecio

## Definición operativa

En esta clase, **Regla del trapecio** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`trapezoid_rule`) devuelve 5 valores. Varios de ellos
