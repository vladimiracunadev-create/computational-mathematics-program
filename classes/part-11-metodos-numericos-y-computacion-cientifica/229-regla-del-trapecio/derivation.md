# Derivación y razonamiento — Regla del trapecio
...
Construye una derivación de 5 a 10 pasos relacionada con **Regla del trapecio**.
...
La demostración `trapezoid_rule` recorre este mismo razonamiento en código.
