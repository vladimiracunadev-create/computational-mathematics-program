# Intuición — Regla del trapecio

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regla del trapecio**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `trapezoid_rule`: regla del trapecio y su convergencia o(h²).
