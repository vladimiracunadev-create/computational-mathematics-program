# Teoría — Método de Euler

## Definición operativa

En esta clase, **Método de Euler** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`euler_method`) devuelve 6 valores. Varios de ellos
