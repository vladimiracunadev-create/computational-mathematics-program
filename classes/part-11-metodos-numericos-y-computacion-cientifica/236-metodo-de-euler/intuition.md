# Intuición — Método de Euler

## La pregunta antes de la fórmula

¿Qué problema resuelve **Método de Euler**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `euler_method`: euler explícito: orden 1 y coste mínimo.
