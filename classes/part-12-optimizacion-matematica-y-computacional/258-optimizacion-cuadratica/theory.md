# Teoría — Optimización cuadrática

## Definición operativa

En esta clase, **Optimización cuadrática** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`quadratic_programming`) devuelve 11 valores. Varios de ellos
