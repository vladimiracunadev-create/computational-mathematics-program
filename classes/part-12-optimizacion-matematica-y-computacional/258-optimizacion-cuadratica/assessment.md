# Evaluación — Optimización cuadrática
...
| Implementación y verificación | 25 % | ejecuta `quadratic_programming`, interpreta sus salidas y comprueba al menos un invariante |
