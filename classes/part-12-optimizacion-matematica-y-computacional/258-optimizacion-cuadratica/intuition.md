# Intuición — Optimización cuadrática

## La pregunta antes de la fórmula

¿Qué problema resuelve **Optimización cuadrática**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `quadratic_programming`: programa cuadrático resuelto por su sistema kkt.
