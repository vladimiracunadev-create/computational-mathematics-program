# Derivación y razonamiento — Optimización cuadrática
...
Construye una derivación de 5 a 10 pasos relacionada con **Optimización cuadrática**.
...
La demostración `quadratic_programming` recorre este mismo razonamiento en código.
