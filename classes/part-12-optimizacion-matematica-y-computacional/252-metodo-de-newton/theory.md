# Teoría — Método de Newton

## Definición operativa

En esta clase, **Método de Newton** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`newton_method`) devuelve 7 valores. Varios de ellos
