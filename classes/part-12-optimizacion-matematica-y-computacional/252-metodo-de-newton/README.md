...
**Motor:** `computational_math.engines.part12` · demostración `newton_method`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `newton_method` del motor de la parte.
