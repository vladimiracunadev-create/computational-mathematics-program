# Derivación y razonamiento — Método de Newton
...
Construye una derivación de 5 a 10 pasos relacionada con **Método de Newton**.
...
La demostración `newton_method` recorre este mismo razonamiento en código.
