# Intuición — Método de Newton

## La pregunta antes de la fórmula

¿Qué problema resuelve **Método de Newton**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `newton_method`: newton en optimización: usa curvatura, converge en un paso si es cuadrática.
