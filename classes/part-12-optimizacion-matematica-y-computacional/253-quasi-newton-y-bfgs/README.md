...
**Motor:** `computational_math.engines.part12` · demostración `quasi_newton`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `quasi_newton` del motor de la parte.
