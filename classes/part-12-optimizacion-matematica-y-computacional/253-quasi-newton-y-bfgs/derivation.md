# Derivación y razonamiento — Quasi-Newton y BFGS
...
Construye una derivación de 5 a 10 pasos relacionada con **Quasi-Newton y BFGS**.
...
La demostración `quasi_newton` recorre este mismo razonamiento en código.
