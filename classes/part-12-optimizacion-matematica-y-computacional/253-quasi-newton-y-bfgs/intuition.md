# Intuición — Quasi-Newton y BFGS

## La pregunta antes de la fórmula

¿Qué problema resuelve **Quasi-Newton y BFGS**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `quasi_newton`: bfgs: aproxima el hessiano inverso solo con gradientes.
