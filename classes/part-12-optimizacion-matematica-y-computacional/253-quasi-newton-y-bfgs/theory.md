# Teoría — Quasi-Newton y BFGS

## Definición operativa

En esta clase, **Quasi-Newton y BFGS** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`quasi_newton`) devuelve 7 valores. Varios de ellos
