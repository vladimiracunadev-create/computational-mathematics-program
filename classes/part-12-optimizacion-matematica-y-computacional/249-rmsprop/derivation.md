# Derivación y razonamiento — RMSProp
...
Construye una derivación de 5 a 10 pasos relacionada con **RMSProp**.
...
La demostración `rmsprop` recorre este mismo razonamiento en código.
