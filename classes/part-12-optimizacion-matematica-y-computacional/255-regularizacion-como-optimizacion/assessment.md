# Evaluación — Regularización como optimización
...
| Implementación y verificación | 25 % | ejecuta `regularization_as_optimization`, interpreta sus salidas y comprueba al menos un invariante |
