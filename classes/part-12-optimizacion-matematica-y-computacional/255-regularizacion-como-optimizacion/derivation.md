# Derivación y razonamiento — Regularización como optimización
...
Construye una derivación de 5 a 10 pasos relacionada con **Regularización como optimización**.
...
La demostración `regularization_as_optimization` recorre este mismo razonamiento en código.
