# Teoría — Regularización como optimización

## Definición operativa

En esta clase, **Regularización como optimización** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`regularization_as_optimization`) devuelve 4 valores. Varios de ellos
