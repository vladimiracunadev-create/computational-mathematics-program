# Intuición — Regularización como optimización

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regularización como optimización**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `regularization_as_optimization`: regularizar es cambiar el objetivo, no el algoritmo.
