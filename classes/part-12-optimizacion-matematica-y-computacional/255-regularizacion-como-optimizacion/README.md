...
Esta clase enseña **Optimización · Estadística e inferencia**. Cada obra dice qué aporta aquí y cómo se comprobó su localizador:

- [Hastie, T.; Tibshirani, R.; Friedman, J. *The Elements of Statistical Learning*, 2ª ed., Springer, 2009](https://hastie.su.domains/ElemStatLearn/) — Estadística e inferencia: el tema de esta clase · ISBN-13 `9780387848570` verificado en International ISBN Agency (2026-08-19).
- [Tibshirani, R. *Regression shrinkage and selection via the lasso*, JRSS-B, 1996](https://doi.org/10.1111/j.2517-6161.1996.tb02080.x) — Estadística e inferencia: el tema de esta clase · DOI `10.1111/j.2517-6161.1996.tb02080.x` verificado en Crossref (2026-08-19).
