...
- [Armijo, L. *Minimization of functions having Lipschitz continuous first partial derivatives*, 1966](https://doi.org/10.2140/pjm.1966.16.1) — Optimización: el tema de esta clase · DOI `10.2140/pjm.1966.16.1` verificado en Crossref (2026-08-19).
