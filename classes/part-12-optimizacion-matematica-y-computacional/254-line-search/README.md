...
**Motor:** `computational_math.engines.part12` · demostración `line_search`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `line_search` del motor de la parte.
