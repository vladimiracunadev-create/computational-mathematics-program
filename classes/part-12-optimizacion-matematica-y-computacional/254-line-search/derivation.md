# Derivación y razonamiento — Line search
...
Construye una derivación de 5 a 10 pasos relacionada con **Line search**.
...
La demostración `line_search` recorre este mismo razonamiento en código.
