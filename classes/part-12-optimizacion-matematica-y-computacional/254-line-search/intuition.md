# Intuición — Line search

## La pregunta antes de la fórmula

¿Qué problema resuelve **Line search**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `line_search`: búsqueda de línea con la condición de armijo.
