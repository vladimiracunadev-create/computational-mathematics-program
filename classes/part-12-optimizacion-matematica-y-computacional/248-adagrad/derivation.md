# Derivación y razonamiento — AdaGrad
...
Construye una derivación de 5 a 10 pasos relacionada con **AdaGrad**.
...
La demostración `adagrad` recorre este mismo razonamiento en código.
