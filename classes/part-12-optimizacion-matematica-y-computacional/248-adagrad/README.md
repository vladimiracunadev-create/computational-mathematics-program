...
**Motor:** `computational_math.engines.part12` · demostración `adagrad`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `adagrad` del motor de la parte.
