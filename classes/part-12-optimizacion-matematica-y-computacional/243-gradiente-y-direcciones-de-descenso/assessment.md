# Evaluación — Gradiente y direcciones de descenso
...
| Implementación y verificación | 25 % | ejecuta `descent_directions`, interpreta sus salidas y comprueba al menos un invariante |
