# Teoría — Gradiente y direcciones de descenso

## Definición operativa

En esta clase, **Gradiente y direcciones de descenso** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`descent_directions`) devuelve 6 valores. Varios de ellos
