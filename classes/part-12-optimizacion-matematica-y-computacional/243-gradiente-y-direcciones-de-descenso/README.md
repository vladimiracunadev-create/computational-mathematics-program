...
- [Nocedal, J.; Wright, S. *Numerical Optimization*, 2ª ed., Springer, 2006, cap. 2](https://doi.org/10.1007/978-0-387-40065-5) — *uso:* desarrollo formal del tema en «Gradiente y direcciones de descenso».
- [Boyd, S.; Vandenberghe, L. *Convex Optimization*, Cambridge, 2004, cap. 9](https://web.stanford.edu/~boyd/cvxbook/) — *uso:* obra de referencia consultada en «Gradiente y direcciones de descenso».
