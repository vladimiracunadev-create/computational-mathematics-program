# Intuición — Gradiente y direcciones de descenso

## La pregunta antes de la fórmula

¿Qué problema resuelve **Gradiente y direcciones de descenso**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `descent_directions`: cualquier dirección con dᵀ∇f < 0 hace descender la función.
