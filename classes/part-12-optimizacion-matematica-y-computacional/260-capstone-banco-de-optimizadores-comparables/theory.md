# Teoría — Capstone: banco de optimizadores comparables

## Definición operativa

En esta clase, **Capstone: banco de optimizadores comparables** se trata como un objeto con tres capas
separadas:
...
## Ideas centrales de la parte 12
...
ningún paso quede oculto. En la práctica profesional se usa: math, numpy (opcional), cvxpy (opcional).
...
El laboratorio (`capstone_optimizer_bench`) devuelve 9 valores. Varios de ellos
