# Ejercicios — Capstone: banco de optimizadores comparables

## Básico

1. Define **Capstone: banco de optimizadores comparables** con tus palabras y da un ejemplo válido y uno inválido.
