# Derivación y razonamiento — Capstone: banco de optimizadores comparables
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: banco de optimizadores comparables**.
...
La demostración `capstone_optimizer_bench` recorre este mismo razonamiento en código.
