# Evaluación — Capstone: banco de optimizadores comparables
...
| Implementación y verificación | 25 % | ejecuta `capstone_optimizer_bench`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con logística o con IA |
...
5. ¿Dónde aparece este concepto en logística?
