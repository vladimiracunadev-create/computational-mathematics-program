# Teoría — Nesterov accelerated gradient

## Definición operativa

En esta clase, **Nesterov accelerated gradient** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`nesterov`) devuelve 5 valores. Varios de ellos
