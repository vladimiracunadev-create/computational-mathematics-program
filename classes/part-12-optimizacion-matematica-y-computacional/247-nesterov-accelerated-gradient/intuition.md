# Intuición — Nesterov accelerated gradient

## La pregunta antes de la fórmula

¿Qué problema resuelve **Nesterov accelerated gradient**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `nesterov`: nag mira adelante antes de calcular el gradiente.
