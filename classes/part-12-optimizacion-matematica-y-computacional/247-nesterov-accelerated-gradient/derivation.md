# Derivación y razonamiento — Nesterov accelerated gradient
...
Construye una derivación de 5 a 10 pasos relacionada con **Nesterov accelerated gradient**.
...
La demostración `nesterov` recorre este mismo razonamiento en código.
