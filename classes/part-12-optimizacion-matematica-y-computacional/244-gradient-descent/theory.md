# Teoría — Gradient descent

## Definición operativa

En esta clase, **Gradient descent** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`gradient_descent`) devuelve 6 valores. Varios de ellos
