# Intuición — Gradient descent

## La pregunta antes de la fórmula

¿Qué problema resuelve **Gradient descent**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `gradient_descent`: descenso de gradiente y el efecto del learning rate.
