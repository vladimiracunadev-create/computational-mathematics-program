# Derivación y razonamiento — Gradient descent
...
Construye una derivación de 5 a 10 pasos relacionada con **Gradient descent**.
...
La demostración `gradient_descent` recorre este mismo razonamiento en código.
