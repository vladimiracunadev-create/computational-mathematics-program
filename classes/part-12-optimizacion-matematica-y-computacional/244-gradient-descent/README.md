...
**Motor:** `computational_math.engines.part12` · demostración `gradient_descent`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `gradient_descent` del motor de la parte.
