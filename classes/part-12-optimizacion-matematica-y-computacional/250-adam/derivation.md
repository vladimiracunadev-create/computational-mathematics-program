# Derivación y razonamiento — Adam
...
Construye una derivación de 5 a 10 pasos relacionada con **Adam**.
...
La demostración `adam` recorre este mismo razonamiento en código.
