# Intuición — Restricciones y Lagrangianos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Restricciones y Lagrangianos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `constraints_lagrangian`: restricción de igualdad resuelta con el lagrangiano.
