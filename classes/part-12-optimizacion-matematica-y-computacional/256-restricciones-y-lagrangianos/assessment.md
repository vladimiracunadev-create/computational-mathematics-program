# Evaluación — Restricciones y Lagrangianos
...
| Implementación y verificación | 25 % | ejecuta `constraints_lagrangian`, interpreta sus salidas y comprueba al menos un invariante |
