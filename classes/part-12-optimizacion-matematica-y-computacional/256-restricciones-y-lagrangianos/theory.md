# Teoría — Restricciones y Lagrangianos

## Definición operativa

En esta clase, **Restricciones y Lagrangianos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`constraints_lagrangian`) devuelve 10 valores. Varios de ellos
