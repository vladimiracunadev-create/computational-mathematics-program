# Teoría — Condiciones KKT

## Definición operativa

En esta clase, **Condiciones KKT** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`kkt_conditions`) devuelve 6 valores. Varios de ellos
