# Intuición — Condiciones KKT

## La pregunta antes de la fórmula

¿Qué problema resuelve **Condiciones KKT**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `kkt_conditions`: kkt: restricciones de desigualdad activas e inactivas.
