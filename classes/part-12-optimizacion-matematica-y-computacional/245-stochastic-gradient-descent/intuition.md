# Intuición — Stochastic gradient descent

## La pregunta antes de la fórmula

¿Qué problema resuelve **Stochastic gradient descent**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sgd`: sgd: gradiente ruidoso, progreso más barato.
