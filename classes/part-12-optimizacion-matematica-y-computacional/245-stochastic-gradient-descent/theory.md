# Teoría — Stochastic gradient descent

## Definición operativa

En esta clase, **Stochastic gradient descent** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sgd`) devuelve 10 valores. Varios de ellos
