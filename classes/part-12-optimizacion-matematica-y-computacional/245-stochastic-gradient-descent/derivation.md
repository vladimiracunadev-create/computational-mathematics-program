# Derivación y razonamiento — Stochastic gradient descent
...
Construye una derivación de 5 a 10 pasos relacionada con **Stochastic gradient descent**.
...
La demostración `sgd` recorre este mismo razonamiento en código.
