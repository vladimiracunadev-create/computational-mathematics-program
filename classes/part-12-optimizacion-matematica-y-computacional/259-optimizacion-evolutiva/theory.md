# Teoría — Optimización evolutiva

## Definición operativa

En esta clase, **Optimización evolutiva** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`evolutionary_optimization`) devuelve 10 valores. Varios de ellos
