# Derivación y razonamiento — Optimización evolutiva
...
Construye una derivación de 5 a 10 pasos relacionada con **Optimización evolutiva**.
...
La demostración `evolutionary_optimization` recorre este mismo razonamiento en código.
