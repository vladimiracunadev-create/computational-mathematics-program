# Intuición — Optimización evolutiva

## La pregunta antes de la fórmula

¿Qué problema resuelve **Optimización evolutiva**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `evolutionary_optimization`: optimización evolutiva: sin gradiente, sobre una función multimodal.
