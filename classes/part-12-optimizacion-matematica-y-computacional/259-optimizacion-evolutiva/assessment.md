# Evaluación — Optimización evolutiva
...
| Implementación y verificación | 25 % | ejecuta `evolutionary_optimization`, interpreta sus salidas y comprueba al menos un invariante |
