# Evaluación — Problemas de optimización y función objetivo
...
| Implementación y verificación | 25 % | ejecuta `objective_function`, interpreta sus salidas y comprueba al menos un invariante |
