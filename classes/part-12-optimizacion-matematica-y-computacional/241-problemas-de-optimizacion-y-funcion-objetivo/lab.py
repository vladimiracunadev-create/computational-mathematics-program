"""Laboratorio 241 — Problemas de optimización y función objetivo.

Parte 12 · Optimización matemática y computacional
Motor: computational_math.engines.part12 · demostración `objective_function`
