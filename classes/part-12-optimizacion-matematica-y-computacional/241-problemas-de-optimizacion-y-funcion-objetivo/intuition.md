# Intuición — Problemas de optimización y función objetivo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Problemas de optimización y función objetivo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `objective_function`: anatomía de un problema de optimización.
