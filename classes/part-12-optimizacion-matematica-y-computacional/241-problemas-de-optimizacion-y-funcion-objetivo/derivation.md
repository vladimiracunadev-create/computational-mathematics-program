# Derivación y razonamiento — Problemas de optimización y función objetivo
...
Construye una derivación de 5 a 10 pasos relacionada con **Problemas de optimización y función objetivo**.
...
La demostración `objective_function` recorre este mismo razonamiento en código.
