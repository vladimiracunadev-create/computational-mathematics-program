# Ejercicios — Problemas de optimización y función objetivo

## Básico

1. Define **Problemas de optimización y función objetivo** con tus palabras y da un ejemplo válido y uno inválido.
