# Teoría — Problemas de optimización y función objetivo

## Definición operativa

En esta clase, **Problemas de optimización y función objetivo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`objective_function`) devuelve 9 valores. Varios de ellos
