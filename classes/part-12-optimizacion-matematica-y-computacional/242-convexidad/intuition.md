# Intuición — Convexidad

## La pregunta antes de la fórmula

¿Qué problema resuelve **Convexidad**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `convexity`: convexidad: la propiedad que convierte un mínimo local en global.
