# Derivación y razonamiento — Convexidad
...
Construye una derivación de 5 a 10 pasos relacionada con **Convexidad**.
...
La demostración `convexity` recorre este mismo razonamiento en código.
