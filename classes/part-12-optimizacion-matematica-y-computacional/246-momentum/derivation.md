# Derivación y razonamiento — Momentum
...
Construye una derivación de 5 a 10 pasos relacionada con **Momentum**.
...
La demostración `momentum` recorre este mismo razonamiento en código.
