...
**Motor:** `computational_math.engines.part12` · demostración `momentum`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `momentum` del motor de la parte.
