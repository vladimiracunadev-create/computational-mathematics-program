# Derivación y razonamiento — AdamW
...
Construye una derivación de 5 a 10 pasos relacionada con **AdamW**.
...
La demostración `adamw` recorre este mismo razonamiento en código.
