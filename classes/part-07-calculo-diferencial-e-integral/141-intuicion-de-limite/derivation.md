# Derivación y razonamiento — Intuición de límite
...
Construye una derivación de 5 a 10 pasos relacionada con **Intuición de límite**.
...
La demostración `limit_intuition` recorre este mismo razonamiento en código.
