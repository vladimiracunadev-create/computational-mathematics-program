# Intuición — Intuición de límite

## La pregunta antes de la fórmula

¿Qué problema resuelve **Intuición de límite**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `limit_intuition`: sin(x)/x cuando x→0: indeterminado en el punto, definido en el límite.
