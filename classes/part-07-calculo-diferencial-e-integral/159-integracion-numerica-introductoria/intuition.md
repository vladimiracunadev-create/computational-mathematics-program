# Intuición — Integración numérica introductoria

## La pregunta antes de la fórmula

¿Qué problema resuelve **Integración numérica introductoria**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `numerical_integration_intro`: trapecio frente a simpson sobre la misma integral.
