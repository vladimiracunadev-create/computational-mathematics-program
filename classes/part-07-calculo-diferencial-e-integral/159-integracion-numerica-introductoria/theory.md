# Teoría — Integración numérica introductoria

## Definición operativa

En esta clase, **Integración numérica introductoria** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`numerical_integration_intro`) devuelve 9 valores. Varios de ellos
