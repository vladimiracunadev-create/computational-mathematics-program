# Derivación y razonamiento — Integración numérica introductoria
...
Construye una derivación de 5 a 10 pasos relacionada con **Integración numérica introductoria**.
...
La demostración `numerical_integration_intro` recorre este mismo razonamiento en código.
