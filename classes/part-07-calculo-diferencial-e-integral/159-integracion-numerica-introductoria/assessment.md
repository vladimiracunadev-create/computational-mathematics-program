# Evaluación — Integración numérica introductoria
...
| Implementación y verificación | 25 % | ejecuta `numerical_integration_intro`, interpreta sus salidas y comprueba al menos un invariante |
