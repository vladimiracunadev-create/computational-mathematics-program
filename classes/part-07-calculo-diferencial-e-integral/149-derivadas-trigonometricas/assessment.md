# Evaluación — Derivadas trigonométricas
...
| Implementación y verificación | 25 % | ejecuta `trig_derivatives`, interpreta sus salidas y comprueba al menos un invariante |
