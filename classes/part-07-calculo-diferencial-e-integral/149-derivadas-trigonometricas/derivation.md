# Derivación y razonamiento — Derivadas trigonométricas
...
Construye una derivación de 5 a 10 pasos relacionada con **Derivadas trigonométricas**.
...
La demostración `trig_derivatives` recorre este mismo razonamiento en código.
