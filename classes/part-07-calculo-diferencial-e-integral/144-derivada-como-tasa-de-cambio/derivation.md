# Derivación y razonamiento — Derivada como tasa de cambio
...
Construye una derivación de 5 a 10 pasos relacionada con **Derivada como tasa de cambio**.
...
La demostración `derivative_as_rate` recorre este mismo razonamiento en código.
