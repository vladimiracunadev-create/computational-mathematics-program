# Teoría — Derivada como tasa de cambio

## Definición operativa

En esta clase, **Derivada como tasa de cambio** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`derivative_as_rate`) devuelve 7 valores. Varios de ellos
