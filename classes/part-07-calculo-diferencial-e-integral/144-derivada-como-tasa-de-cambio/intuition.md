# Intuición — Derivada como tasa de cambio

## La pregunta antes de la fórmula

¿Qué problema resuelve **Derivada como tasa de cambio**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `derivative_as_rate`: derivada como límite del cociente incremental.
