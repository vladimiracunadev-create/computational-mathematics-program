# Evaluación — Derivada como tasa de cambio
...
| Implementación y verificación | 25 % | ejecuta `derivative_as_rate`, interpreta sus salidas y comprueba al menos un invariante |
