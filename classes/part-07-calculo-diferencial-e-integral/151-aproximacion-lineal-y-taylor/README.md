...
Esta clase concreta ese objetivo sobre **Aproximación lineal y Taylor**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `taylor_approximation` del motor de la parte.
