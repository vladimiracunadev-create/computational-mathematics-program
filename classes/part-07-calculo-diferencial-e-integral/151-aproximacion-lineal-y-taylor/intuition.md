# Intuición — Aproximación lineal y Taylor

## La pregunta antes de la fórmula

¿Qué problema resuelve **Aproximación lineal y Taylor**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `taylor_approximation`: taylor de e^x en 0: el error cae con el grado.
