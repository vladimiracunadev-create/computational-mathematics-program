# Teoría — Aproximación lineal y Taylor

## Definición operativa

En esta clase, **Aproximación lineal y Taylor** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`taylor_approximation`) devuelve 6 valores. Varios de ellos
