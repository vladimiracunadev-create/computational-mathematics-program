# Evaluación — Aproximación lineal y Taylor
...
| Implementación y verificación | 25 % | ejecuta `taylor_approximation`, interpreta sus salidas y comprueba al menos un invariante |
