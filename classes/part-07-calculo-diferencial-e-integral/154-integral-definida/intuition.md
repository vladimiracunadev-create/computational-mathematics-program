# Intuición — Integral definida

## La pregunta antes de la fórmula

¿Qué problema resuelve **Integral definida**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `definite_integral`: propiedades de la integral definida.
