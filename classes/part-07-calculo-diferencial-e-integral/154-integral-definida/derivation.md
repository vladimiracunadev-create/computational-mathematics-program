# Derivación y razonamiento — Integral definida
...
Construye una derivación de 5 a 10 pasos relacionada con **Integral definida**.
...
La demostración `definite_integral` recorre este mismo razonamiento en código.
