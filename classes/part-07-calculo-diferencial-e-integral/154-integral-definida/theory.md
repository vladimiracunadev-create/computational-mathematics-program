# Teoría — Integral definida

## Definición operativa

En esta clase, **Integral definida** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`definite_integral`) devuelve 7 valores. Varios de ellos
