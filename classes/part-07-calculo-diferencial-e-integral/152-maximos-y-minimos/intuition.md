# Intuición — Máximos y mínimos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Máximos y mínimos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `extrema`: máximos y mínimos por derivada y criterio de la segunda derivada.
