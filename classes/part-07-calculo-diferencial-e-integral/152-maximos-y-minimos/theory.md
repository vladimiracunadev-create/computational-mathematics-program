# Teoría — Máximos y mínimos

## Definición operativa

En esta clase, **Máximos y mínimos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`extrema`) devuelve 3 valores. Varios de ellos
