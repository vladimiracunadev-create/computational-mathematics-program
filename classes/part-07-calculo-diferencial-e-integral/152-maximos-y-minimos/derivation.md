# Derivación y razonamiento — Máximos y mínimos
...
Construye una derivación de 5 a 10 pasos relacionada con **Máximos y mínimos**.
...
La demostración `extrema` recorre este mismo razonamiento en código.
