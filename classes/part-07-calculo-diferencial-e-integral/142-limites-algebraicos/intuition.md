# Intuición — Límites algebraicos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Límites algebraicos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `algebraic_limits`: indeterminación 0/0 resuelta por factorización.
