# Teoría — Límites algebraicos

## Definición operativa

En esta clase, **Límites algebraicos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`algebraic_limits`) devuelve 8 valores. Varios de ellos
