# Evaluación — Derivación implícita
...
| Implementación y verificación | 25 % | ejecuta `implicit_differentiation`, interpreta sus salidas y comprueba al menos un invariante |
