# Derivación y razonamiento — Derivación implícita
...
Construye una derivación de 5 a 10 pasos relacionada con **Derivación implícita**.
...
La demostración `implicit_differentiation` recorre este mismo razonamiento en código.
