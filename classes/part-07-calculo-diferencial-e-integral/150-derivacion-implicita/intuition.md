# Intuición — Derivación implícita

## La pregunta antes de la fórmula

¿Qué problema resuelve **Derivación implícita**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `implicit_differentiation`: derivación implícita sobre la circunferencia x²+y²=25.
