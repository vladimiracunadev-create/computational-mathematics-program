# Teoría — Derivación implícita

## Definición operativa

En esta clase, **Derivación implícita** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`implicit_differentiation`) devuelve 7 valores. Varios de ellos
