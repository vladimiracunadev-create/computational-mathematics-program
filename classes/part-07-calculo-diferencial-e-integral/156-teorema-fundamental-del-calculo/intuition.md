# Intuición — Teorema fundamental del cálculo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Teorema fundamental del cálculo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `fundamental_theorem`: teorema fundamental: derivar deshace integrar.
