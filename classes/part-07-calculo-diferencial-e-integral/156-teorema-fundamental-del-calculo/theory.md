# Teoría — Teorema fundamental del cálculo

## Definición operativa

En esta clase, **Teorema fundamental del cálculo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`fundamental_theorem`) devuelve 7 valores. Varios de ellos
