# Evaluación — Teorema fundamental del cálculo
...
| Implementación y verificación | 25 % | ejecuta `fundamental_theorem`, interpreta sus salidas y comprueba al menos un invariante |
