# Derivación y razonamiento — Teorema fundamental del cálculo
...
Construye una derivación de 5 a 10 pasos relacionada con **Teorema fundamental del cálculo**.
...
La demostración `fundamental_theorem` recorre este mismo razonamiento en código.
