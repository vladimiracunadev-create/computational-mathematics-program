...
- [Spivak, M. *Calculus*, 4ª ed., 2008, cap. 6](https://www.mathpop.com/calculus) — Análisis matemático y Cálculo: el tema de esta clase · ISBN-13 `9780914098911` verificado en International ISBN Agency (2026-08-19).
- [Weierstrass function — Wolfram MathWorld](https://mathworld.wolfram.com/WeierstrassFunction.html) — Análisis matemático y Cálculo: el tema de esta clase · URL de la fuente primaria comprobada en Wolfram Research (2026-08-19).
