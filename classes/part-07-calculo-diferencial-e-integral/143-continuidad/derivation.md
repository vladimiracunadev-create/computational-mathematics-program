# Derivación y razonamiento — Continuidad
...
Construye una derivación de 5 a 10 pasos relacionada con **Continuidad**.
...
La demostración `continuity` recorre este mismo razonamiento en código.
