# Intuición — Continuidad

## La pregunta antes de la fórmula

¿Qué problema resuelve **Continuidad**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `continuity`: los tres requisitos de continuidad en un punto.
