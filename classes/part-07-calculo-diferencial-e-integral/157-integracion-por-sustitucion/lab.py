"""Laboratorio 157 — Integración por sustitución.

Parte 07 · Cálculo diferencial e integral
Motor: computational_math.engines.part07 · demostración `substitution`
...
def main() -> dict:
    ...
    print(f"Clase 157 — Integración por sustitución")
