# Intuición — Integración por sustitución

## La pregunta antes de la fórmula

¿Qué problema resuelve **Integración por sustitución**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `substitution`: integración por sustitución: la regla de la cadena al revés.
