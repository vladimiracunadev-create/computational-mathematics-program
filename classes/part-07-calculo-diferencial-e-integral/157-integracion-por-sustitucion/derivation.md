# Derivación y razonamiento — Integración por sustitución
...
Construye una derivación de 5 a 10 pasos relacionada con **Integración por sustitución**.
...
La demostración `substitution` recorre este mismo razonamiento en código.
