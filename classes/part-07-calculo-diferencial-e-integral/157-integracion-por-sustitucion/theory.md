# Teoría — Integración por sustitución

## Definición operativa

En esta clase, **Integración por sustitución** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`substitution`) devuelve 7 valores. Varios de ellos
