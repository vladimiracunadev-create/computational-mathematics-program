# Derivación y razonamiento — Capstone: optimizar y acumular una señal
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: optimizar y acumular una señal**.
...
La demostración `capstone_optimize_and_accumulate` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part07.py` y responde:
