# Ejercicios — Capstone: optimizar y acumular una señal

## Básico

1. Define **Capstone: optimizar y acumular una señal** con tus palabras y da un ejemplo válido y uno inválido.
