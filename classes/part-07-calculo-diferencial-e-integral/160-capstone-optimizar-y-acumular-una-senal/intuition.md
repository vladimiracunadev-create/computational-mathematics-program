# Intuición — Capstone: optimizar y acumular una señal

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: optimizar y acumular una señal**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Cálculo diferencial e integral**. Límite, continuidad, derivada, reglas de derivación, Taylor, optimización de una variable, integral definida y teorema fundamental del cálculo.
...
El laboratorio ejecuta `capstone_optimize_and_accumulate`: capstone: derivar para optimizar e integrar para acumular una señal.
