"""Laboratorio 160 — Capstone: optimizar y acumular una señal.

Parte 07 · Cálculo diferencial e integral
Motor: computational_math.engines.part07 · demostración `capstone_optimize_and_accumulate`
...
from computational_math.engines import part07 as motor  # noqa: E402

DEMO = "capstone_optimize_and_accumulate"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 160 — Capstone: optimizar y acumular una señal")
    print(f"Parte 07 · Cálculo diferencial e integral")
