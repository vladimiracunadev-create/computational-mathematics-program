# Evaluación — Capstone: optimizar y acumular una señal
...
| Implementación y verificación | 25 % | ejecuta `capstone_optimize_and_accumulate`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con física o con IA |
...
5. ¿Dónde aparece este concepto en física?
