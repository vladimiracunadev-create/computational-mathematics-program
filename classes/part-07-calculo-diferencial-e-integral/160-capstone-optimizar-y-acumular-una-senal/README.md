...
3. Ejecutar y modificar `lab.py`, que corre la demostración `capstone_optimize_and_accumulate` del motor de la parte.
...
- `t_del_primer_maximo`
- `valor_maximo`
- `derivada_en_el_maximo`
- `area_acumulada_0_a_6`
- `energia_∫f²`
- `valor_medio`
- `las_dos_operaciones`
