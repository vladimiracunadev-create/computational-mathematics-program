# Teoría — Capstone: optimizar y acumular una señal

## Definición operativa

En esta clase, **Capstone: optimizar y acumular una señal** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_optimize_and_accumulate`) devuelve 8 valores. Varios de ellos
