# Intuición — Regla de la cadena

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regla de la cadena**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `chain_rule`: la regla de la cadena: el mecanismo entero de backpropagation.
