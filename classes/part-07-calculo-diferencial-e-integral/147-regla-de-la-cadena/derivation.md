# Derivación y razonamiento — Regla de la cadena
...
Construye una derivación de 5 a 10 pasos relacionada con **Regla de la cadena**.
...
La demostración `chain_rule` recorre este mismo razonamiento en código.
