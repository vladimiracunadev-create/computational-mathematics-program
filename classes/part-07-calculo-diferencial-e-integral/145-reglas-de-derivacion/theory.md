# Teoría — Reglas de derivación

## Definición operativa

En esta clase, **Reglas de derivación** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`derivative_rules`) devuelve 4 valores. Varios de ellos
