# Intuición — Reglas de derivación

## La pregunta antes de la fórmula

¿Qué problema resuelve **Reglas de derivación**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `derivative_rules`: reglas de potencia, suma y constante verificadas numéricamente.
