# Derivación y razonamiento — Reglas de derivación
...
Construye una derivación de 5 a 10 pasos relacionada con **Reglas de derivación**.
...
La demostración `derivative_rules` recorre este mismo razonamiento en código.
