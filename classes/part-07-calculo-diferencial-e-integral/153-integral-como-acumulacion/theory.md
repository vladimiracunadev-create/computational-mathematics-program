# Teoría — Integral como acumulación

## Definición operativa

En esta clase, **Integral como acumulación** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`integral_as_accumulation`) devuelve 5 valores. Varios de ellos
