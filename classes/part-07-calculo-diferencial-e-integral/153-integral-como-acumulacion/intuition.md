# Intuición — Integral como acumulación

## La pregunta antes de la fórmula

¿Qué problema resuelve **Integral como acumulación**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `integral_as_accumulation`: sumas de riemann convergiendo a la integral.
