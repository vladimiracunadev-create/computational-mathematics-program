# Evaluación — Integral como acumulación
...
| Implementación y verificación | 25 % | ejecuta `integral_as_accumulation`, interpreta sus salidas y comprueba al menos un invariante |
