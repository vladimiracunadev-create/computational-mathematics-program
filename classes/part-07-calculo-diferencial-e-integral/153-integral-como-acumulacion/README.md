...
Esta clase concreta ese objetivo sobre **Integral como acumulación**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `integral_as_accumulation` del motor de la parte.
