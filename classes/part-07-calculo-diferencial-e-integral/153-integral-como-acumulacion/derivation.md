# Derivación y razonamiento — Integral como acumulación
...
Construye una derivación de 5 a 10 pasos relacionada con **Integral como acumulación**.
...
La demostración `integral_as_accumulation` recorre este mismo razonamiento en código.
