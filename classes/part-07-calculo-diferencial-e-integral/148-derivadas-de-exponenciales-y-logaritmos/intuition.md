# Intuición — Derivadas de exponenciales y logaritmos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Derivadas de exponenciales y logaritmos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `exp_log_derivatives`: e^x es su propia derivada; log tiene derivada 1/x.
