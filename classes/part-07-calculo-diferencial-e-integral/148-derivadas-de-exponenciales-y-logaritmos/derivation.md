# Derivación y razonamiento — Derivadas de exponenciales y logaritmos
...
Construye una derivación de 5 a 10 pasos relacionada con **Derivadas de exponenciales y logaritmos**.
...
La demostración `exp_log_derivatives` recorre este mismo razonamiento en código.
