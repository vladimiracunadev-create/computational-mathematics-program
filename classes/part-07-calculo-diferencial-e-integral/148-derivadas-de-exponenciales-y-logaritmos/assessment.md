# Evaluación — Derivadas de exponenciales y logaritmos
...
| Implementación y verificación | 25 % | ejecuta `exp_log_derivatives`, interpreta sus salidas y comprueba al menos un invariante |
