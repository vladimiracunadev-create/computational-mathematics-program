# Teoría — Derivadas de exponenciales y logaritmos

## Definición operativa

En esta clase, **Derivadas de exponenciales y logaritmos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`exp_log_derivatives`) devuelve 7 valores. Varios de ellos
