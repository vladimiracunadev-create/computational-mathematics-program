# Intuición — Regla del producto y cociente

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regla del producto y cociente**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `product_quotient_rule`: regla del producto y del cociente.
