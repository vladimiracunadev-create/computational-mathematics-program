# Evaluación — Regla del producto y cociente
...
| Implementación y verificación | 25 % | ejecuta `product_quotient_rule`, interpreta sus salidas y comprueba al menos un invariante |
