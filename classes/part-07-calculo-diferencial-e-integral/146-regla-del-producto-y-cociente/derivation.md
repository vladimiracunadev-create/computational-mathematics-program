# Derivación y razonamiento — Regla del producto y cociente
...
Construye una derivación de 5 a 10 pasos relacionada con **Regla del producto y cociente**.
...
La demostración `product_quotient_rule` recorre este mismo razonamiento en código.
