# Teoría — Regla del producto y cociente

## Definición operativa

En esta clase, **Regla del producto y cociente** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`product_quotient_rule`) devuelve 9 valores. Varios de ellos
