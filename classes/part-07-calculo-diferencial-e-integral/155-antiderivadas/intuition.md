# Intuición — Antiderivadas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Antiderivadas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `antiderivatives`: la antiderivada no es única: difiere en una constante.
