# Derivación y razonamiento — Antiderivadas
...
Construye una derivación de 5 a 10 pasos relacionada con **Antiderivadas**.
...
La demostración `antiderivatives` recorre este mismo razonamiento en código.
