# Teoría — Antiderivadas

## Definición operativa

En esta clase, **Antiderivadas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`antiderivatives`) devuelve 8 valores. Varios de ellos
