# Evaluación — Integración por partes
...
| Implementación y verificación | 25 % | ejecuta `integration_by_parts`, interpreta sus salidas y comprueba al menos un invariante |
