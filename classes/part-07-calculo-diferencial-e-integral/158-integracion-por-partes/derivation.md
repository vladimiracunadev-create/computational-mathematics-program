# Derivación y razonamiento — Integración por partes
...
Construye una derivación de 5 a 10 pasos relacionada con **Integración por partes**.
...
La demostración `integration_by_parts` recorre este mismo razonamiento en código.
