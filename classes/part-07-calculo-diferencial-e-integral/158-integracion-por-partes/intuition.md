# Intuición — Integración por partes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Integración por partes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `integration_by_parts`: integración por partes: la regla del producto al revés.
