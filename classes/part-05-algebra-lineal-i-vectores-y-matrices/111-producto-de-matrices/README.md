...
**Motor:** `computational_math.engines.part05` · demostración `matrix_product`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `matrix_product` del motor de la parte.
