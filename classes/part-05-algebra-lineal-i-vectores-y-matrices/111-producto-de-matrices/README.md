...
- [Golub & Van Loan. *Matrix Computations*, 4ª ed., Johns Hopkins, 2013](https://jhupbooks.press.jhu.edu/title/matrix-computations) — Álgebra lineal: el tema de esta clase · ISBN-13 `9781421407944` verificado en International ISBN Agency (2026-08-19).
- [Strassen, V. *Gaussian elimination is not optimal*. Numer. Math., 1969](https://link.springer.com/article/10.1007/BF02165411) — Álgebra lineal numérica y Algoritmos y complejidad: conexión declarada de esta parte · DOI `10.1007/bf02165411` verificado en Crossref (2026-08-19).
