# Teoría — Producto de matrices

## Definición operativa

En esta clase, **Producto de matrices** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`matrix_product`) devuelve 9 valores. Varios de ellos
