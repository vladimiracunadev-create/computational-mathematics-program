# Intuición — Producto de matrices

## La pregunta antes de la fórmula

¿Qué problema resuelve **Producto de matrices**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `matrix_product`: ab ≠ ba y el coste cúbico del producto.
