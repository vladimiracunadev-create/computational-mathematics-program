# Intuición — Producto matriz-vector

## La pregunta antes de la fórmula

¿Qué problema resuelve **Producto matriz-vector**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `matrix_vector`: ax como combinación lineal de las columnas de a.
