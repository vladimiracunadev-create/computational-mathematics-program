# Teoría — Producto matriz-vector

## Definición operativa

En esta clase, **Producto matriz-vector** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`matrix_vector`) devuelve 7 valores. Varios de ellos
