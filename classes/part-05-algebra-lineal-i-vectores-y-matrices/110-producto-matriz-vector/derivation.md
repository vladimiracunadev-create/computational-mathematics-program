# Derivación y razonamiento — Producto matriz-vector
...
Construye una derivación de 5 a 10 pasos relacionada con **Producto matriz-vector**.
...
La demostración `matrix_vector` recorre este mismo razonamiento en código.
