...
**Motor:** `computational_math.engines.part05` · demostración `matrix_vector`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `matrix_vector` del motor de la parte.
