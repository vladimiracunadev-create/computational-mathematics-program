# Derivación y razonamiento — Matrices y operaciones básicas
...
Construye una derivación de 5 a 10 pasos relacionada con **Matrices y operaciones básicas**.
...
La demostración `matrix_basics` recorre este mismo razonamiento en código.
