# Evaluación — Matrices y operaciones básicas
...
| Implementación y verificación | 25 % | ejecuta `matrix_basics`, interpreta sus salidas y comprueba al menos un invariante |
