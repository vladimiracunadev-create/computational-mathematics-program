# Intuición — Matrices y operaciones básicas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Matrices y operaciones básicas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `matrix_basics`: suma, escala y transpuesta de matrices.
