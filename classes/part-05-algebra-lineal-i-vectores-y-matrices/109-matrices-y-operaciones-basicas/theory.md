# Teoría — Matrices y operaciones básicas

## Definición operativa

En esta clase, **Matrices y operaciones básicas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`matrix_basics`) devuelve 7 valores. Varios de ellos
