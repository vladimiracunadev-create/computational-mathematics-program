# Evaluación — Escalares, vectores y matrices
...
| Implementación y verificación | 25 % | ejecuta `scalars_vectors_matrices`, interpreta sus salidas y comprueba al menos un invariante |
