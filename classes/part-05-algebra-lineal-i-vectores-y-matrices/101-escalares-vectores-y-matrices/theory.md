# Teoría — Escalares, vectores y matrices

## Definición operativa

En esta clase, **Escalares, vectores y matrices** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`scalars_vectors_matrices`) devuelve 8 valores. Varios de ellos
