# Derivación y razonamiento — Escalares, vectores y matrices
...
Construye una derivación de 5 a 10 pasos relacionada con **Escalares, vectores y matrices**.
...
La demostración `scalars_vectors_matrices` recorre este mismo razonamiento en código.
