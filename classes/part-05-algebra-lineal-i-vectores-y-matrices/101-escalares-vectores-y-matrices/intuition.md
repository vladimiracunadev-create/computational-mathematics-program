# Intuición — Escalares, vectores y matrices

## La pregunta antes de la fórmula

¿Qué problema resuelve **Escalares, vectores y matrices**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `scalars_vectors_matrices`: escalar, vector y matriz como objetos con forma y significado.
