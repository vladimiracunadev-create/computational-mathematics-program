...
**Motor:** `computational_math.engines.part05` · demostración `scalars_vectors_matrices`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `scalars_vectors_matrices` del motor de la parte.
...
- `escalar_por_vector`
- `transpuesta_shape`
- `un_tensor_de_orden_0_es_un_escalar`
