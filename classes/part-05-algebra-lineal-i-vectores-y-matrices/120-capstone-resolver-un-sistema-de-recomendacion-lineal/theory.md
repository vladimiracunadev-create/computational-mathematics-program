# Teoría — Capstone: resolver un sistema de recomendación lineal

## Definición operativa

En esta clase, **Capstone: resolver un sistema de recomendación lineal** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_linear_recommender`) devuelve 8 valores. Varios de ellos
