# Derivación y razonamiento — Capstone: resolver un sistema de recomendación lineal
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: resolver un sistema de recomendación lineal**.
...
La demostración `capstone_linear_recommender` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part05.py` y responde:
