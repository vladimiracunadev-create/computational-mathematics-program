# Intuición — Capstone: resolver un sistema de recomendación lineal

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: resolver un sistema de recomendación lineal**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Álgebra lineal I: vectores y matrices**. Vectores, normas, producto punto, independencia, span, sistemas lineales, eliminación de Gauss, rango, inversa, determinante y proyección ortogonal.
...
El laboratorio ejecuta `capstone_linear_recommender`: capstone: recomendación lineal por similitud coseno entre usuarios.
