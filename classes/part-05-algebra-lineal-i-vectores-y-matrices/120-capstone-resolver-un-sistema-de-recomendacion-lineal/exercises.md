# Ejercicios — Capstone: resolver un sistema de recomendación lineal

## Básico

1. Define **Capstone: resolver un sistema de recomendación lineal** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 8 salidas.
...
7. Conecta esta clase con sistemas de recomendación, gráficos, ingeniería estructural y análisis de datos mediante un caso concreto y realista.
