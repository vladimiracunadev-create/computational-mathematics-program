# Evaluación — Capstone: resolver un sistema de recomendación lineal
...
| Implementación y verificación | 25 % | ejecuta `capstone_linear_recommender`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con sistemas de recomendación o con IA |
...
5. ¿Dónde aparece este concepto en sistemas de recomendación?
