...
- [Ricci, Rokach & Shapira. *Recommender Systems Handbook*, 3ª ed., Springer, 2022](https://link.springer.com/book/10.1007/978-1-0716-2197-4) — Machine learning: conexión declarada de esta parte · ISBN-13 `9781071621974`, pendiente de resolver.
- [Koren, Bell & Volinsky. *Matrix Factorization Techniques for Recommender Systems*. IEEE Computer, 2009](https://ieeexplore.ieee.org/document/5197422) — Álgebra lineal: el tema de esta clase · URL de la fuente primaria, pendiente de resolver.
