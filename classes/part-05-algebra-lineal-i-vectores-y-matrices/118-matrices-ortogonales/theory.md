# Teoría — Matrices ortogonales

## Definición operativa

En esta clase, **Matrices ortogonales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`orthogonal_matrices`) devuelve 8 valores. Varios de ellos
