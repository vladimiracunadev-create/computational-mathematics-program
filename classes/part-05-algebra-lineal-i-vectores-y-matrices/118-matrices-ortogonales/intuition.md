# Intuición — Matrices ortogonales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Matrices ortogonales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `orthogonal_matrices`: matriz ortogonal: qᵀq = i, preserva normas y ángulos.
