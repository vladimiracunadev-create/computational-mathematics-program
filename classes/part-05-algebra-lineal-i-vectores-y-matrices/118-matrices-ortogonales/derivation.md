# Derivación y razonamiento — Matrices ortogonales
...
Construye una derivación de 5 a 10 pasos relacionada con **Matrices ortogonales**.
...
La demostración `orthogonal_matrices` recorre este mismo razonamiento en código.
