# Teoría — Vectores unitarios

## Definición operativa

En esta clase, **Vectores unitarios** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`unit_vectors`) devuelve 7 valores. Varios de ellos
