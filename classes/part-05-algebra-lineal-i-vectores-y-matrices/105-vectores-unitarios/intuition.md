# Intuición — Vectores unitarios

## La pregunta antes de la fórmula

¿Qué problema resuelve **Vectores unitarios**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `unit_vectors`: normalizar separa dirección de magnitud.
