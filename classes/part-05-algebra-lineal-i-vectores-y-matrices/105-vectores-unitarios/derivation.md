# Derivación y razonamiento — Vectores unitarios
...
Construye una derivación de 5 a 10 pasos relacionada con **Vectores unitarios**.
...
La demostración `unit_vectors` recorre este mismo razonamiento en código.
