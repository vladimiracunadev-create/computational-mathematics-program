# Evaluación — Operaciones con vectores
...
| Implementación y verificación | 25 % | ejecuta `vector_operations`, interpreta sus salidas y comprueba al menos un invariante |
