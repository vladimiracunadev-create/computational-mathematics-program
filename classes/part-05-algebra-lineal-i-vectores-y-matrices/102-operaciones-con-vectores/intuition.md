# Intuición — Operaciones con vectores

## La pregunta antes de la fórmula

¿Qué problema resuelve **Operaciones con vectores**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `vector_operations`: suma, resta y combinación lineal con interpretación geométrica.
