# Teoría — Operaciones con vectores

## Definición operativa

En esta clase, **Operaciones con vectores** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`vector_operations`) devuelve 8 valores. Varios de ellos
