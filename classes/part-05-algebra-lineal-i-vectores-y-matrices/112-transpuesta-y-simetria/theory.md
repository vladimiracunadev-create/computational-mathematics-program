# Teoría — Transpuesta y simetría

## Definición operativa

En esta clase, **Transpuesta y simetría** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`transpose_symmetry`) devuelve 6 valores. Varios de ellos
