# Evaluación — Transpuesta y simetría
...
| Implementación y verificación | 25 % | ejecuta `transpose_symmetry`, interpreta sus salidas y comprueba al menos un invariante |
