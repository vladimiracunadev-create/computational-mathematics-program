# Intuición — Transpuesta y simetría

## La pregunta antes de la fórmula

¿Qué problema resuelve **Transpuesta y simetría**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `transpose_symmetry`: toda matriz cuadrada se descompone en parte simétrica y antisimétrica.
