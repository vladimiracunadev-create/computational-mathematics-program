# Derivación y razonamiento — Transpuesta y simetría
...
Construye una derivación de 5 a 10 pasos relacionada con **Transpuesta y simetría**.
...
La demostración `transpose_symmetry` recorre este mismo razonamiento en código.
