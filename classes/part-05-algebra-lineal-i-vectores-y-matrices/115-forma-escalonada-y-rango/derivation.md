# Derivación y razonamiento — Forma escalonada y rango
...
Construye una derivación de 5 a 10 pasos relacionada con **Forma escalonada y rango**.
...
La demostración `echelon_rank` recorre este mismo razonamiento en código.
