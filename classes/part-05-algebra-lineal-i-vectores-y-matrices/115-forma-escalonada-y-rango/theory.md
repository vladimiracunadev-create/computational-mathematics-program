# Teoría — Forma escalonada y rango

## Definición operativa

En esta clase, **Forma escalonada y rango** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`echelon_rank`) devuelve 7 valores. Varios de ellos
