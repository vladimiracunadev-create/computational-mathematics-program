# Teoría — Producto punto y similitud

## Definición operativa

En esta clase, **Producto punto y similitud** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`dot_product`) devuelve 7 valores. Varios de ellos
