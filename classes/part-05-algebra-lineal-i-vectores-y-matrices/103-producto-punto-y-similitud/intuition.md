# Intuición — Producto punto y similitud

## La pregunta antes de la fórmula

¿Qué problema resuelve **Producto punto y similitud**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `dot_product`: producto punto: proyección, ángulo y similitud.
