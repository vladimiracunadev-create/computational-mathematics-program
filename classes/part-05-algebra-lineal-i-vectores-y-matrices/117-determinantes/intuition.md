# Intuición — Determinantes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Determinantes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `determinants`: el determinante mide el escalado de volumen y detecta singularidad.
