...
**Motor:** `computational_math.engines.part05` · demostración `determinants`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `determinants` del motor de la parte.
...
- `B_es_singular`
- `det(AB)=det(A)det(B)`
- `det_negativo_invierte_orientacion`
