# Derivación y razonamiento — Determinantes
...
Construye una derivación de 5 a 10 pasos relacionada con **Determinantes**.
...
La demostración `determinants` recorre este mismo razonamiento en código.
