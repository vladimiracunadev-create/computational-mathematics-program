...
**Motor:** `computational_math.engines.part05` · demostración `gaussian_elimination_demo`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `gaussian_elimination_demo` del motor de la parte.
