# Evaluación — Eliminación de Gauss
...
| Implementación y verificación | 25 % | ejecuta `gaussian_elimination_demo`, interpreta sus salidas y comprueba al menos un invariante |
