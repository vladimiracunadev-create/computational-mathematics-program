# Derivación y razonamiento — Eliminación de Gauss
...
Construye una derivación de 5 a 10 pasos relacionada con **Eliminación de Gauss**.
...
La demostración `gaussian_elimination_demo` recorre este mismo razonamiento en código.
