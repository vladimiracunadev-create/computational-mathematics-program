...
**Motor:** `computational_math.engines.part05` · demostración `linear_systems`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `linear_systems` del motor de la parte.
