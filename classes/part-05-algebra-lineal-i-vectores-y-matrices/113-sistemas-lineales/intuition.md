# Intuición — Sistemas lineales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Sistemas lineales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_systems`: sistema 3x3: solución, residuo y unicidad.
