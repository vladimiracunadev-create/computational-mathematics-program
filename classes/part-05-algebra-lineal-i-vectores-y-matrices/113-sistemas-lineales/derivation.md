# Derivación y razonamiento — Sistemas lineales
...
Construye una derivación de 5 a 10 pasos relacionada con **Sistemas lineales**.
...
La demostración `linear_systems` recorre este mismo razonamiento en código.
