# Teoría — Sistemas lineales

## Definición operativa

En esta clase, **Sistemas lineales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_systems`) devuelve 7 valores. Varios de ellos
