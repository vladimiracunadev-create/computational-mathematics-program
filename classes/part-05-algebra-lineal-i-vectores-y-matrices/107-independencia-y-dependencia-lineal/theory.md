# Teoría — Independencia y dependencia lineal

## Definición operativa

En esta clase, **Independencia y dependencia lineal** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_independence`) devuelve 8 valores. Varios de ellos
