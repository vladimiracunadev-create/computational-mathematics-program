# Evaluación — Independencia y dependencia lineal
...
| Implementación y verificación | 25 % | ejecuta `linear_independence`, interpreta sus salidas y comprueba al menos un invariante |
