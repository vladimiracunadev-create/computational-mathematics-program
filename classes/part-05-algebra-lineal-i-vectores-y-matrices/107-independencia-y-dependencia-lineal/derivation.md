# Derivación y razonamiento — Independencia y dependencia lineal
...
Construye una derivación de 5 a 10 pasos relacionada con **Independencia y dependencia lineal**.
...
La demostración `linear_independence` recorre este mismo razonamiento en código.
