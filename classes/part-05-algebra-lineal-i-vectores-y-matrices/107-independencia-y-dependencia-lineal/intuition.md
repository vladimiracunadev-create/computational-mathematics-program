# Intuición — Independencia y dependencia lineal

## La pregunta antes de la fórmula

¿Qué problema resuelve **Independencia y dependencia lineal**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_independence`: independencia detectada por el rango, no por inspección.
