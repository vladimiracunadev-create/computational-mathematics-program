# Intuición — Proyecciones ortogonales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Proyecciones ortogonales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `orthogonal_projection`: proyección sobre un subespacio y descomposición ortogonal.
