# Derivación y razonamiento — Proyecciones ortogonales
...
Construye una derivación de 5 a 10 pasos relacionada con **Proyecciones ortogonales**.
...
La demostración `orthogonal_projection` recorre este mismo razonamiento en código.
