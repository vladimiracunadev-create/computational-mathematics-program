# Teoría — Proyecciones ortogonales

## Definición operativa

En esta clase, **Proyecciones ortogonales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`orthogonal_projection`) devuelve 8 valores. Varios de ellos
