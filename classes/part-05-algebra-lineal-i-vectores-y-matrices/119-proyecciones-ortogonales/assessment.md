# Evaluación — Proyecciones ortogonales
...
| Implementación y verificación | 25 % | ejecuta `orthogonal_projection`, interpreta sus salidas y comprueba al menos un invariante |
