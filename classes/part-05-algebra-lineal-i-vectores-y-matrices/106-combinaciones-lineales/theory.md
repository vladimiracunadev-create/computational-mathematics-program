# Teoría — Combinaciones lineales

## Definición operativa

En esta clase, **Combinaciones lineales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_combinations`) devuelve 6 valores. Varios de ellos
