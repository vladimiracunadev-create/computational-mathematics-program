# Evaluación — Combinaciones lineales
...
| Implementación y verificación | 25 % | ejecuta `linear_combinations`, interpreta sus salidas y comprueba al menos un invariante |
