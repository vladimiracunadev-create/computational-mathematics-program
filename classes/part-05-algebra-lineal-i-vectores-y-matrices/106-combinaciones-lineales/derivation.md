# Derivación y razonamiento — Combinaciones lineales
...
Construye una derivación de 5 a 10 pasos relacionada con **Combinaciones lineales**.
...
La demostración `linear_combinations` recorre este mismo razonamiento en código.
