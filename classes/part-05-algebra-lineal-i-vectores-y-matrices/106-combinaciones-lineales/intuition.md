# Intuición — Combinaciones lineales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Combinaciones lineales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_combinations`: toda combinación lineal de la base canónica reconstruye el vector.
