# Teoría — Normas y distancias

## Definición operativa

En esta clase, **Normas y distancias** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`norms_distances`) devuelve 7 valores. Varios de ellos
