# Intuición — Normas y distancias

## La pregunta antes de la fórmula

¿Qué problema resuelve **Normas y distancias**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `norms_distances`: l1, l2 e l∞ sobre el mismo vector.
