# Derivación y razonamiento — Normas y distancias
...
Construye una derivación de 5 a 10 pasos relacionada con **Normas y distancias**.
...
La demostración `norms_distances` recorre este mismo razonamiento en código.
