# Teoría — Inversa de una matriz

## Definición operativa

En esta clase, **Inversa de una matriz** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`matrix_inverse`) devuelve 7 valores. Varios de ellos
