# Derivación y razonamiento — Inversa de una matriz
...
Construye una derivación de 5 a 10 pasos relacionada con **Inversa de una matriz**.
...
La demostración `matrix_inverse` recorre este mismo razonamiento en código.
