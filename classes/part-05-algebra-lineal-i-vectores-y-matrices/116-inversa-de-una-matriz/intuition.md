# Intuición — Inversa de una matriz

## La pregunta antes de la fórmula

¿Qué problema resuelve **Inversa de una matriz**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `matrix_inverse`: la inversa existe, pero rara vez conviene calcularla.
