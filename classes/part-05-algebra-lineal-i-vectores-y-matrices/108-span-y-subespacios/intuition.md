# Intuición — Span y subespacios

## La pregunta antes de la fórmula

¿Qué problema resuelve **Span y subespacios**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `span_subspaces`: el span de dos vectores en ℝ³ es un plano, no todo el espacio.
