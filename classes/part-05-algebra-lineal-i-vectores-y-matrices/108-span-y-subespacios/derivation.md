# Derivación y razonamiento — Span y subespacios
...
Construye una derivación de 5 a 10 pasos relacionada con **Span y subespacios**.
...
La demostración `span_subspaces` recorre este mismo razonamiento en código.
