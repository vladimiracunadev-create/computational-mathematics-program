# Teoría — Span y subespacios

## Definición operativa

En esta clase, **Span y subespacios** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`span_subspaces`) devuelve 7 valores. Varios de ellos
