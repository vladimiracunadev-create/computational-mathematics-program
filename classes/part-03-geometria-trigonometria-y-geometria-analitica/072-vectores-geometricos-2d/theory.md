# Teoría — Vectores geométricos 2D

## Definición operativa

En esta clase, **Vectores geométricos 2D** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`vectors_2d`) devuelve 9 valores. Varios de ellos
