...
**Motor:** `computational_math.engines.part03` · demostración `vectors_2d`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `vectors_2d` del motor de la parte.
