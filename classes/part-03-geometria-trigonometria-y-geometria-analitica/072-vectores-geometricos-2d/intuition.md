# Intuición — Vectores geométricos 2D

## La pregunta antes de la fórmula

¿Qué problema resuelve **Vectores geométricos 2D**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `vectors_2d`: vector como dirección y magnitud; ángulo entre vectores.
