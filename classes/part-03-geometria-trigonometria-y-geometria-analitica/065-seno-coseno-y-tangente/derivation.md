# Derivación y razonamiento — Seno, coseno y tangente
...
Construye una derivación de 5 a 10 pasos relacionada con **Seno, coseno y tangente**.
...
La demostración `trig_ratios` recorre este mismo razonamiento en código.
