# Intuición — Seno, coseno y tangente

## La pregunta antes de la fórmula

¿Qué problema resuelve **Seno, coseno y tangente**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `trig_ratios`: seno, coseno y tangente sobre un triángulo rectángulo concreto.
