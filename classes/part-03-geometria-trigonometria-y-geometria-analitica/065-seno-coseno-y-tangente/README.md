...
**Motor:** `computational_math.engines.part03` · demostración `trig_ratios`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `trig_ratios` del motor de la parte.
