# Teoría — Seno, coseno y tangente

## Definición operativa

En esta clase, **Seno, coseno y tangente** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`trig_ratios`) devuelve 9 valores. Varios de ellos
