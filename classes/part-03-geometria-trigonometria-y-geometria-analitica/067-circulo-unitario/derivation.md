# Derivación y razonamiento — Círculo unitario
...
Construye una derivación de 5 a 10 pasos relacionada con **Círculo unitario**.
...
La demostración `unit_circle` recorre este mismo razonamiento en código.
