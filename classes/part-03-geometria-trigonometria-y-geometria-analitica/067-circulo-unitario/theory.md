# Teoría — Círculo unitario

## Definición operativa

En esta clase, **Círculo unitario** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`unit_circle`) devuelve 5 valores. Varios de ellos
