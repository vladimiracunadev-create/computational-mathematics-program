...
**Motor:** `computational_math.engines.part03` · demostración `unit_circle`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `unit_circle` del motor de la parte.
