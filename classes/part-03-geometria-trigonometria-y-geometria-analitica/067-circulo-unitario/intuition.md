# Intuición — Círculo unitario

## La pregunta antes de la fórmula

¿Qué problema resuelve **Círculo unitario**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `unit_circle`: el círculo unitario como diccionario de ángulos notables.
