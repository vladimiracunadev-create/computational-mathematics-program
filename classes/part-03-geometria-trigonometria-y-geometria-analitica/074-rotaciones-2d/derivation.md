# Derivación y razonamiento — Rotaciones 2D
...
Construye una derivación de 5 a 10 pasos relacionada con **Rotaciones 2D**.
...
La demostración `rotation_2d` recorre este mismo razonamiento en código.
