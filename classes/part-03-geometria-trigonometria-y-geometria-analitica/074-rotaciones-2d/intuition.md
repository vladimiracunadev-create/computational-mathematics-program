# Intuición — Rotaciones 2D

## La pregunta antes de la fórmula

¿Qué problema resuelve **Rotaciones 2D**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `rotation_2d`: matriz de rotación: ortogonal y de determinante 1.
