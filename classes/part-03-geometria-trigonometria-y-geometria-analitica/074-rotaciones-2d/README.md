...
**Motor:** `computational_math.engines.part03` · demostración `rotation_2d`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `rotation_2d` del motor de la parte.
...
- `RᵀR_es_identidad`
- `preserva_la_norma`
- `cuatro_rotaciones_vuelven_al_origen`
