# Derivación y razonamiento — Distancia punto-recta
...
Construye una derivación de 5 a 10 pasos relacionada con **Distancia punto-recta**.
...
La demostración `point_line_distance` recorre este mismo razonamiento en código.
