...
**Motor:** `computational_math.engines.part03` · demostración `point_line_distance`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `point_line_distance` del motor de la parte.
