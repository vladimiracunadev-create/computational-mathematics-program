# Teoría — Distancia punto-recta

## Definición operativa

En esta clase, **Distancia punto-recta** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`point_line_distance`) devuelve 6 valores. Varios de ellos
