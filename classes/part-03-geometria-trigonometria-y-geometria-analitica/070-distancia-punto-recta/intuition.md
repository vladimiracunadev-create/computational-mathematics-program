# Intuición — Distancia punto-recta

## La pregunta antes de la fórmula

¿Qué problema resuelve **Distancia punto-recta**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `point_line_distance`: distancia de un punto a una recta y su proyección.
