# Evaluación — Distancia punto-recta
...
| Implementación y verificación | 25 % | ejecuta `point_line_distance`, interpreta sus salidas y comprueba al menos un invariante |
