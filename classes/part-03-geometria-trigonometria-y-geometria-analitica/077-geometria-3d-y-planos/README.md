...
**Motor:** `computational_math.engines.part03` · demostración `planes_3d`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `planes_3d` del motor de la parte.
...
- `punto`
- `distancia_al_plano`
- `normal_es_ortogonal_a_a`
- `norma_del_producto_cruz_es_el_area`
