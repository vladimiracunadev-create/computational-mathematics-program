# Intuición — Geometría 3D y planos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Geometría 3D y planos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `planes_3d`: plano por su normal, distancia de un punto y producto cruz.
