# Derivación y razonamiento — Geometría 3D y planos
...
Construye una derivación de 5 a 10 pasos relacionada con **Geometría 3D y planos**.
...
La demostración `planes_3d` recorre este mismo razonamiento en código.
