# Teoría — Geometría 3D y planos

## Definición operativa

En esta clase, **Geometría 3D y planos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`planes_3d`) devuelve 8 valores. Varios de ellos
