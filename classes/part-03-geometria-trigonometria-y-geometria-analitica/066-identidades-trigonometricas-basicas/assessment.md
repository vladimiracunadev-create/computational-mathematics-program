# Evaluación — Identidades trigonométricas básicas
...
| Implementación y verificación | 25 % | ejecuta `trig_identities`, interpreta sus salidas y comprueba al menos un invariante |
