# Teoría — Identidades trigonométricas básicas

## Definición operativa

En esta clase, **Identidades trigonométricas básicas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`trig_identities`) devuelve 5 valores. Varios de ellos
