# Intuición — Identidades trigonométricas básicas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Identidades trigonométricas básicas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `trig_identities`: identidades fundamentales verificadas en varios ángulos.
