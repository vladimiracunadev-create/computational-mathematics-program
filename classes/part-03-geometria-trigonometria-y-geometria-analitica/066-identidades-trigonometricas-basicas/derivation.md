# Derivación y razonamiento — Identidades trigonométricas básicas
...
Construye una derivación de 5 a 10 pasos relacionada con **Identidades trigonométricas básicas**.
...
La demostración `trig_identities` recorre este mismo razonamiento en código.
