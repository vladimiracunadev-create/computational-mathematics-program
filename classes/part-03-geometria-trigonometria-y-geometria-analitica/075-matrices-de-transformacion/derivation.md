# Derivación y razonamiento — Matrices de transformación
...
Construye una derivación de 5 a 10 pasos relacionada con **Matrices de transformación**.
...
La demostración `transform_matrices` recorre este mismo razonamiento en código.
