# Evaluación — Matrices de transformación
...
| Implementación y verificación | 25 % | ejecuta `transform_matrices`, interpreta sus salidas y comprueba al menos un invariante |
