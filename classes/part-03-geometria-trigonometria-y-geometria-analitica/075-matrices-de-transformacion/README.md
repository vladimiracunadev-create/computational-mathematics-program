...
**Motor:** `computational_math.engines.part03` · demostración `transform_matrices`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `transform_matrices` del motor de la parte.
...
- `det_escala`
- `det_reflexion`
- `reflexion_invierte_orientacion`
