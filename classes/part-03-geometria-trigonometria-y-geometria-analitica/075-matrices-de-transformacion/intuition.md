# Intuición — Matrices de transformación

## La pregunta antes de la fórmula

¿Qué problema resuelve **Matrices de transformación**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `transform_matrices`: composición de rotación, escala y reflexión.
