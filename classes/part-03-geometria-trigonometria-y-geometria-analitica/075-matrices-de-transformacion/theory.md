# Teoría — Matrices de transformación

## Definición operativa

En esta clase, **Matrices de transformación** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`transform_matrices`) devuelve 8 valores. Varios de ellos
