# Teoría — Teorema de Pitágoras

## Definición operativa

En esta clase, **Teorema de Pitágoras** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`pythagoras`) devuelve 7 valores. Varios de ellos
