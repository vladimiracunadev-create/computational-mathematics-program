# Derivación y razonamiento — Teorema de Pitágoras
...
Construye una derivación de 5 a 10 pasos relacionada con **Teorema de Pitágoras**.
...
La demostración `pythagoras` recorre este mismo razonamiento en código.
