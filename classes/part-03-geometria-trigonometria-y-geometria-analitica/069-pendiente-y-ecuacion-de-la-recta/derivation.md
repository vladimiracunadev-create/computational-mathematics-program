# Derivación y razonamiento — Pendiente y ecuación de la recta
...
Construye una derivación de 5 a 10 pasos relacionada con **Pendiente y ecuación de la recta**.
...
La demostración `line_equation` recorre este mismo razonamiento en código.
