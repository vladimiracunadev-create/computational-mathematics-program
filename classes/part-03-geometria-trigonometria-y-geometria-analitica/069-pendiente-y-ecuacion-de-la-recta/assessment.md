# Evaluación — Pendiente y ecuación de la recta
...
| Implementación y verificación | 25 % | ejecuta `line_equation`, interpreta sus salidas y comprueba al menos un invariante |
