...
**Motor:** `computational_math.engines.part03` · demostración `line_equation`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `line_equation` del motor de la parte.
