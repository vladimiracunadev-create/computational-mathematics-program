# Intuición — Pendiente y ecuación de la recta

## La pregunta antes de la fórmula

¿Qué problema resuelve **Pendiente y ecuación de la recta**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `line_equation`: recta en forma pendiente-intercepto y en forma general.
