# Teoría — Circunferencias y cónicas

## Definición operativa

En esta clase, **Circunferencias y cónicas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`conics`) devuelve 9 valores. Varios de ellos
