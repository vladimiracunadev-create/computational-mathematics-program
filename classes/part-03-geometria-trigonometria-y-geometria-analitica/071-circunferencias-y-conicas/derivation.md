# Derivación y razonamiento — Circunferencias y cónicas
...
Construye una derivación de 5 a 10 pasos relacionada con **Circunferencias y cónicas**.
...
La demostración `conics` recorre este mismo razonamiento en código.
