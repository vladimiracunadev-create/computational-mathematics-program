# Intuición — Circunferencias y cónicas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Circunferencias y cónicas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `conics`: circunferencia, elipse y parábola desde su ecuación.
