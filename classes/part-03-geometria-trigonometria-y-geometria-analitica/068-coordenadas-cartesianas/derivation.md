# Derivación y razonamiento — Coordenadas cartesianas
...
Construye una derivación de 5 a 10 pasos relacionada con **Coordenadas cartesianas**.
...
La demostración `cartesian_coordinates` recorre este mismo razonamiento en código.
