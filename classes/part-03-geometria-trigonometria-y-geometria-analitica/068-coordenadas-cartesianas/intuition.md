# Intuición — Coordenadas cartesianas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Coordenadas cartesianas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `cartesian_coordinates`: cuadrantes, simetrías y traslación de origen.
