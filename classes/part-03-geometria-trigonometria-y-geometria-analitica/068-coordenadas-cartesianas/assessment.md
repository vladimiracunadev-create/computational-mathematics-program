# Evaluación — Coordenadas cartesianas
...
| Implementación y verificación | 25 % | ejecuta `cartesian_coordinates`, interpreta sus salidas y comprueba al menos un invariante |
