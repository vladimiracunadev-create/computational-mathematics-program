# Teoría — Coordenadas cartesianas

## Definición operativa

En esta clase, **Coordenadas cartesianas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`cartesian_coordinates`) devuelve 6 valores. Varios de ellos
