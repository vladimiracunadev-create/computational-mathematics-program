# Intuición — Triángulos y semejanza

## La pregunta antes de la fórmula

¿Qué problema resuelve **Triángulos y semejanza**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `similar_triangles`: semejanza: los ángulos se conservan, las longitudes escalan.
