# Derivación y razonamiento — Triángulos y semejanza
...
Construye una derivación de 5 a 10 pasos relacionada con **Triángulos y semejanza**.
...
La demostración `similar_triangles` recorre este mismo razonamiento en código.
