# Teoría — Triángulos y semejanza

## Definición operativa

En esta clase, **Triángulos y semejanza** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`similar_triangles`) devuelve 8 valores. Varios de ellos
