# Intuición — Ángulos y radianes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Ángulos y radianes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `angles_radians`: grados y radianes: por qué el radián es la unidad natural.
