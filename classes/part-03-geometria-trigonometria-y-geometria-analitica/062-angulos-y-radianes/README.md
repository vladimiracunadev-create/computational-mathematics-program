...
**Motor:** `computational_math.engines.part03` · demostración `angles_radians`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `angles_radians` del motor de la parte.
