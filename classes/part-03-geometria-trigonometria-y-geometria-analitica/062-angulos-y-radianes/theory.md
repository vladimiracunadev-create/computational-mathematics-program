# Teoría — Ángulos y radianes

## Definición operativa

En esta clase, **Ángulos y radianes** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`angles_radians`) devuelve 7 valores. Varios de ellos
