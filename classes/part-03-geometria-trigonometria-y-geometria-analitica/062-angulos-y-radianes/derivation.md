# Derivación y razonamiento — Ángulos y radianes
...
Construye una derivación de 5 a 10 pasos relacionada con **Ángulos y radianes**.
...
La demostración `angles_radians` recorre este mismo razonamiento en código.
