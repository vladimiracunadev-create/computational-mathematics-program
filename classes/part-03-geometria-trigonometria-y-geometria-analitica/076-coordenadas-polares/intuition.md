# Intuición — Coordenadas polares

## La pregunta antes de la fórmula

¿Qué problema resuelve **Coordenadas polares**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `polar_coordinates`: conversión cartesiana ↔ polar y su ida y vuelta.
