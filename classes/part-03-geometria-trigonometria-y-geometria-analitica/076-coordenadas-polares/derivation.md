# Derivación y razonamiento — Coordenadas polares
...
Construye una derivación de 5 a 10 pasos relacionada con **Coordenadas polares**.
...
La demostración `polar_coordinates` recorre este mismo razonamiento en código.
