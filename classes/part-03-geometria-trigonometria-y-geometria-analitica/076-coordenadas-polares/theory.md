# Teoría — Coordenadas polares

## Definición operativa

En esta clase, **Coordenadas polares** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`polar_coordinates`) devuelve 7 valores. Varios de ellos
