# Teoría — Proyecciones y perspectiva

## Definición operativa

En esta clase, **Proyecciones y perspectiva** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`projection`) devuelve 8 valores. Varios de ellos
