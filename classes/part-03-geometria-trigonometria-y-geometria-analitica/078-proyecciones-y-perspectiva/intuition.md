# Intuición — Proyecciones y perspectiva

## La pregunta antes de la fórmula

¿Qué problema resuelve **Proyecciones y perspectiva**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `projection`: proyección ortogonal de un vector y proyección en perspectiva.
