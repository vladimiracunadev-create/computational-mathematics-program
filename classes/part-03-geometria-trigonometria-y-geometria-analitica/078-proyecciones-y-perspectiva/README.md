...
**Motor:** `computational_math.engines.part03` · demostración `projection`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `projection` del motor de la parte.
...
- `proyeccion`
- `residuo`
- `residuo_ortogonal_a_u`
- `pitagoras`
- `perspectiva_x'_con_f=2_z=5`
- `objetos_lejanos_se_encogen`
