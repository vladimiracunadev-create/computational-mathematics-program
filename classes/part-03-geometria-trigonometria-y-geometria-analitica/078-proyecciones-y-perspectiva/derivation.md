# Derivación y razonamiento — Proyecciones y perspectiva
...
Construye una derivación de 5 a 10 pasos relacionada con **Proyecciones y perspectiva**.
...
La demostración `projection` recorre este mismo razonamiento en código.
