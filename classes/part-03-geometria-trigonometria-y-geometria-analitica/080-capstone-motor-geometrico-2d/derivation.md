# Derivación y razonamiento — Capstone: motor geométrico 2D
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: motor geométrico 2D**.
...
La demostración `capstone_geometry_engine` recorre este mismo razonamiento en código.
