# Teoría — Capstone: motor geométrico 2D

## Definición operativa

En esta clase, **Capstone: motor geométrico 2D** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_geometry_engine`) devuelve 7 valores. Varios de ellos
