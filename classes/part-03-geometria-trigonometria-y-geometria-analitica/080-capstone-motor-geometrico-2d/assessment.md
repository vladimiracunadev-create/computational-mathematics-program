# Evaluación — Capstone: motor geométrico 2D
...
| Implementación y verificación | 25 % | ejecuta `capstone_geometry_engine`, interpreta sus salidas y comprueba al menos un invariante |
