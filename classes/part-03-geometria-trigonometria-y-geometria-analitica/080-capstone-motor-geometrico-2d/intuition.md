# Intuición — Capstone: motor geométrico 2D

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: motor geométrico 2D**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `capstone_geometry_engine`: capstone: motor 2d que compone transformaciones sobre un polígono.
