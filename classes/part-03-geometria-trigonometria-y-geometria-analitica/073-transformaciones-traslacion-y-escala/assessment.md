# Evaluación — Transformaciones: traslación y escala
...
| Implementación y verificación | 25 % | ejecuta `translation_scale`, interpreta sus salidas y comprueba al menos un invariante |
