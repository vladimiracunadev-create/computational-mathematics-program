# Teoría — Transformaciones: traslación y escala

## Definición operativa

En esta clase, **Transformaciones: traslación y escala** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`translation_scale`) devuelve 6 valores. Varios de ellos
