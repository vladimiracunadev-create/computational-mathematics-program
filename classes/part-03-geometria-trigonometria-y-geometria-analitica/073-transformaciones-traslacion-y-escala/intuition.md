# Intuición — Transformaciones: traslación y escala

## La pregunta antes de la fórmula

¿Qué problema resuelve **Transformaciones: traslación y escala**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `translation_scale`: traslación y escala en coordenadas homogéneas.
