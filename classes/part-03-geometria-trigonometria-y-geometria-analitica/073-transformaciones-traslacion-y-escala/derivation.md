# Derivación y razonamiento — Transformaciones: traslación y escala
...
Construye una derivación de 5 a 10 pasos relacionada con **Transformaciones: traslación y escala**.
...
La demostración `translation_scale` recorre este mismo razonamiento en código.
