# Derivación y razonamiento — Puntos, segmentos y distancias
...
Construye una derivación de 5 a 10 pasos relacionada con **Puntos, segmentos y distancias**.
...
La demostración `distances` recorre este mismo razonamiento en código.
