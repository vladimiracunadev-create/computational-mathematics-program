# Teoría — Puntos, segmentos y distancias

## Definición operativa

En esta clase, **Puntos, segmentos y distancias** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`distances`) devuelve 7 valores. Varios de ellos
