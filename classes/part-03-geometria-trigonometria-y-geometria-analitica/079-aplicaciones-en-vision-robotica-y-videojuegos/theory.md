# Teoría — Aplicaciones en visión, robótica y videojuegos

## Definición operativa

En esta clase, **Aplicaciones en visión, robótica y videojuegos** se trata como un objeto con tres capas
separadas:
...
## Ideas centrales de la parte 03
...
El laboratorio (`applications_pipeline`) devuelve 6 valores. Varios de ellos
