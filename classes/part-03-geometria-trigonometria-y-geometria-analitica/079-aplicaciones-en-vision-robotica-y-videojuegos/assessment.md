# Evaluación — Aplicaciones en visión, robótica y videojuegos
...
| Implementación y verificación | 25 % | ejecuta `applications_pipeline`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con gráficos por computador o con IA |
...
5. ¿Dónde aparece este concepto en gráficos por computador?
