# Intuición — Aplicaciones en visión, robótica y videojuegos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Aplicaciones en visión, robótica y videojuegos**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Geometría, trigonometría y geometría analítica**. Del espacio a las coordenadas: distancia, ángulo, trigonometría, transformaciones lineales en el plano, coordenadas polares y proyección.
...
El laboratorio ejecuta `applications_pipeline`: pipeline geométrico típico: modelo → mundo → cámara → pantalla.
