# Teoría — Policy gradients

## Definición operativa

En esta clase, **Policy gradients** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`policy_gradients`) devuelve 11 valores. Varios de ellos
