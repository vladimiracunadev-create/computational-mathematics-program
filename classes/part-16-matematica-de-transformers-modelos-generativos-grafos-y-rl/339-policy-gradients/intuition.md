# Intuición — Policy gradients

## La pregunta antes de la fórmula

¿Qué problema resuelve **Policy gradients**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `policy_gradients`: reinforce: gradiente de la política sobre un bandido de 3 brazos.
