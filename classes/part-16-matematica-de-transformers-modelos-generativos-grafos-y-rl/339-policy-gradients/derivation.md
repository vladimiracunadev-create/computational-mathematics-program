# Derivación y razonamiento — Policy gradients
...
Construye una derivación de 5 a 10 pasos relacionada con **Policy gradients**.
...
La demostración `policy_gradients` recorre este mismo razonamiento en código.
