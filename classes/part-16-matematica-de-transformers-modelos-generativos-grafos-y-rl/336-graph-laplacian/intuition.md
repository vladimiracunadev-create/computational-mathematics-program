# Intuición — Graph Laplacian

## La pregunta antes de la fórmula

¿Qué problema resuelve **Graph Laplacian**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `graph_laplacian`: laplaciano del grafo: espectro y componentes conexas.
