# Teoría — Graph Laplacian

## Definición operativa

En esta clase, **Graph Laplacian** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`graph_laplacian`) devuelve 12 valores. Varios de ellos
