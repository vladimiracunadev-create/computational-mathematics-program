# Derivación y razonamiento — Self-attention
...
Construye una derivación de 5 a 10 pasos relacionada con **Self-attention**.
...
La demostración `self_attention` recorre este mismo razonamiento en código.
