# Teoría — Self-attention

## Definición operativa

En esta clase, **Self-attention** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`self_attention`) devuelve 10 valores. Varios de ellos
