# Intuición — Self-attention

## La pregunta antes de la fórmula

¿Qué problema resuelve **Self-attention**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `self_attention`: self-attention completa sobre una secuencia de 4 tokens.
