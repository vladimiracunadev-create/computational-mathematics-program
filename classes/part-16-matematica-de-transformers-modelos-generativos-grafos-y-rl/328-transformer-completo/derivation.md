# Derivación y razonamiento — Transformer completo
...
Construye una derivación de 5 a 10 pasos relacionada con **Transformer completo**.
...
La demostración `transformer_block` recorre este mismo razonamiento en código.
