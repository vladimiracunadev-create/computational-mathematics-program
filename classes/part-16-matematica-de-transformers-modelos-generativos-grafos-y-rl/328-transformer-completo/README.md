...
- [Xiong, R. et al. *On Layer Normalization in the Transformer Architecture*, ICML, 2020](https://arxiv.org/abs/2002.04745) — Deep learning y Modelos de lenguaje: el tema de esta clase · DOI `10.48550/arxiv.2002.04745` verificado en DataCite (2026-08-19).
