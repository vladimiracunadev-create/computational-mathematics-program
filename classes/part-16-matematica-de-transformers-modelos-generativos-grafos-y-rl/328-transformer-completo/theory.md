# Teoría — Transformer completo

## Definición operativa

En esta clase, **Transformer completo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`transformer_block`) devuelve 12 valores. Varios de ellos
