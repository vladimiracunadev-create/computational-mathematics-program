# Intuición — Transformer completo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Transformer completo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `transformer_block`: bloque transformer: atención, residual, layer norm y feed-forward.
