# Teoría — Bellman equations

## Definición operativa

En esta clase, **Bellman equations** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`bellman_equations`) devuelve 11 valores. Varios de ellos
