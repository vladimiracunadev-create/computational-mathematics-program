# Derivación y razonamiento — Bellman equations
...
Construye una derivación de 5 a 10 pasos relacionada con **Bellman equations**.
...
La demostración `bellman_equations` recorre este mismo razonamiento en código.
