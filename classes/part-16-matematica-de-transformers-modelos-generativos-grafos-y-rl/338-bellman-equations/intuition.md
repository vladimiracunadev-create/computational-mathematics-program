# Intuición — Bellman equations

## La pregunta antes de la fórmula

¿Qué problema resuelve **Bellman equations**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bellman_equations`: iteración de valor sobre un mdp pequeño.
