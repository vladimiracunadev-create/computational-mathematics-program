...
- [Sutton, R.; Barto, A. *Reinforcement Learning: An Introduction*, 2ª ed., MIT Press, 2018](http://incompleteideas.net/book/the-book.html) — Aprendizaje por refuerzo: el tema de esta clase · URL de la fuente primaria, pendiente de resolver.
- [Bellman, R. *Dynamic Programming*, Princeton University Press, 1957](https://press.princeton.edu/books/paperback/9780691146683/dynamic-programming) — Aprendizaje por refuerzo: el tema de esta clase · ISBN-13 `9780691146683` verificado en International ISBN Agency (2026-08-19).
