...
**Motor:** `computational_math.engines.part16` · demostración `bellman_equations`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `bellman_equations` del motor de la parte.
