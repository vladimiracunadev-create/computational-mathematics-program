# Derivación y razonamiento — Query, Key y Value
...
Construye una derivación de 5 a 10 pasos relacionada con **Query, Key y Value**.
...
La demostración `query_key_value` recorre este mismo razonamiento en código.
