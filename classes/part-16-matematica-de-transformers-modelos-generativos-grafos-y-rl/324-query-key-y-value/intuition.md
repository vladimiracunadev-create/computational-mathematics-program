# Intuición — Query, Key y Value

## La pregunta antes de la fórmula

¿Qué problema resuelve **Query, Key y Value**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `query_key_value`: q, k, v: tres proyecciones distintas del mismo token.
