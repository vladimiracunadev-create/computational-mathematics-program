# Teoría — Variational Autoencoders

## Definición operativa

En esta clase, **Variational Autoencoders** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`variational_autoencoder`) devuelve 12 valores. Varios de ellos
