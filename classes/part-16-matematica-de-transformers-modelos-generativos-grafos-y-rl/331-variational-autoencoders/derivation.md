# Derivación y razonamiento — Variational Autoencoders
...
Construye una derivación de 5 a 10 pasos relacionada con **Variational Autoencoders**.
...
La demostración `variational_autoencoder` recorre este mismo razonamiento en código.
