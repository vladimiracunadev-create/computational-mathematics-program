# Evaluación — Variational Autoencoders
...
| Implementación y verificación | 25 % | ejecuta `variational_autoencoder`, interpreta sus salidas y comprueba al menos un invariante |
