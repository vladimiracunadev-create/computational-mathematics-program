...
**Motor:** `computational_math.engines.part16` · demostración `variational_autoencoder`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `variational_autoencoder` del motor de la parte.
