...
- [Kingma, D.; Welling, M. *Auto-Encoding Variational Bayes*, ICLR, 2014](https://arxiv.org/abs/1312.6114) — Modelos generativos: el tema de esta clase · DOI `10.48550/arxiv.1312.6114` verificado en DataCite (2026-08-19).
- [Doersch, C. *Tutorial on Variational Autoencoders*, 2016](https://arxiv.org/abs/1606.05908) — Deep learning y Modelos generativos: el tema de esta clase · DOI `10.48550/arxiv.1606.05908` verificado en DataCite (2026-08-19).
