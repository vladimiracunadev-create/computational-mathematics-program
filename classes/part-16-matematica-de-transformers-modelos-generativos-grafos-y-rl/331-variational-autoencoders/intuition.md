# Intuición — Variational Autoencoders

## La pregunta antes de la fórmula

¿Qué problema resuelve **Variational Autoencoders**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `variational_autoencoder`: vae: reparametrización y el término kl en forma cerrada.
