# Intuición — ELBO y variational inference

## La pregunta antes de la fórmula

¿Qué problema resuelve **ELBO y variational inference**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `elbo`: elbo: reconstrucción menos kl, y su relación con la log-verosimilitud.
