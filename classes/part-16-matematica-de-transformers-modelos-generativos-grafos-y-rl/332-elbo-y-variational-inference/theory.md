# Teoría — ELBO y variational inference

## Definición operativa

En esta clase, **ELBO y variational inference** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`elbo`) devuelve 10 valores. Varios de ellos
