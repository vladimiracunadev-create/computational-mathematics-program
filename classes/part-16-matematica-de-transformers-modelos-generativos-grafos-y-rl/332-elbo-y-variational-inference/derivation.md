# Derivación y razonamiento — ELBO y variational inference
...
Construye una derivación de 5 a 10 pasos relacionada con **ELBO y variational inference**.
...
La demostración `elbo` recorre este mismo razonamiento en código.
