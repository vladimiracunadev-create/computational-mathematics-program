# Teoría — Softmax y distribuciones categóricas

## Definición operativa

En esta clase, **Softmax y distribuciones categóricas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`softmax_distributions`) devuelve 9 valores. Varios de ellos
