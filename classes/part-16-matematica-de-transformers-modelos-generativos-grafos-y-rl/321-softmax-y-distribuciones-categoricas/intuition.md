# Intuición — Softmax y distribuciones categóricas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Softmax y distribuciones categóricas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `softmax_distributions`: softmax: de logits arbitrarios a una distribución categórica.
