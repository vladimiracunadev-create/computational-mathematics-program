# Derivación y razonamiento — Softmax y distribuciones categóricas
...
Construye una derivación de 5 a 10 pasos relacionada con **Softmax y distribuciones categóricas**.
...
La demostración `softmax_distributions` recorre este mismo razonamiento en código.
