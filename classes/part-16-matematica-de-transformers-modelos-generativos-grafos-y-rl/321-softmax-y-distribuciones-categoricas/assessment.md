# Evaluación — Softmax y distribuciones categóricas
...
| Implementación y verificación | 25 % | ejecuta `softmax_distributions`, interpreta sus salidas y comprueba al menos un invariante |
