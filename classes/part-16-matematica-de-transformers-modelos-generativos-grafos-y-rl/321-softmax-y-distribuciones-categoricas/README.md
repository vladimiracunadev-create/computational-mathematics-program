...
**Motor:** `computational_math.engines.part16` · demostración `softmax_distributions`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `softmax_distributions` del motor de la parte.
...
- `con_logits_enormes`
- `sin_restar_el_maximo`
- `el_orden_se_conserva`
- `temperatura_alta_aplana`
- `temperatura_baja_afila`
