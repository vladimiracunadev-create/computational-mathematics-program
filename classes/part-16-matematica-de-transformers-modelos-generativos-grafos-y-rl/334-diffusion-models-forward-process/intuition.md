# Intuición — Diffusion models: forward process

## La pregunta antes de la fórmula

¿Qué problema resuelve **Diffusion models: forward process**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `diffusion_forward`: proceso directo de difusión: ruido añadido con horario fijo.
