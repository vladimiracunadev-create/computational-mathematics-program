...
**Motor:** `computational_math.engines.part16` · demostración `diffusion_forward`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `diffusion_forward` del motor de la parte.
...
- `formula`
- `traza`
- `salto_directo_a_cualquier_t`
- `x_T_es_ruido_puro`
- `el_proceso_directo_no_se_aprende`
- `semilla`
