# Teoría — Diffusion models: forward process

## Definición operativa

En esta clase, **Diffusion models: forward process** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`diffusion_forward`) devuelve 9 valores. Varios de ellos
