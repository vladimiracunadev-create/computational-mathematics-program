# Derivación y razonamiento — Diffusion models: forward process
...
Construye una derivación de 5 a 10 pasos relacionada con **Diffusion models: forward process**.
...
La demostración `diffusion_forward` recorre este mismo razonamiento en código.
