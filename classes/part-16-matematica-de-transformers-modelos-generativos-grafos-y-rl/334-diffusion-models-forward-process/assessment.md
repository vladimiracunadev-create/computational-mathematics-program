# Evaluación — Diffusion models: forward process
...
| Implementación y verificación | 25 % | ejecuta `diffusion_forward`, interpreta sus salidas y comprueba al menos un invariante |
