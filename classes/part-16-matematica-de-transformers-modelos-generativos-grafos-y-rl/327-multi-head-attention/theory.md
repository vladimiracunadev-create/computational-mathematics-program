# Teoría — Multi-head attention

## Definición operativa

En esta clase, **Multi-head attention** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`multi_head_attention`) devuelve 10 valores. Varios de ellos
