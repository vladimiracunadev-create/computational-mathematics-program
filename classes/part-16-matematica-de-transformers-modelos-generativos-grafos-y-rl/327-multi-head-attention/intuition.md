# Intuición — Multi-head attention

## La pregunta antes de la fórmula

¿Qué problema resuelve **Multi-head attention**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `multi_head_attention`: multi-head: varias atenciones en subespacios distintos.
