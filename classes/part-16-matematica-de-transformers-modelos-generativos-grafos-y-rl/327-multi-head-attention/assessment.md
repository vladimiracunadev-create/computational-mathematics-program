# Evaluación — Multi-head attention
...
| Implementación y verificación | 25 % | ejecuta `multi_head_attention`, interpreta sus salidas y comprueba al menos un invariante |
