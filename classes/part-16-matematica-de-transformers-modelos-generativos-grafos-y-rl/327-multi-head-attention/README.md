...
- [Michel, P.; Levy, O.; Neubig, G. *Are sixteen heads really better than one?*, NeurIPS, 2019](https://arxiv.org/abs/1905.10650) — Deep learning y Modelos de lenguaje: el tema de esta clase · DOI `10.48550/arxiv.1905.10650` verificado en DataCite (2026-08-19).
