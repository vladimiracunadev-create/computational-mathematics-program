...
**Motor:** `computational_math.engines.part16` · demostración `multi_head_attention`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `multi_head_attention` del motor de la parte.
...
- `las_cabezas_atienden_distinto`
- `parametros_totales`
- `parametros_de_una_sola_cabeza_ancha`
- `coste_igual`
- `beneficio`
- `concatenacion_y_proyeccion_final`
