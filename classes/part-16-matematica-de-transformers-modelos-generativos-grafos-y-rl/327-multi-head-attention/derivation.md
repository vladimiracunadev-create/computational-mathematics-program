# Derivación y razonamiento — Multi-head attention
...
Construye una derivación de 5 a 10 pasos relacionada con **Multi-head attention**.
...
La demostración `multi_head_attention` recorre este mismo razonamiento en código.
