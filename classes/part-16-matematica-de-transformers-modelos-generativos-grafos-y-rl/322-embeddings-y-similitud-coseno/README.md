...
- [Mikolov, T. et al. *Distributed representations of words and phrases*, NeurIPS, 2013](https://arxiv.org/abs/1310.4546) — Deep learning y Modelos de lenguaje: el tema de esta clase · DOI `10.48550/arxiv.1310.4546` verificado en DataCite (2026-08-19).
- [Reimers, N.; Gurevych, I. *Sentence-BERT*, EMNLP, 2019](https://arxiv.org/abs/1908.10084) — Deep learning y Modelos de lenguaje: el tema de esta clase · DOI `10.48550/arxiv.1908.10084` verificado en DataCite (2026-08-19).
