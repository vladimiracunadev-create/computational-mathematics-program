...
**Motor:** `computational_math.engines.part16` · demostración `cosine_similarity`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `cosine_similarity` del motor de la parte.
...
- `el_escalado_no_afecta_al_coseno`
- `el_escalado_si_afecta_a_la_distancia`
- `rango`
- `mas_similar`
- `uso`
