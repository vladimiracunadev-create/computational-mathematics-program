# Evaluación — Embeddings y similitud coseno
...
| Implementación y verificación | 25 % | ejecuta `cosine_similarity`, interpreta sus salidas y comprueba al menos un invariante |
