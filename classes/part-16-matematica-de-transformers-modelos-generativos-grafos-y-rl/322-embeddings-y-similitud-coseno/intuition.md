# Intuición — Embeddings y similitud coseno

## La pregunta antes de la fórmula

¿Qué problema resuelve **Embeddings y similitud coseno**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `cosine_similarity`: similitud coseno: la métrica estándar entre embeddings.
