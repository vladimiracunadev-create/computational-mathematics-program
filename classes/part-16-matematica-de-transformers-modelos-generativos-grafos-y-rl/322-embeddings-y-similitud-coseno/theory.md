# Teoría — Embeddings y similitud coseno

## Definición operativa

En esta clase, **Embeddings y similitud coseno** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`cosine_similarity`) devuelve 8 valores. Varios de ellos
