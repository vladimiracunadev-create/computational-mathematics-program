# Derivación y razonamiento — Sampling, temperatura, top-k y top-p
...
Construye una derivación de 5 a 10 pasos relacionada con **Sampling, temperatura, top-k y top-p**.
...
La demostración `sampling_strategies` recorre este mismo razonamiento en código.
