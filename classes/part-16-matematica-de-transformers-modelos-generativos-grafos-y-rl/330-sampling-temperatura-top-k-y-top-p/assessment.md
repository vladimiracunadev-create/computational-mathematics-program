# Evaluación — Sampling, temperatura, top-k y top-p
...
| Implementación y verificación | 25 % | ejecuta `sampling_strategies`, interpreta sus salidas y comprueba al menos un invariante |
