# Teoría — Sampling, temperatura, top-k y top-p

## Definición operativa

En esta clase, **Sampling, temperatura, top-k y top-p** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sampling_strategies`) devuelve 9 valores. Varios de ellos
