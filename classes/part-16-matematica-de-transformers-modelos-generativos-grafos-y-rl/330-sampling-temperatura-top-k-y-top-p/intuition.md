# Intuición — Sampling, temperatura, top-k y top-p

## La pregunta antes de la fórmula

¿Qué problema resuelve **Sampling, temperatura, top-k y top-p**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sampling_strategies`: temperatura, top-k y top-p reescriben la distribución antes de muestrear.
