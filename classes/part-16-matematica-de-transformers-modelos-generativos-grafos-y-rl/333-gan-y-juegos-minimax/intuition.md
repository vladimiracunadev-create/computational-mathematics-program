# Intuición — GAN y juegos minimax

## La pregunta antes de la fórmula

¿Qué problema resuelve **GAN y juegos minimax**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `gan_minimax`: gan: el equilibrio del juego minimax y su punto óptimo.
