# Teoría — GAN y juegos minimax

## Definición operativa

En esta clase, **GAN y juegos minimax** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`gan_minimax`) devuelve 9 valores. Varios de ellos
