...
- [Goodfellow, I. et al. *Generative Adversarial Networks*, NeurIPS, 2014](https://arxiv.org/abs/1406.2661) — Deep learning y Modelos generativos: el tema de esta clase · DOI `10.48550/arxiv.1406.2661` verificado en DataCite (2026-08-19).
- [Arjovsky, M.; Chintala, S.; Bottou, L. *Wasserstein GAN*, ICML, 2017](https://arxiv.org/abs/1701.07875) — Deep learning y Modelos generativos: el tema de esta clase · DOI `10.48550/arxiv.1701.07875` verificado en DataCite (2026-08-19).
