# Teoría — Diffusion models: reverse process

## Definición operativa

En esta clase, **Diffusion models: reverse process** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`diffusion_reverse`) devuelve 12 valores. Varios de ellos
