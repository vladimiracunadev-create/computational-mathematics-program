# Ejercicios — Diffusion models: reverse process

## Básico

1. Define **Diffusion models: reverse process** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 12 salidas.
