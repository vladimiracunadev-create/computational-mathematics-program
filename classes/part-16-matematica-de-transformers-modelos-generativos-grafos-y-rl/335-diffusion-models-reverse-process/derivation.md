# Derivación y razonamiento — Diffusion models: reverse process
...
Construye una derivación de 5 a 10 pasos relacionada con **Diffusion models: reverse process**.
...
La demostración `diffusion_reverse` recorre este mismo razonamiento en código.
