# Evaluación — Diffusion models: reverse process
...
| Implementación y verificación | 25 % | ejecuta `diffusion_reverse`, interpreta sus salidas y comprueba al menos un invariante |
