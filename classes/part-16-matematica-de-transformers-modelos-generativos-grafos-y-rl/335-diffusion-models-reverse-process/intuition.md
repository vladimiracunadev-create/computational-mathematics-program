# Intuición — Diffusion models: reverse process

## La pregunta antes de la fórmula

¿Qué problema resuelve **Diffusion models: reverse process**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `diffusion_reverse`: proceso inverso: la red predice el ruido y se reconstruye x₀.
