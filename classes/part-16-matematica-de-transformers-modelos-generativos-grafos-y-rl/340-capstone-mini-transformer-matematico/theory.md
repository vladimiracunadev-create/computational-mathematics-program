# Teoría — Capstone: mini-Transformer matemático

## Definición operativa

En esta clase, **Capstone: mini-Transformer matemático** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_mini_transformer`) devuelve 20 valores. Varios de ellos
