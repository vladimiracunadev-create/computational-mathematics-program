# Derivación y razonamiento — Capstone: mini-Transformer matemático
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: mini-Transformer matemático**.
...
La demostración `capstone_mini_transformer` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part16.py` y responde:
