# Intuición — Capstone: mini-Transformer matemático

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: mini-Transformer matemático**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Matemática de Transformers, modelos generativos, grafos y RL**. Softmax, embeddings, positional encoding, atención escalada, multi-head, Transformer completo, muestreo, VAE, GAN, difusión, GNN y ecuaciones de Bellman.
...
El laboratorio ejecuta `capstone_mini_transformer`: capstone: mini-transformer que aprende a copiar el token anterior.
