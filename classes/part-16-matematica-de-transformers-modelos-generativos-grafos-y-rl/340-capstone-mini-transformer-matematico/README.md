...
**Motor:** `computational_math.engines.part16` · demostración `capstone_mini_transformer`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `capstone_mini_transformer` del motor de la parte.
4. Interpretar las 20 salidas del laboratorio y decir qué invariante comprueba cada una.
...
- `ejemplo_objetivo`
- `ejemplo_prediccion`
- `atencion_de_la_ultima_posicion`
- `sesgo_relativo_aprendido`
- `la_atencion_aprende_a_mirar_i-1`
