# Evaluación — Capstone: mini-Transformer matemático
...
| Implementación y verificación | 25 % | ejecuta `capstone_mini_transformer`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con LLM o con IA |
...
5. ¿Dónde aparece este concepto en LLM?
