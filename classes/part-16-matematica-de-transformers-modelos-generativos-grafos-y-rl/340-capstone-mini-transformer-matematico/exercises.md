# Ejercicios — Capstone: mini-Transformer matemático

## Básico

1. Define **Capstone: mini-Transformer matemático** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 20 salidas.
