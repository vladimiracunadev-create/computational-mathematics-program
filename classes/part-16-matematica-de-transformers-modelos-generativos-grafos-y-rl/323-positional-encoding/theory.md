# Teoría — Positional encoding

## Definición operativa

En esta clase, **Positional encoding** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`positional_encoding`) devuelve 9 valores. Varios de ellos
