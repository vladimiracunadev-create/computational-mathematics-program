...
- [Su, J. et al. *RoFormer: Enhanced Transformer with Rotary Position Embedding*, 2021](https://arxiv.org/abs/2104.09864) — Deep learning y Modelos de lenguaje: el tema de esta clase · DOI `10.48550/arxiv.2104.09864` verificado en DataCite (2026-08-19).
