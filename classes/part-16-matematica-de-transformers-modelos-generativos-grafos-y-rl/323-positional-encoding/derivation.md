# Derivación y razonamiento — Positional encoding
...
Construye una derivación de 5 a 10 pasos relacionada con **Positional encoding**.
...
La demostración `positional_encoding` recorre este mismo razonamiento en código.
