# Intuición — Positional encoding

## La pregunta antes de la fórmula

¿Qué problema resuelve **Positional encoding**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `positional_encoding`: positional encoding sinusoidal: posición sin parámetros aprendidos.
