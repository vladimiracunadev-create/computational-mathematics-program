# Evaluación — Modelado autoregresivo
...
| Implementación y verificación | 25 % | ejecuta `autoregressive_modeling`, interpreta sus salidas y comprueba al menos un invariante |
