# Intuición — Modelado autoregresivo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Modelado autoregresivo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `autoregressive_modeling`: modelado autoregresivo: la regla de la cadena de la probabilidad.
