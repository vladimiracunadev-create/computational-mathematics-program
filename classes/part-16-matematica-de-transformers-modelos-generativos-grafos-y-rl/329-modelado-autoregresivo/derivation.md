# Derivación y razonamiento — Modelado autoregresivo
...
Construye una derivación de 5 a 10 pasos relacionada con **Modelado autoregresivo**.
...
La demostración `autoregressive_modeling` recorre este mismo razonamiento en código.
