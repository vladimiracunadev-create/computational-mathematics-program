# Teoría — Modelado autoregresivo

## Definición operativa

En esta clase, **Modelado autoregresivo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`autoregressive_modeling`) devuelve 9 valores. Varios de ellos
