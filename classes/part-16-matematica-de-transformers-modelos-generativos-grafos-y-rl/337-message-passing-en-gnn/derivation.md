# Derivación y razonamiento — Message passing en GNN
...
Construye una derivación de 5 a 10 pasos relacionada con **Message passing en GNN**.
...
La demostración `message_passing` recorre este mismo razonamiento en código.
