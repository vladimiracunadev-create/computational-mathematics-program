# Teoría — Message passing en GNN

## Definición operativa

En esta clase, **Message passing en GNN** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`message_passing`) devuelve 10 valores. Varios de ellos
