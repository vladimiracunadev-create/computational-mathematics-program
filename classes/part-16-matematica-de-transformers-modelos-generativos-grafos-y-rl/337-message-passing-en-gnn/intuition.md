# Intuición — Message passing en GNN

## La pregunta antes de la fórmula

¿Qué problema resuelve **Message passing en GNN**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `message_passing`: message passing: cada capa agrega información de un salto más lejos.
