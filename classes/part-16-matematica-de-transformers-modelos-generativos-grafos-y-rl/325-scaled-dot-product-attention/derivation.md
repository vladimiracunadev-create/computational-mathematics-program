# Derivación y razonamiento — Scaled dot-product attention
...
Construye una derivación de 5 a 10 pasos relacionada con **Scaled dot-product attention**.
...
La demostración `scaled_dot_product_attention` recorre este mismo razonamiento en código.
