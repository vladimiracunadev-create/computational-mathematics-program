# Teoría — Scaled dot-product attention

## Definición operativa

En esta clase, **Scaled dot-product attention** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`scaled_dot_product_attention`) devuelve 9 valores. Varios de ellos
