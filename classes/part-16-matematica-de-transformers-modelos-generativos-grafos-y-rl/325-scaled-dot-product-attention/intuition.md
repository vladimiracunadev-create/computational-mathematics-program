# Intuición — Scaled dot-product attention

## La pregunta antes de la fórmula

¿Qué problema resuelve **Scaled dot-product attention**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `scaled_dot_product_attention`: atención escalada: por qué existe el 1/√d.
