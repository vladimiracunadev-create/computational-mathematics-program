# Evaluación — Scaled dot-product attention
...
| Implementación y verificación | 25 % | ejecuta `scaled_dot_product_attention`, interpreta sus salidas y comprueba al menos un invariante |
