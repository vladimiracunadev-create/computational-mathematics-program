...
3. Ejecutar y modificar `lab.py`, que corre la demostración `scaled_dot_product_attention` del motor de la parte.
...
- `d=256_sin_escalar`
- `d=256_escalado`
- `varianza_del_producto_punto`
- `por_que_1/√d`
- `sintoma_de_saturacion`
- `entropia_maxima_4_tokens`
