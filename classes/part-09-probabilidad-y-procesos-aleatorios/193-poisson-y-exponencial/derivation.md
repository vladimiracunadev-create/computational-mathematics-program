# Derivación y razonamiento — Poisson y exponencial
...
Construye una derivación de 5 a 10 pasos relacionada con **Poisson y exponencial**.
...
La demostración `poisson_exponential` recorre este mismo razonamiento en código.
