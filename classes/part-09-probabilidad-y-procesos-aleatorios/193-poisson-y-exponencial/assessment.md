# Evaluación — Poisson y exponencial
...
| Implementación y verificación | 25 % | ejecuta `poisson_exponential`, interpreta sus salidas y comprueba al menos un invariante |
