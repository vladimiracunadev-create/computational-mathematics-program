# Intuición — Poisson y exponencial

## La pregunta antes de la fórmula

¿Qué problema resuelve **Poisson y exponencial**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `poisson_exponential`: poisson cuenta eventos; la exponencial mide el tiempo entre ellos.
