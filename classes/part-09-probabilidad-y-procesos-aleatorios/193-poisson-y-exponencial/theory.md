# Teoría — Poisson y exponencial

## Definición operativa

En esta clase, **Poisson y exponencial** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`poisson_exponential`) devuelve 8 valores. Varios de ellos
