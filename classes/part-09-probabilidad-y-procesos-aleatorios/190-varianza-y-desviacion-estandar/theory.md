# Teoría — Varianza y desviación estándar

## Definición operativa

En esta clase, **Varianza y desviación estándar** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`variance`) devuelve 9 valores. Varios de ellos
