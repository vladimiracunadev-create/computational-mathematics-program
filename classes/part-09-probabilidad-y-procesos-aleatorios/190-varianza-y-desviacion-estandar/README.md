...
3. Ejecutar y modificar `lab.py`, que corre la demostración `variance` del motor de la parte.
...
- `datos`
- `media`
- `varianza_poblacional_/n`
- `varianza_muestral_/(n-1)`
- `desviacion_estandar`
- `statistics.pstdev`
- `statistics.stdev`
- `correccion_de_Bessel`
- `Var(aX)=a²Var(X)`
