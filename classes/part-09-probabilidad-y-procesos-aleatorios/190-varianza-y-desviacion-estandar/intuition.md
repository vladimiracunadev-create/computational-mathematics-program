# Intuición — Varianza y desviación estándar

## La pregunta antes de la fórmula

¿Qué problema resuelve **Varianza y desviación estándar**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `variance`: varianza, desviación estándar y el estimador insesgado.
