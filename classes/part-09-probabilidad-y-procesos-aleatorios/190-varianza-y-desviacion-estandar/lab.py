"""Laboratorio 190 — Varianza y desviación estándar.

Parte 09 · Probabilidad y procesos aleatorios
Motor: computational_math.engines.part09 · demostración `variance`
...
def main() -> dict:
    ...
    print(f"Clase 190 — Varianza y desviación estándar")
