# Derivación y razonamiento — Varianza y desviación estándar
...
Construye una derivación de 5 a 10 pasos relacionada con **Varianza y desviación estándar**.
...
La demostración `variance` recorre este mismo razonamiento en código.
