# Intuición — Axiomas de probabilidad

## La pregunta antes de la fórmula

¿Qué problema resuelve **Axiomas de probabilidad**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `axioms`: los tres axiomas de kolmogorov verificados sobre un modelo.
