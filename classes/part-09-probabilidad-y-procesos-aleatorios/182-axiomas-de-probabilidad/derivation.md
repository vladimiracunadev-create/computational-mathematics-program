# Derivación y razonamiento — Axiomas de probabilidad
...
Construye una derivación de 5 a 10 pasos relacionada con **Axiomas de probabilidad**.
...
La demostración `axioms` recorre este mismo razonamiento en código.
