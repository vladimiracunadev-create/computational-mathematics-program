...
**Motor:** `computational_math.engines.part09` · demostración `axioms`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `axioms` del motor de la parte.
