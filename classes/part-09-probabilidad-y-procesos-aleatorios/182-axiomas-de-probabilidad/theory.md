# Teoría — Axiomas de probabilidad

## Definición operativa

En esta clase, **Axiomas de probabilidad** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`axioms`) devuelve 8 valores. Varios de ellos
