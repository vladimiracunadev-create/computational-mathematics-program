"""Laboratorio 200 — Capstone: simulador probabilístico y bayesiano.

Parte 09 · Probabilidad y procesos aleatorios
Motor: computational_math.engines.part09 · demostración `capstone_probabilistic_simulator`
...
from computational_math.engines import part09 as motor  # noqa: E402

DEMO = "capstone_probabilistic_simulator"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 200 — Capstone: simulador probabilístico y bayesiano")
    print(f"Parte 09 · Probabilidad y procesos aleatorios")
