# Intuición — Capstone: simulador probabilístico y bayesiano

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: simulador probabilístico y bayesiano**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Probabilidad y procesos aleatorios**. Axiomas, probabilidad condicional, Bayes, variables aleatorias, esperanza, varianza, distribuciones clave, LGN, TCL, Monte Carlo y cadenas de Markov.
...
El laboratorio ejecuta `capstone_probabilistic_simulator`: capstone: simulador probabilístico con actualización bayesiana.
