# Teoría — Capstone: simulador probabilístico y bayesiano

## Definición operativa

En esta clase, **Capstone: simulador probabilístico y bayesiano** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_probabilistic_simulator`) devuelve 8 valores. Varios de ellos
