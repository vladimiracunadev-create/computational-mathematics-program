# Derivación y razonamiento — Capstone: simulador probabilístico y bayesiano
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: simulador probabilístico y bayesiano**.
...
La demostración `capstone_probabilistic_simulator` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part09.py` y responde:
