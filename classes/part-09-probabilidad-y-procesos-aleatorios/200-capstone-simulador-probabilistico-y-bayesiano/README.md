...
3. Ejecutar y modificar `lab.py`, que corre la demostración `capstone_probabilistic_simulator` del motor de la parte.
...
- `prior`
- `actualizacion`
- `estimacion_frecuentista`
- `estimacion_bayesiana_final`
- `el_prior_se_diluye_con_datos`
- `semilla`
- `reproducible`
