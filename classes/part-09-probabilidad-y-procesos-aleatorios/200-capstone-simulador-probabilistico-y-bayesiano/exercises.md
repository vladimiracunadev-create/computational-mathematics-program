# Ejercicios — Capstone: simulador probabilístico y bayesiano

## Básico

1. Define **Capstone: simulador probabilístico y bayesiano** con tus palabras y da un ejemplo válido y uno inválido.
...
7. Conecta esta clase con riesgo, seguros, colas, simulación, criptografía y toma de decisiones bajo incertidumbre mediante un caso concreto y realista.
