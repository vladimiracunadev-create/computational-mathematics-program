# Derivación y razonamiento — Probabilidad condicional
...
Construye una derivación de 5 a 10 pasos relacionada con **Probabilidad condicional**.
...
La demostración `conditional` recorre este mismo razonamiento en código.
