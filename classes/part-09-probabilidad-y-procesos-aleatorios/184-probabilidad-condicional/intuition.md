# Intuición — Probabilidad condicional

## La pregunta antes de la fórmula

¿Qué problema resuelve **Probabilidad condicional**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `conditional`: p(a|b) cambia el espacio muestral, no la realidad.
