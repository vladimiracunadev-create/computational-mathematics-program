# Teoría — Reglas de suma y producto

## Definición operativa

En esta clase, **Reglas de suma y producto** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sum_product_rules`) devuelve 8 valores. Varios de ellos
