# Evaluación — Reglas de suma y producto
...
| Implementación y verificación | 25 % | ejecuta `sum_product_rules`, interpreta sus salidas y comprueba al menos un invariante |
