# Derivación y razonamiento — Reglas de suma y producto
...
Construye una derivación de 5 a 10 pasos relacionada con **Reglas de suma y producto**.
...
La demostración `sum_product_rules` recorre este mismo razonamiento en código.
