# Intuición — Reglas de suma y producto

## La pregunta antes de la fórmula

¿Qué problema resuelve **Reglas de suma y producto**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sum_product_rules`: regla de la suma con y sin exclusión mutua.
