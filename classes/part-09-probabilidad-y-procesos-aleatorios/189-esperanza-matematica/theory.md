# Teoría — Esperanza matemática

## Definición operativa

En esta clase, **Esperanza matemática** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`expectation`) devuelve 9 valores. Varios de ellos
