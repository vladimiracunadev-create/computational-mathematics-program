...
**Motor:** `computational_math.engines.part09` · demostración `expectation`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `expectation` del motor de la parte.
