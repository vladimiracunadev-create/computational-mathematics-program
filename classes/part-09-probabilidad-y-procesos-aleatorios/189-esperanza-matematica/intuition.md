# Intuición — Esperanza matemática

## La pregunta antes de la fórmula

¿Qué problema resuelve **Esperanza matemática**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `expectation`: linealidad de la esperanza, incluso sin independencia.
