# Derivación y razonamiento — Esperanza matemática
...
Construye una derivación de 5 a 10 pasos relacionada con **Esperanza matemática**.
...
La demostración `expectation` recorre este mismo razonamiento en código.
