# Intuición — Independencia

## La pregunta antes de la fórmula

¿Qué problema resuelve **Independencia**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `independence`: independencia se comprueba, no se supone.
