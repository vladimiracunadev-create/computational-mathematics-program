# Derivación y razonamiento — Independencia
...
Construye una derivación de 5 a 10 pasos relacionada con **Independencia**.
...
La demostración `independence` recorre este mismo razonamiento en código.
