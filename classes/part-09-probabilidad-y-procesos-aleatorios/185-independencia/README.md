...
3. Ejecutar y modificar `lab.py`, que corre la demostración `independence` del motor de la parte.
...
- `P(B)`
- `P(A∩B)`
- `A_y_B_independientes`
- `P(C)`
- `P(A∩C)`
- `A_y_C_independientes`
- `P(A∩B∩C)`
- `independencia_por_pares_no_implica_conjunta`
