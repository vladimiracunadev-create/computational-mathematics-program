# Intuición — Covarianza y correlación

## La pregunta antes de la fórmula

¿Qué problema resuelve **Covarianza y correlación**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `covariance_correlation`: covarianza depende de la escala; la correlación no.
