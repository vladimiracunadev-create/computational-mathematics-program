# Teoría — Covarianza y correlación

## Definición operativa

En esta clase, **Covarianza y correlación** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`covariance_correlation`) devuelve 7 valores. Varios de ellos
