# Derivación y razonamiento — Covarianza y correlación
...
Construye una derivación de 5 a 10 pasos relacionada con **Covarianza y correlación**.
...
La demostración `covariance_correlation` recorre este mismo razonamiento en código.
