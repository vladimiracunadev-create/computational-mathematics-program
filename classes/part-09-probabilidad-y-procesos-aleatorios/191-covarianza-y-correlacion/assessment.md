# Evaluación — Covarianza y correlación
...
| Implementación y verificación | 25 % | ejecuta `covariance_correlation`, interpreta sus salidas y comprueba al menos un invariante |
