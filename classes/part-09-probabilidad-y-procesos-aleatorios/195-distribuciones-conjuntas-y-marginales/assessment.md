# Evaluación — Distribuciones conjuntas y marginales
...
| Implementación y verificación | 25 % | ejecuta `joint_marginal`, interpreta sus salidas y comprueba al menos un invariante |
