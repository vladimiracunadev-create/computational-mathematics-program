# Derivación y razonamiento — Distribuciones conjuntas y marginales
...
Construye una derivación de 5 a 10 pasos relacionada con **Distribuciones conjuntas y marginales**.
...
La demostración `joint_marginal` recorre este mismo razonamiento en código.
