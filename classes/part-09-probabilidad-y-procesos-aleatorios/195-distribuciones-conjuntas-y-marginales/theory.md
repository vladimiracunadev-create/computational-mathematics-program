# Teoría — Distribuciones conjuntas y marginales

## Definición operativa

En esta clase, **Distribuciones conjuntas y marginales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`joint_marginal`) devuelve 7 valores. Varios de ellos
