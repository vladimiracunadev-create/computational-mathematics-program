"""Laboratorio 195 — Distribuciones conjuntas y marginales.

Parte 09 · Probabilidad y procesos aleatorios
Motor: computational_math.engines.part09 · demostración `joint_marginal`
...
def main() -> dict:
    ...
    print(f"Clase 195 — Distribuciones conjuntas y marginales")
