# Intuición — Distribuciones conjuntas y marginales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Distribuciones conjuntas y marginales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `joint_marginal`: distribución conjunta, marginales y condicional.
