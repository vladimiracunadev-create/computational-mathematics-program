...
3. Ejecutar y modificar `lab.py`, que corre la demostración `central_limit` del motor de la parte.
...
- `media_de_las_medias`
- `media_teorica`
- `varianza_de_las_medias`
- `varianza_teorica_σ²/n`
- `error_estandar`
- `la_distribucion_de_medias_es_casi_normal`
