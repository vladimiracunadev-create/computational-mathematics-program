# Derivación y razonamiento — Teorema central del límite
...
Construye una derivación de 5 a 10 pasos relacionada con **Teorema central del límite**.
...
La demostración `central_limit` recorre este mismo razonamiento en código.
