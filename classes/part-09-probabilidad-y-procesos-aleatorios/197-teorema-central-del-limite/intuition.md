# Intuición — Teorema central del límite

## La pregunta antes de la fórmula

¿Qué problema resuelve **Teorema central del límite**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `central_limit`: el tcl en acción sobre una distribución claramente no normal.
