# Teoría — Teorema central del límite

## Definición operativa

En esta clase, **Teorema central del límite** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`central_limit`) devuelve 9 valores. Varios de ellos
