# Derivación y razonamiento — Teorema de Bayes
...
Construye una derivación de 5 a 10 pasos relacionada con **Teorema de Bayes**.
...
La demostración `bayes` recorre este mismo razonamiento en código.
