# Intuición — Teorema de Bayes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Teorema de Bayes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bayes`: test médico: por qué un positivo no significa enfermedad.
