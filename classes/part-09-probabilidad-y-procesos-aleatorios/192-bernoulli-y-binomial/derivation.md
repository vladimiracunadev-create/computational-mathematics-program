# Derivación y razonamiento — Bernoulli y binomial
...
Construye una derivación de 5 a 10 pasos relacionada con **Bernoulli y binomial**.
...
La demostración `bernoulli_binomial` recorre este mismo razonamiento en código.
