...
- [Blitzstein, J.; Hwang, J. *Introduction to Probability*, 2ª ed., CRC, 2019, cap. 3](https://projects.iq.harvard.edu/stat110/home) — *uso:* exposición alternativa del tema en «Bernoulli y binomial».
- [Ross, S. *A First Course in Probability*, 10ª ed., Pearson, 2018, cap. 4](https://www.pearson.com/) — *uso:* obra de referencia consultada en «Bernoulli y binomial».
