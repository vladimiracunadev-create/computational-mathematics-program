# Teoría — Bernoulli y binomial

## Definición operativa

En esta clase, **Bernoulli y binomial** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`bernoulli_binomial`) devuelve 9 valores. Varios de ellos
