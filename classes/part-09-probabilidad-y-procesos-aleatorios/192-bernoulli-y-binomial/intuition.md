# Intuición — Bernoulli y binomial

## La pregunta antes de la fórmula

¿Qué problema resuelve **Bernoulli y binomial**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bernoulli_binomial`: de un ensayo a n ensayos: bernoulli y binomial.
