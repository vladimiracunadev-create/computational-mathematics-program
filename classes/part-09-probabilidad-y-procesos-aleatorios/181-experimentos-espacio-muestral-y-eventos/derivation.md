# Derivación y razonamiento — Experimentos, espacio muestral y eventos
...
Construye una derivación de 5 a 10 pasos relacionada con **Experimentos, espacio muestral y eventos**.
...
La demostración `sample_space` recorre este mismo razonamiento en código.
