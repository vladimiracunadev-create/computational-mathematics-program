# Teoría — Experimentos, espacio muestral y eventos

## Definición operativa

En esta clase, **Experimentos, espacio muestral y eventos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sample_space`) devuelve 8 valores. Varios de ellos
