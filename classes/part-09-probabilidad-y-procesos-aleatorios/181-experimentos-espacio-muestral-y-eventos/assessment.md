# Evaluación — Experimentos, espacio muestral y eventos
...
| Implementación y verificación | 25 % | ejecuta `sample_space`, interpreta sus salidas y comprueba al menos un invariante |
