# Intuición — Experimentos, espacio muestral y eventos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Experimentos, espacio muestral y eventos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sample_space`: espacio muestral, eventos y su probabilidad en un modelo equiprobable.
