# Derivación y razonamiento — Distribución normal
...
Construye una derivación de 5 a 10 pasos relacionada con **Distribución normal**.
...
La demostración `normal_distribution` recorre este mismo razonamiento en código.
