# Intuición — Distribución normal

## La pregunta antes de la fórmula

¿Qué problema resuelve **Distribución normal**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `normal_distribution`: normal: regla 68-95-99.7 y estandarización.
