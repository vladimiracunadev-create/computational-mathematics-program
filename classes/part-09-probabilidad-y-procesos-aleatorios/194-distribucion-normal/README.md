...
**Motor:** `computational_math.engines.part09` · demostración `normal_distribution`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `normal_distribution` del motor de la parte.
