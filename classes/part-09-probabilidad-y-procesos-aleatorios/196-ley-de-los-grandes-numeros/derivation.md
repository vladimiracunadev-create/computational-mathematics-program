# Derivación y razonamiento — Ley de los grandes números
...
Construye una derivación de 5 a 10 pasos relacionada con **Ley de los grandes números**.
...
La demostración `law_large_numbers` recorre este mismo razonamiento en código.
