# Evaluación — Ley de los grandes números
...
| Implementación y verificación | 25 % | ejecuta `law_large_numbers`, interpreta sus salidas y comprueba al menos un invariante |
