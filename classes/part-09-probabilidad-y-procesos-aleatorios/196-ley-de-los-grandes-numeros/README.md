...
> [⬅️ 195 Distribuciones conjuntas y marginales](../195-distribuciones-conjuntas-y-marginales/README.md) · [📚 Parte 09](../README.md) · [🏠 Programa](../../../README.md) · [197 Teorema central del límite ➡️](../197-teorema-central-del-limite/README.md)

**Parte:** 09 — Probabilidad y procesos aleatorios · **Nivel:** `universitario` · **Horas estimadas:** 4
**Motor:** `engines.part09` · **Demostración:** `law_large_numbers` · **Clase 16 de 20** de la parte
...
```mermaid
flowchart LR
    P["Clase 195 · Distribuciones conjuntas…"] --> D
    subgraph CLASE["Clase 196 · Ley de los grandes números"]
        direction TB
        D["Demostracion law_large_numbers"]
        D --> R["Resultados: ninguna"]
        D --> V["Comprobaciones 2: cuadruplicar_n_reduce… +1"]
        D --> O["Contexto 3: distribucion +2"]
    end
    R --> N["Clase 197 · Teorema central del límite"]
...
| ✅ Comprobaciones de invariante (2) | `cuadruplicar_n_reduce_el_error_a_la_mitad`, `no_garantiza_ninguna_muestra_concreta` |
...
- [Blitzstein, J.; Hwang, J. *Introduction to Probability*, 2ª ed., CRC, 2019, cap. 10](https://projects.iq.harvard.edu/stat110/home) — Probabilidad: el tema de esta clase · URL de la fuente primaria, pendiente de resolver.
- [Durrett, R. *Probability: Theory and Examples*, 5ª ed., Cambridge, 2019, cap. 2](https://services.math.duke.edu/~rtd/PTE/pte.html) — Probabilidad: el tema de esta clase · URL de la fuente primaria comprobada en services.math.duke.edu (2026-08-19).
