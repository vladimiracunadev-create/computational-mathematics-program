"""Laboratorio 187 — Variables aleatorias discretas.

Parte 09 · Probabilidad y procesos aleatorios
Motor: computational_math.engines.part09 · demostración `discrete_rv`
...
def main() -> dict:
    ...
    print(f"Clase 187 — Variables aleatorias discretas")
