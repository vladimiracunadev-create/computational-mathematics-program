# Teoría — Variables aleatorias discretas

## Definición operativa

En esta clase, **Variables aleatorias discretas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`discrete_rv`) devuelve 8 valores. Varios de ellos
