# Derivación y razonamiento — Variables aleatorias discretas
...
Construye una derivación de 5 a 10 pasos relacionada con **Variables aleatorias discretas**.
...
La demostración `discrete_rv` recorre este mismo razonamiento en código.
