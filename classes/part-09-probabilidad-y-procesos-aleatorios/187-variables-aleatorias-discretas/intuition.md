# Intuición — Variables aleatorias discretas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Variables aleatorias discretas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `discrete_rv`: variable aleatoria discreta: pmf, cdf y coherencia.
