# Evaluación — Variables aleatorias discretas
...
| Implementación y verificación | 25 % | ejecuta `discrete_rv`, interpreta sus salidas y comprueba al menos un invariante |
