# Intuición — Cadenas de Markov

## La pregunta antes de la fórmula

¿Qué problema resuelve **Cadenas de Markov**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `markov_chains`: cadena de markov: matriz de transición y distribución estacionaria.
