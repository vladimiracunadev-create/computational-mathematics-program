# Derivación y razonamiento — Cadenas de Markov
...
Construye una derivación de 5 a 10 pasos relacionada con **Cadenas de Markov**.
...
La demostración `markov_chains` recorre este mismo razonamiento en código.
