...
- [Blitzstein, J.; Hwang, J. *Introduction to Probability*, 2ª ed., CRC, 2019, cap. 11](https://projects.iq.harvard.edu/stat110/home) — *uso:* exposición alternativa del tema en «Cadenas de Markov».
- [Durrett, R. *Probability: Theory and Examples*, 5ª ed., Cambridge, 2019, cap. 5](https://services.math.duke.edu/~rtd/PTE/pte.html) — *uso:* obra de referencia consultada en «Cadenas de Markov».
