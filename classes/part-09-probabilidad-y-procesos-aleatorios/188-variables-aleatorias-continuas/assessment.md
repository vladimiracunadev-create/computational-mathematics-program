# Evaluación — Variables aleatorias continuas
...
| Implementación y verificación | 25 % | ejecuta `continuous_rv`, interpreta sus salidas y comprueba al menos un invariante |
