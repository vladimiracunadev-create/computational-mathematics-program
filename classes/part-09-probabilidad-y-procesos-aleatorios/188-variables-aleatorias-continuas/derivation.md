# Derivación y razonamiento — Variables aleatorias continuas
...
Construye una derivación de 5 a 10 pasos relacionada con **Variables aleatorias continuas**.
...
La demostración `continuous_rv` recorre este mismo razonamiento en código.
