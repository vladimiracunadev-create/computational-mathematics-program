# Intuición — Variables aleatorias continuas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Variables aleatorias continuas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `continuous_rv`: variable continua: la densidad no es una probabilidad.
