# Teoría — Variables aleatorias continuas

## Definición operativa

En esta clase, **Variables aleatorias continuas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`continuous_rv`) devuelve 8 valores. Varios de ellos
