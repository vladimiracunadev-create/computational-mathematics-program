# Teoría — Métodos Monte Carlo

## Definición operativa

En esta clase, **Métodos Monte Carlo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`monte_carlo`) devuelve 6 valores. Varios de ellos
