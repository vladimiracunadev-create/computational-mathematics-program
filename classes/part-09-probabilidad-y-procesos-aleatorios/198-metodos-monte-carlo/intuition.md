# Intuición — Métodos Monte Carlo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Métodos Monte Carlo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `monte_carlo`: estimar π por monte carlo con su error e intervalo.
