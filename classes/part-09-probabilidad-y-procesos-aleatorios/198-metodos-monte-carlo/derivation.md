# Derivación y razonamiento — Métodos Monte Carlo
...
Construye una derivación de 5 a 10 pasos relacionada con **Métodos Monte Carlo**.
...
La demostración `monte_carlo` recorre este mismo razonamiento en código.
