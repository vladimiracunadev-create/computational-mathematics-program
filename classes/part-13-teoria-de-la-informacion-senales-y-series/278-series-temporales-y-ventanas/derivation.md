# Derivación y razonamiento — Series temporales y ventanas
...
Construye una derivación de 5 a 10 pasos relacionada con **Series temporales y ventanas**.
...
La demostración `windowing` recorre este mismo razonamiento en código.
