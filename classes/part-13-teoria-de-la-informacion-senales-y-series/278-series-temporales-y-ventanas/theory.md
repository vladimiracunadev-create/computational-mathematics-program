# Teoría — Series temporales y ventanas

## Definición operativa

En esta clase, **Series temporales y ventanas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`windowing`) devuelve 8 valores. Varios de ellos
