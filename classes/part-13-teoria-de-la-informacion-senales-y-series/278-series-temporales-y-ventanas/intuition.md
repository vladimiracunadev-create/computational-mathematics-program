# Intuición — Series temporales y ventanas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Series temporales y ventanas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `windowing`: ventaneo: el precio de analizar un trozo finito de señal.
