# Teoría — Entropía cruzada

## Definición operativa

En esta clase, **Entropía cruzada** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`cross_entropy`) devuelve 7 valores. Varios de ellos
