...
3. Ejecutar y modificar `lab.py`, que corre la demostración `capstone_signal_features` del motor de la parte.
...
- `muestras`
- `frecuencia_de_muestreo_Hz`
- `features_temporales`
- `features_espectrales`
- `componentes_reales_Hz`
- `dominante_detectada_correctamente`
- `vector_de_features`
- `uso`
