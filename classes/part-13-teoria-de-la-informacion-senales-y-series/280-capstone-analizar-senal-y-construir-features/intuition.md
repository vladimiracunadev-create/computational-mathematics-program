# Intuición — Capstone: analizar señal y construir features

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: analizar señal y construir features**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `capstone_signal_features`: capstone: de una señal cruda a un vector de características.
