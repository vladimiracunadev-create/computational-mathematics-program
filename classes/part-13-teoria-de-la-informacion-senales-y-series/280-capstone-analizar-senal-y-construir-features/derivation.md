# Derivación y razonamiento — Capstone: analizar señal y construir features
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: analizar señal y construir features**.
...
La demostración `capstone_signal_features` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part13.py` y responde:
