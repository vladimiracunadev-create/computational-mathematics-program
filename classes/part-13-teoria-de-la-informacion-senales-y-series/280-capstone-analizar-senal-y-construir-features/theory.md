# Teoría — Capstone: analizar señal y construir features

## Definición operativa

En esta clase, **Capstone: analizar señal y construir features** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_signal_features`) devuelve 8 valores. Varios de ellos
