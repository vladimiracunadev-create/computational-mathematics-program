"""Laboratorio 280 — Capstone: analizar señal y construir features.

Parte 13 · Teoría de la información, señales y series
Motor: computational_math.engines.part13 · demostración `capstone_signal_features`
...
from computational_math.engines import part13 as motor  # noqa: E402

DEMO = "capstone_signal_features"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 280 — Capstone: analizar señal y construir features")
    print(f"Parte 13 · Teoría de la información, señales y series")
