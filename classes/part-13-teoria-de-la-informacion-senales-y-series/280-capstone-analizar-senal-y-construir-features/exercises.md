# Ejercicios — Capstone: analizar señal y construir features

## Básico

1. Define **Capstone: analizar señal y construir features** con tus palabras y da un ejemplo válido y uno inválido.
...
7. Conecta esta clase con compresión, audio, comunicaciones, análisis espectral y feature engineering temporal mediante un caso concreto y realista.
