# Evaluación — Capstone: analizar señal y construir features
...
| Implementación y verificación | 25 % | ejecuta `capstone_signal_features`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con compresión o con IA |
...
5. ¿Dónde aparece este concepto en compresión?
