# Teoría — Espectro y densidad espectral

## Definición operativa

En esta clase, **Espectro y densidad espectral** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`power_spectrum`) devuelve 9 valores. Varios de ellos
