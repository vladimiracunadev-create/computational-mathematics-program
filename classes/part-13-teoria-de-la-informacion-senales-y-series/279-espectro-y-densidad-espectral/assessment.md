# Evaluación — Espectro y densidad espectral
...
| Implementación y verificación | 25 % | ejecuta `power_spectrum`, interpreta sus salidas y comprueba al menos un invariante |
