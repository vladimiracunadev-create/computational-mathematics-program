# Derivación y razonamiento — Espectro y densidad espectral
...
Construye una derivación de 5 a 10 pasos relacionada con **Espectro y densidad espectral**.
...
La demostración `power_spectrum` recorre este mismo razonamiento en código.
