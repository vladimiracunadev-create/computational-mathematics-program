# Intuición — Espectro y densidad espectral

## La pregunta antes de la fórmula

¿Qué problema resuelve **Espectro y densidad espectral**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `power_spectrum`: densidad espectral de potencia y reparto de la energía.
