# Teoría — Información mutua

## Definición operativa

En esta clase, **Información mutua** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`mutual_information`) devuelve 8 valores. Varios de ellos
