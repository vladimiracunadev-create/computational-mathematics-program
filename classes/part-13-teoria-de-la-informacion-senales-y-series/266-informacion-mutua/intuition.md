# Intuición — Información mutua

## La pregunta antes de la fórmula

¿Qué problema resuelve **Información mutua**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `mutual_information`: información mutua: cuánto reduce y la incertidumbre de x.
