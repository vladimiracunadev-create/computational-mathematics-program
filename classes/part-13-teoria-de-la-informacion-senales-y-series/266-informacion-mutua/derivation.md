# Derivación y razonamiento — Información mutua
...
Construye una derivación de 5 a 10 pasos relacionada con **Información mutua**.
...
La demostración `mutual_information` recorre este mismo razonamiento en código.
