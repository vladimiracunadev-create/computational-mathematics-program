# Teoría — Procesos estacionarios

## Definición operativa

En esta clase, **Procesos estacionarios** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`stationarity`) devuelve 5 valores. Varios de ellos
