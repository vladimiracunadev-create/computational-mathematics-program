# Derivación y razonamiento — Procesos estacionarios
...
Construye una derivación de 5 a 10 pasos relacionada con **Procesos estacionarios**.
...
La demostración `stationarity` recorre este mismo razonamiento en código.
