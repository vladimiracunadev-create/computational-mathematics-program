# Intuición — Procesos estacionarios

## La pregunta antes de la fórmula

¿Qué problema resuelve **Procesos estacionarios**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `stationarity`: serie estacionaria frente a serie con tendencia.
