# Derivación y razonamiento — Codificación y compresión
...
Construye una derivación de 5 a 10 pasos relacionada con **Codificación y compresión**.
...
La demostración `coding_compression` recorre este mismo razonamiento en código.
