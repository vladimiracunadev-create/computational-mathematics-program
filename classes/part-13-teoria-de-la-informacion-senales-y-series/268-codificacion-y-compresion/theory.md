# Teoría — Codificación y compresión

## Definición operativa

En esta clase, **Codificación y compresión** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`coding_compression`) devuelve 8 valores. Varios de ellos
