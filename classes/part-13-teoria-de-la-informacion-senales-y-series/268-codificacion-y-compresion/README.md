...
3. Ejecutar y modificar `lab.py`, que corre la demostración `coding_compression` del motor de la parte.
...
- `longitud_media_bits`
- `entropia_bits`
- `longitud_fija_necesaria`
- `ahorro_vs_longitud_fija_%`
- `cumple_la_cota_de_Shannon`
- `codigo_libre_de_prefijos`
