# Intuición — Codificación y compresión

## La pregunta antes de la fórmula

¿Qué problema resuelve **Codificación y compresión**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `coding_compression`: código de huffman frente a codificación de longitud fija.
