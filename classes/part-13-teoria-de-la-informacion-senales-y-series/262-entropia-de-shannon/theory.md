# Teoría — Entropía de Shannon

## Definición operativa

En esta clase, **Entropía de Shannon** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`shannon_entropy`) devuelve 6 valores. Varios de ellos
