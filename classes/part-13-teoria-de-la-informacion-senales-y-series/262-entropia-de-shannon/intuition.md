# Intuición — Entropía de Shannon

## La pregunta antes de la fórmula

¿Qué problema resuelve **Entropía de Shannon**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `shannon_entropy`: la entropía es la sorpresa esperada y el límite de compresión.
