# Derivación y razonamiento — Entropía de Shannon
...
Construye una derivación de 5 a 10 pasos relacionada con **Entropía de Shannon**.
...
La demostración `shannon_entropy` recorre este mismo razonamiento en código.
