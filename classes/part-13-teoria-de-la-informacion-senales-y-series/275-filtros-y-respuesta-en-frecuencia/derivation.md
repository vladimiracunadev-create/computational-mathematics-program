# Derivación y razonamiento — Filtros y respuesta en frecuencia
...
Construye una derivación de 5 a 10 pasos relacionada con **Filtros y respuesta en frecuencia**.
...
La demostración `filters` recorre este mismo razonamiento en código.
