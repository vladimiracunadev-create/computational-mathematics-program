# Evaluación — Filtros y respuesta en frecuencia
...
| Implementación y verificación | 25 % | ejecuta `filters`, interpreta sus salidas y comprueba al menos un invariante |
