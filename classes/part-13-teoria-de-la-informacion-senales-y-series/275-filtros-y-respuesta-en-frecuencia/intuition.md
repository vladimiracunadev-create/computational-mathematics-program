# Intuición — Filtros y respuesta en frecuencia

## La pregunta antes de la fórmula

¿Qué problema resuelve **Filtros y respuesta en frecuencia**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `filters`: filtro paso-bajo aplicado a una señal con ruido de alta frecuencia.
