# Teoría — Filtros y respuesta en frecuencia

## Definición operativa

En esta clase, **Filtros y respuesta en frecuencia** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`filters`) devuelve 8 valores. Varios de ellos
