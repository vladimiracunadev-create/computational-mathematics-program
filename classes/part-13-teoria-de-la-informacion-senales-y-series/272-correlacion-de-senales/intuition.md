# Intuición — Correlación de señales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Correlación de señales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `cross_correlation`: correlación cruzada: convolución sin invertir el kernel.
