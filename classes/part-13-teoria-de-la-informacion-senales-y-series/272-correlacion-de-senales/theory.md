# Teoría — Correlación de señales

## Definición operativa

En esta clase, **Correlación de señales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`cross_correlation`) devuelve 9 valores. Varios de ellos
