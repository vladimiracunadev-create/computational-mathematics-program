"""Laboratorio 267 — Principio de máxima entropía.

Parte 13 · Teoría de la información, señales y series
Motor: computational_math.engines.part13 · demostración `max_entropy`
...
def main() -> dict:
    ...
    print(f"Clase 267 — Principio de máxima entropía")
