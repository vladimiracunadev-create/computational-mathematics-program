# Teoría — Principio de máxima entropía

## Definición operativa

En esta clase, **Principio de máxima entropía** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`max_entropy`) devuelve 7 valores. Varios de ellos
