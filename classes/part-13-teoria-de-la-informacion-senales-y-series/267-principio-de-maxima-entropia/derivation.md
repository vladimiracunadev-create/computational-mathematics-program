# Derivación y razonamiento — Principio de máxima entropía
...
Construye una derivación de 5 a 10 pasos relacionada con **Principio de máxima entropía**.
...
La demostración `max_entropy` recorre este mismo razonamiento en código.
