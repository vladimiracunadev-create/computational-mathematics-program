# Intuición — Principio de máxima entropía

## La pregunta antes de la fórmula

¿Qué problema resuelve **Principio de máxima entropía**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `max_entropy`: principio de máxima entropía: la distribución menos comprometida.
