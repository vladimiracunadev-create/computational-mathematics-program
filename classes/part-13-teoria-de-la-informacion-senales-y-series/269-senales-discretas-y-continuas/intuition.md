# Intuición — Señales discretas y continuas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Señales discretas y continuas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `signals`: señal continua muestreada: amplitud, frecuencia y fase.
