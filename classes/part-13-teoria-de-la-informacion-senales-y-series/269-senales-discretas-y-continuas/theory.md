# Teoría — Señales discretas y continuas

## Definición operativa

En esta clase, **Señales discretas y continuas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`signals`) devuelve 10 valores. Varios de ellos
