# Derivación y razonamiento — Señales discretas y continuas
...
Construye una derivación de 5 a 10 pasos relacionada con **Señales discretas y continuas**.
...
La demostración `signals` recorre este mismo razonamiento en código.
