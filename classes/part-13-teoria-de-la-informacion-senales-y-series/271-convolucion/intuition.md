# Intuición — Convolución

## La pregunta antes de la fórmula

¿Qué problema resuelve **Convolución**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `convolution`: convolución discreta: el operador de las cnn.
