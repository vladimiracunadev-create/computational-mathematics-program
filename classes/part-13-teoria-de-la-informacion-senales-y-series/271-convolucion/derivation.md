# Derivación y razonamiento — Convolución
...
Construye una derivación de 5 a 10 pasos relacionada con **Convolución**.
...
La demostración `convolution` recorre este mismo razonamiento en código.
