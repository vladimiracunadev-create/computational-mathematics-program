# Derivación y razonamiento — Series y transformada de Fourier
...
Construye una derivación de 5 a 10 pasos relacionada con **Series y transformada de Fourier**.
...
La demostración `fourier_series` recorre este mismo razonamiento en código.
