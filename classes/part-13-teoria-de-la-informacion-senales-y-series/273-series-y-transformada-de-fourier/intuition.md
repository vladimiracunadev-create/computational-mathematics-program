# Intuición — Series y transformada de Fourier

## La pregunta antes de la fórmula

¿Qué problema resuelve **Series y transformada de Fourier**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `fourier_series`: descomponer una señal en senos y cosenos.
