# Teoría — Series y transformada de Fourier

## Definición operativa

En esta clase, **Series y transformada de Fourier** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`fourier_series`) devuelve 8 valores. Varios de ellos
