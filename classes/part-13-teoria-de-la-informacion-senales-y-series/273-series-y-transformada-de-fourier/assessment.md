# Evaluación — Series y transformada de Fourier
...
| Implementación y verificación | 25 % | ejecuta `fourier_series`, interpreta sus salidas y comprueba al menos un invariante |
