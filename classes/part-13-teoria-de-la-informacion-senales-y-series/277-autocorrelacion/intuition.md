# Intuición — Autocorrelación

## La pregunta antes de la fórmula

¿Qué problema resuelve **Autocorrelación**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `autocorrelation`: autocorrelación revela la periodicidad oculta.
