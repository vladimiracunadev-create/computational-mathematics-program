# Teoría — Autocorrelación

## Definición operativa

En esta clase, **Autocorrelación** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`autocorrelation`) devuelve 9 valores. Varios de ellos
