# Derivación y razonamiento — Autocorrelación
...
Construye una derivación de 5 a 10 pasos relacionada con **Autocorrelación**.
...
La demostración `autocorrelation` recorre este mismo razonamiento en código.
