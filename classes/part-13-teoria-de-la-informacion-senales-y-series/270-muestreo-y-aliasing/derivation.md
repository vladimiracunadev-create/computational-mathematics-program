# Derivación y razonamiento — Muestreo y aliasing
...
Construye una derivación de 5 a 10 pasos relacionada con **Muestreo y aliasing**.
...
La demostración `sampling_aliasing` recorre este mismo razonamiento en código.
