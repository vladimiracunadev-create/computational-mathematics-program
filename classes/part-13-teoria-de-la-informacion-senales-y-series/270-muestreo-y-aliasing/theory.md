# Teoría — Muestreo y aliasing

## Definición operativa

En esta clase, **Muestreo y aliasing** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sampling_aliasing`) devuelve 6 valores. Varios de ellos
