# Intuición — Muestreo y aliasing

## La pregunta antes de la fórmula

¿Qué problema resuelve **Muestreo y aliasing**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sampling_aliasing`: nyquist: muestrear por debajo del límite crea una señal falsa.
