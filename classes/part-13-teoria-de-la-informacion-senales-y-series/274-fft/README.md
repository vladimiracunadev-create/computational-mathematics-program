...
- [Cooley, J.; Tukey, J. *An algorithm for the machine calculation of complex Fourier series*, 1965](https://doi.org/10.1090/S0025-5718-1965-0178586-1) — Procesamiento de señales: el tema de esta clase · DOI `10.1090/s0025-5718-1965-0178586-1` verificado en Crossref (2026-08-19).
- [Press, W. et al. *Numerical Recipes*, 3ª ed., Cambridge, 2007, cap. 12](https://numerical.recipes/) — Computación científica y Métodos numéricos: conexión declarada de esta parte · URL de la fuente primaria comprobada en sitio de la obra o de su editorial (2026-08-19).
