# Intuición — Jensen-Shannon divergence

## La pregunta antes de la fórmula

¿Qué problema resuelve **Jensen-Shannon divergence**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `js_divergence`: jensen-shannon: simétrica y acotada.
