# Derivación y razonamiento — Jensen-Shannon divergence
...
Construye una derivación de 5 a 10 pasos relacionada con **Jensen-Shannon divergence**.
...
La demostración `js_divergence` recorre este mismo razonamiento en código.
