...
- [Lin, J. *Divergence measures based on the Shannon entropy*, IEEE Trans. Information Theory, 1991](https://doi.org/10.1109/18.61115) — Teoría de la información: el tema de esta clase · DOI `10.1109/18.61115` verificado en Crossref (2026-08-19).
- [Goodfellow, I. et al. *Generative Adversarial Networks*, NeurIPS, 2014](https://arxiv.org/abs/1406.2661) — Deep learning y Modelos generativos: conexión declarada de esta parte · DOI `10.48550/arxiv.1406.2661` verificado en DataCite (2026-08-19).
