# Teoría — Jensen-Shannon divergence

## Definición operativa

En esta clase, **Jensen-Shannon divergence** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`js_divergence`) devuelve 9 valores. Varios de ellos
