# Derivación y razonamiento — Información y sorpresa
...
Construye una derivación de 5 a 10 pasos relacionada con **Información y sorpresa**.
...
La demostración `surprise` recorre este mismo razonamiento en código.
