# Teoría — Información y sorpresa

## Definición operativa

En esta clase, **Información y sorpresa** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`surprise`) devuelve 6 valores. Varios de ellos
