# Intuición — Información y sorpresa

## La pregunta antes de la fórmula

¿Qué problema resuelve **Información y sorpresa**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `surprise`: la sorpresa de un evento es -log de su probabilidad.
