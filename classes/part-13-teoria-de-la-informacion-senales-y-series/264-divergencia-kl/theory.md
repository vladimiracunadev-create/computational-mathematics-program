# Teoría — Divergencia KL

## Definición operativa

En esta clase, **Divergencia KL** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`kl_divergence`) devuelve 9 valores. Varios de ellos
