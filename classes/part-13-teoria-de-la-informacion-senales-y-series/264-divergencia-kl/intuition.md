# Intuición — Divergencia KL

## La pregunta antes de la fórmula

¿Qué problema resuelve **Divergencia KL**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `kl_divergence`: kl: no simétrica y no es una distancia.
