...
3. Ejecutar y modificar `lab.py`, que corre la demostración `kl_divergence` del motor de la parte.
...
- `KL(p||p)`
- `siempre_no_negativa`
- `no_cumple_desigualdad_triangular`
- `KL_infinita_si_q=0_donde_p>0`
