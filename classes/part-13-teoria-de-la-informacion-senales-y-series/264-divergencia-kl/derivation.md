# Derivación y razonamiento — Divergencia KL
...
Construye una derivación de 5 a 10 pasos relacionada con **Divergencia KL**.
...
La demostración `kl_divergence` recorre este mismo razonamiento en código.
