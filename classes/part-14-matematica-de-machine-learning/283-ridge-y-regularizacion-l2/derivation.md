# Derivación y razonamiento — Ridge y regularización L2
...
Construye una derivación de 5 a 10 pasos relacionada con **Ridge y regularización L2**.
...
La demostración `ridge` recorre este mismo razonamiento en código.
