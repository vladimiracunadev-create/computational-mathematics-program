...
**Motor:** `computational_math.engines.part14` · demostración `ridge`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `ridge` del motor de la parte.
...
- `λ=1.0`
- `λ=10.0`
- `condicion_sin_regularizar`
- `condicion_con_λ=1`
- `ridge_nunca_anula_coeficientes`
- `solucion_cerrada`
