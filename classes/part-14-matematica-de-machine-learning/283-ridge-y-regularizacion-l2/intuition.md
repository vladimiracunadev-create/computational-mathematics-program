# Intuición — Ridge y regularización L2

## La pregunta antes de la fórmula

¿Qué problema resuelve **Ridge y regularización L2**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `ridge`: ridge: l2 encoge los coeficientes y estabiliza el mal condicionamiento.
