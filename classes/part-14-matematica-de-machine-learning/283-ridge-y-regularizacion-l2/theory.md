# Teoría — Ridge y regularización L2

## Definición operativa

En esta clase, **Ridge y regularización L2** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`ridge`) devuelve 8 valores. Varios de ellos
