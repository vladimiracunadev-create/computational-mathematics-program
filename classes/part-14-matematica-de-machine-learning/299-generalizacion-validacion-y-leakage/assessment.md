# Evaluación — Generalización, validación y leakage
...
| Implementación y verificación | 25 % | ejecuta `generalization`, interpreta sus salidas y comprueba al menos un invariante |
