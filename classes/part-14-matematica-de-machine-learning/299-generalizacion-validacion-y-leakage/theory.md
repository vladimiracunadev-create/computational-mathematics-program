# Teoría — Generalización, validación y leakage

## Definición operativa

En esta clase, **Generalización, validación y leakage** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`generalization`) devuelve 10 valores. Varios de ellos
