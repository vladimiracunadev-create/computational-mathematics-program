# Intuición — Generalización, validación y leakage

## La pregunta antes de la fórmula

¿Qué problema resuelve **Generalización, validación y leakage**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `generalization`: validación honesta frente a leakage: la misma métrica, dos verdades.
