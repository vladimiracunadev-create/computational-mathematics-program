# Derivación y razonamiento — Bias-variance tradeoff
...
Construye una derivación de 5 a 10 pasos relacionada con **Bias-variance tradeoff**.
...
La demostración `bias_variance` recorre este mismo razonamiento en código.
