# Intuición — Bias-variance tradeoff

## La pregunta antes de la fórmula

¿Qué problema resuelve **Bias-variance tradeoff**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bias_variance`: descomposición sesgo-varianza medida por simulación.
