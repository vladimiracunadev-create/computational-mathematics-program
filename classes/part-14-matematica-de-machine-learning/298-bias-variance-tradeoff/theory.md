# Teoría — Bias-variance tradeoff

## Definición operativa

En esta clase, **Bias-variance tradeoff** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`bias_variance`) devuelve 8 valores. Varios de ellos
