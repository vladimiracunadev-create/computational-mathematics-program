...
**Motor:** `computational_math.engines.part14` · demostración `em_algorithm`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `em_algorithm` del motor de la parte.
