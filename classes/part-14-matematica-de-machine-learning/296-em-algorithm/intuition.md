# Intuición — EM algorithm

## La pregunta antes de la fórmula

¿Qué problema resuelve **EM algorithm**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `em_algorithm`: em: e-step y m-step sobre datos con una variable latente.
