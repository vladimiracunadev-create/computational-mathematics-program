# Derivación y razonamiento — EM algorithm
...
Construye una derivación de 5 a 10 pasos relacionada con **EM algorithm**.
...
La demostración `em_algorithm` recorre este mismo razonamiento en código.
