# Teoría — Regresión logística y sigmoid

## Definición operativa

En esta clase, **Regresión logística y sigmoid** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`logistic_regression`) devuelve 8 valores. Varios de ellos
