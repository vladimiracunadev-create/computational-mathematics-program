# Evaluación — Regresión logística y sigmoid
...
| Implementación y verificación | 25 % | ejecuta `logistic_regression`, interpreta sus salidas y comprueba al menos un invariante |
