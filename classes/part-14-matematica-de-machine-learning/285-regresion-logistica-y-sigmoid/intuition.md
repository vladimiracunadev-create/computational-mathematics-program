# Intuición — Regresión logística y sigmoid

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regresión logística y sigmoid**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `logistic_regression`: regresión logística derivada desde la log-verosimilitud.
