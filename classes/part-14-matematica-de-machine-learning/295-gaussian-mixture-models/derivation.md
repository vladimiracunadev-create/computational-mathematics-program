# Derivación y razonamiento — Gaussian Mixture Models
...
Construye una derivación de 5 a 10 pasos relacionada con **Gaussian Mixture Models**.
...
La demostración `gmm` recorre este mismo razonamiento en código.
