# Teoría — Gaussian Mixture Models

## Definición operativa

En esta clase, **Gaussian Mixture Models** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`gmm`) devuelve 8 valores. Varios de ellos
