# Intuición — Gaussian Mixture Models

## La pregunta antes de la fórmula

¿Qué problema resuelve **Gaussian Mixture Models**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `gmm`: mezcla de gaussianas: asignación blanda en lugar de dura.
