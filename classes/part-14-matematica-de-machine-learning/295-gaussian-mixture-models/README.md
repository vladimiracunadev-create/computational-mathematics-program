...
**Motor:** `computational_math.engines.part14` · demostración `gmm`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `gmm` del motor de la parte.
...
- `pesos_de_mezcla`
- `log_verosimilitud`
- `la_log_verosimilitud_nunca_baja`
- `asignacion_blanda`
- `kmeans_es_el_caso_limite`
