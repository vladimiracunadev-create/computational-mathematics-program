# Intuición — Naive Bayes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Naive Bayes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `naive_bayes`: naive bayes gaussiano: independencia condicional como supuesto explícito.
