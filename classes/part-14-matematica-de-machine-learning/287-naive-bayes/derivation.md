# Derivación y razonamiento — Naive Bayes
...
Construye una derivación de 5 a 10 pasos relacionada con **Naive Bayes**.
...
La demostración `naive_bayes` recorre este mismo razonamiento en código.
