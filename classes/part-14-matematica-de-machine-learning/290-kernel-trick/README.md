...
**Motor:** `computational_math.engines.part14` · demostración `kernel_trick`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `kernel_trick` del motor de la parte.
...
- `b`
- `phi(a)`
- `producto_en_el_espacio_expandido`
- `kernel_polinomico_(aᵀb)²`
- `coinciden`
- `dimension_explicita`
- `operaciones_kernel`
- `kernel_RBF`
- `dimension_implicita_del_RBF`
- `condicion_de_Mercer`
