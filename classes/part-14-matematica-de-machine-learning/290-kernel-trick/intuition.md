# Intuición — Kernel trick

## La pregunta antes de la fórmula

¿Qué problema resuelve **Kernel trick**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `kernel_trick`: el kernel calcula el producto punto sin construir el espacio.
