# Derivación y razonamiento — Kernel trick
...
Construye una derivación de 5 a 10 pasos relacionada con **Kernel trick**.
...
La demostración `kernel_trick` recorre este mismo razonamiento en código.
