# Teoría — Boosting y descenso funcional

## Definición operativa

En esta clase, **Boosting y descenso funcional** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`boosting`) devuelve 8 valores. Varios de ellos
