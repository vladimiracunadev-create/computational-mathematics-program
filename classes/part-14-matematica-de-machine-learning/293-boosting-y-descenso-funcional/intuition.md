# Intuición — Boosting y descenso funcional

## La pregunta antes de la fórmula

¿Qué problema resuelve **Boosting y descenso funcional**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `boosting`: boosting: cada modelo corrige el residuo del anterior (descenso funcional).
