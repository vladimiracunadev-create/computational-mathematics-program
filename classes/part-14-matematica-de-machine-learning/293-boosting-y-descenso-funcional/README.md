...
**Motor:** `computational_math.engines.part14` · demostración `boosting`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `boosting` del motor de la parte.
