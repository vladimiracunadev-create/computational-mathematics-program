...
- [Friedman, J. *Greedy function approximation: a gradient boosting machine*, Annals of Statistics, 2001](https://doi.org/10.1214/aos/1013203451) — Machine learning: el tema de esta clase · DOI `10.1214/aos/1013203451` verificado en Crossref (2026-08-19).
- [Chen, T.; Guestrin, C. *XGBoost: A Scalable Tree Boosting System*, KDD, 2016](https://arxiv.org/abs/1603.02754) — Machine learning: el tema de esta clase · DOI `10.48550/arxiv.1603.02754` verificado en DataCite (2026-08-19).
