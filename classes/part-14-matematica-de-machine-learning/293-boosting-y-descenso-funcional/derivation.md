# Derivación y razonamiento — Boosting y descenso funcional
...
Construye una derivación de 5 a 10 pasos relacionada con **Boosting y descenso funcional**.
...
La demostración `boosting` recorre este mismo razonamiento en código.
