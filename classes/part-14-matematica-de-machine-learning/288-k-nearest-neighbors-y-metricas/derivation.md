# Derivación y razonamiento — k-Nearest Neighbors y métricas
...
Construye una derivación de 5 a 10 pasos relacionada con **k-Nearest Neighbors y métricas**.
...
La demostración `knn` recorre este mismo razonamiento en código.
