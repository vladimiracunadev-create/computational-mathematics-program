# Intuición — k-Nearest Neighbors y métricas

## La pregunta antes de la fórmula

¿Qué problema resuelve **k-Nearest Neighbors y métricas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `knn`: k-nn: la métrica y el escalado deciden el resultado.
