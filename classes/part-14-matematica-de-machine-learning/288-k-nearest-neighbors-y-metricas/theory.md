# Teoría — k-Nearest Neighbors y métricas

## Definición operativa

En esta clase, **k-Nearest Neighbors y métricas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`knn`) devuelve 9 valores. Varios de ellos
