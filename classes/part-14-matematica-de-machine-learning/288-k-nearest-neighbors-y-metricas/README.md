...
**Motor:** `computational_math.engines.part14` · demostración `knn`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `knn` del motor de la parte.
...
- `prediccion_k=5`
- `prediccion_k=21`
- `prediccion_con_x2_escalada_x100`
- `el_escalado_cambia_la_respuesta`
- `coste_de_prediccion`
- `k_par_puede_empatar`
