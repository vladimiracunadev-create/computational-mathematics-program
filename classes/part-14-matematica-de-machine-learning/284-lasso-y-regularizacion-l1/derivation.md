# Derivación y razonamiento — Lasso y regularización L1
...
Construye una derivación de 5 a 10 pasos relacionada con **Lasso y regularización L1**.
...
La demostración `lasso` recorre este mismo razonamiento en código.
