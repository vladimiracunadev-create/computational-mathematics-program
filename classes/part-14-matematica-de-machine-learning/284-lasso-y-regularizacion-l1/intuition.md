# Intuición — Lasso y regularización L1

## La pregunta antes de la fórmula

¿Qué problema resuelve **Lasso y regularización L1**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `lasso`: lasso: l1 produce ceros exactos gracias a su geometría.
