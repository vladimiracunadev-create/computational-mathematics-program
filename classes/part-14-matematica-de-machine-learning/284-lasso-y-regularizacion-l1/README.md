...
**Motor:** `computational_math.engines.part14` · demostración `lasso`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `lasso` del motor de la parte.
