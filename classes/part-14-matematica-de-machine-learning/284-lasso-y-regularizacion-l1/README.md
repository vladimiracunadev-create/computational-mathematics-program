...
- [Tibshirani, R. *Regression shrinkage and selection via the lasso*, JRSS-B, 1996](https://doi.org/10.1111/j.2517-6161.1996.tb02080.x) — Machine learning: el tema de esta clase · DOI `10.1111/j.2517-6161.1996.tb02080.x` verificado en Crossref (2026-08-19).
- [Zou, H.; Hastie, T. *Regularization and variable selection via the elastic net*, JRSS-B, 2005](https://doi.org/10.1111/j.1467-9868.2005.00503.x) — Machine learning: el tema de esta clase · DOI `10.1111/j.1467-9868.2005.00503.x` verificado en Crossref (2026-08-19).
