# Teoría — Lasso y regularización L1

## Definición operativa

En esta clase, **Lasso y regularización L1** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`lasso`) devuelve 8 valores. Varios de ellos
