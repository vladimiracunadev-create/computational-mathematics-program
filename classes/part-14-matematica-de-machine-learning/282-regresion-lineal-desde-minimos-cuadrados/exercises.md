# Ejercicios — Regresión lineal desde mínimos cuadrados

## Básico

1. Define **Regresión lineal desde mínimos cuadrados** con tus palabras y da un ejemplo válido y uno inválido.
