# Evaluación — Regresión lineal desde mínimos cuadrados
...
| Implementación y verificación | 25 % | ejecuta `linear_regression`, interpreta sus salidas y comprueba al menos un invariante |
