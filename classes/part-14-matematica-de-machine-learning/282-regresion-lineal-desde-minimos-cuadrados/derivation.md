# Derivación y razonamiento — Regresión lineal desde mínimos cuadrados
...
Construye una derivación de 5 a 10 pasos relacionada con **Regresión lineal desde mínimos cuadrados**.
...
La demostración `linear_regression` recorre este mismo razonamiento en código.
