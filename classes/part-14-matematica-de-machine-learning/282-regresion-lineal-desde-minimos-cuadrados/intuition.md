# Intuición — Regresión lineal desde mínimos cuadrados

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regresión lineal desde mínimos cuadrados**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_regression`: regresión lineal: solución cerrada y descenso de gradiente.
