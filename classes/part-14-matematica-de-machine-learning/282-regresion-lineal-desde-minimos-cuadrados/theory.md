# Teoría — Regresión lineal desde mínimos cuadrados

## Definición operativa

En esta clase, **Regresión lineal desde mínimos cuadrados** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_regression`) devuelve 9 valores. Varios de ellos
