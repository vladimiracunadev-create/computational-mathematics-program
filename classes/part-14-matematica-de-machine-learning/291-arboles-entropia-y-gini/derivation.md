# Derivación y razonamiento — Árboles: entropía y Gini
...
Construye una derivación de 5 a 10 pasos relacionada con **Árboles: entropía y Gini**.
...
La demostración `tree_impurity` recorre este mismo razonamiento en código.
