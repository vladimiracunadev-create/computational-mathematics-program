# Teoría — Árboles: entropía y Gini

## Definición operativa

En esta clase, **Árboles: entropía y Gini** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`tree_impurity`) devuelve 8 valores. Varios de ellos
