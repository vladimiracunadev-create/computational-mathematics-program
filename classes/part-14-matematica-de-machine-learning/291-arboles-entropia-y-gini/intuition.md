# Intuición — Árboles: entropía y Gini

## La pregunta antes de la fórmula

¿Qué problema resuelve **Árboles: entropía y Gini**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `tree_impurity`: entropía y gini: dos medidas de impureza para elegir el corte.
