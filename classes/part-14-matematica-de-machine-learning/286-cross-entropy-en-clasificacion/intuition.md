# Intuición — Cross-entropy en clasificación

## La pregunta antes de la fórmula

¿Qué problema resuelve **Cross-entropy en clasificación**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `classification_loss`: cross-entropy penaliza la confianza equivocada de forma no acotada.
