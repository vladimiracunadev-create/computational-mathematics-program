# Derivación y razonamiento — Cross-entropy en clasificación
...
Construye una derivación de 5 a 10 pasos relacionada con **Cross-entropy en clasificación**.
...
La demostración `classification_loss` recorre este mismo razonamiento en código.
