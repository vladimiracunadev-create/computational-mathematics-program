# Teoría — Cross-entropy en clasificación

## Definición operativa

En esta clase, **Cross-entropy en clasificación** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`classification_loss`) devuelve 8 valores. Varios de ellos
