...
**Motor:** `computational_math.engines.part14` · demostración `classification_loss`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `classification_loss` del motor de la parte.
...
- `incorrecto_dudoso`
- `incorrecto_seguro`
- `razon_CE_seguro_vs_dudoso`
- `razon_MSE_seguro_vs_dudoso`
- `CE_castiga_mucho_mas`
- `gradiente_de_CE_con_sigmoid`
