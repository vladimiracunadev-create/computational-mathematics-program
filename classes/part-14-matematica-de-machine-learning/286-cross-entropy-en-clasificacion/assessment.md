# Evaluación — Cross-entropy en clasificación
...
| Implementación y verificación | 25 % | ejecuta `classification_loss`, interpreta sus salidas y comprueba al menos un invariante |
