# Intuición — Random Forest desde probabilidad

## La pregunta antes de la fórmula

¿Qué problema resuelve **Random Forest desde probabilidad**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `random_forest`: bagging: promediar modelos decorrelacionados reduce la varianza.
