# Evaluación — Random Forest desde probabilidad
...
| Implementación y verificación | 25 % | ejecuta `random_forest`, interpreta sus salidas y comprueba al menos un invariante |
