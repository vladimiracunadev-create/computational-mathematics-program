# Teoría — Random Forest desde probabilidad

## Definición operativa

En esta clase, **Random Forest desde probabilidad** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`random_forest`) devuelve 8 valores. Varios de ellos
