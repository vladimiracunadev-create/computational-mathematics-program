# Intuición — Geometría del aprendizaje supervisado

## La pregunta antes de la fórmula

¿Qué problema resuelve **Geometría del aprendizaje supervisado**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `supervised_geometry`: aprendizaje supervisado como búsqueda de una frontera en el espacio.
