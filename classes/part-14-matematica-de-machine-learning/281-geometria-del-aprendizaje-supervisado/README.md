...
**Motor:** `computational_math.engines.part14` · demostración `supervised_geometry`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `supervised_geometry` del motor de la parte.
...
- `distancia_entre_centroides`
- `accuracy_del_clasificador_de_centroides`
- `hipotesis`
