# Evaluación — Geometría del aprendizaje supervisado
...
| Implementación y verificación | 25 % | ejecuta `supervised_geometry`, interpreta sus salidas y comprueba al menos un invariante |
