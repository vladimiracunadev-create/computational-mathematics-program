# Teoría — Geometría del aprendizaje supervisado

## Definición operativa

En esta clase, **Geometría del aprendizaje supervisado** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`supervised_geometry`) devuelve 8 valores. Varios de ellos
