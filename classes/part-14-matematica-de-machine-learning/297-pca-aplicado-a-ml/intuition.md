# Intuición — PCA aplicado a ML

## La pregunta antes de la fórmula

¿Qué problema resuelve **PCA aplicado a ML**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `pca_ml`: pca como preprocesamiento: cuánta varianza se conserva.
