# Derivación y razonamiento — PCA aplicado a ML
...
Construye una derivación de 5 a 10 pasos relacionada con **PCA aplicado a ML**.
...
La demostración `pca_ml` recorre este mismo razonamiento en código.
