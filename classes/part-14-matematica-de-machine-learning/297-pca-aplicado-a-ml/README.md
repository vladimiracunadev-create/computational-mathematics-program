...
**Motor:** `computational_math.engines.part14` · demostración `pca_ml`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `pca_ml` del motor de la parte.
...
- `PC1`
- `accuracy_usando_solo_PC1`
- `dimension_reducida`
- `centrar_es_obligatorio`
- `PCA_es_no_supervisado`
