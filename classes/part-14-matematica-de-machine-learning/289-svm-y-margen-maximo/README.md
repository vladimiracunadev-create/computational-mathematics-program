...
**Motor:** `computational_math.engines.part14` · demostración `svm_margin`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `svm_margin` del motor de la parte.
...
- `b`
- `norma_de_w`
- `ancho_del_margen_2/|w|`
- `vectores_de_soporte`
- `accuracy`
- `objetivo`
- `hinge_loss`
- `solo_los_vectores_de_soporte_definen_la_frontera`
