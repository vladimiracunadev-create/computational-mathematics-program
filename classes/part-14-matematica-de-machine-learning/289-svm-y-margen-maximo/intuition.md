# Intuición — SVM y margen máximo

## La pregunta antes de la fórmula

¿Qué problema resuelve **SVM y margen máximo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `svm_margin`: svm: maximizar el margen equivale a minimizar ‖w‖.
