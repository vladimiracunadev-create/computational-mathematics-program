# Derivación y razonamiento — SVM y margen máximo
...
Construye una derivación de 5 a 10 pasos relacionada con **SVM y margen máximo**.
...
La demostración `svm_margin` recorre este mismo razonamiento en código.
