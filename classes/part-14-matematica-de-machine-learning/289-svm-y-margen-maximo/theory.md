# Teoría — SVM y margen máximo

## Definición operativa

En esta clase, **SVM y margen máximo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`svm_margin`) devuelve 9 valores. Varios de ellos
