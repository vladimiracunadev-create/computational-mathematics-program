# Derivación y razonamiento — k-means como optimización
...
Construye una derivación de 5 a 10 pasos relacionada con **k-means como optimización**.
...
La demostración `kmeans` recorre este mismo razonamiento en código.
