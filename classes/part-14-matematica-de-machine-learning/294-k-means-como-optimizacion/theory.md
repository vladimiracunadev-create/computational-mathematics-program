# Teoría — k-means como optimización

## Definición operativa

En esta clase, **k-means como optimización** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`kmeans`) devuelve 9 valores. Varios de ellos
