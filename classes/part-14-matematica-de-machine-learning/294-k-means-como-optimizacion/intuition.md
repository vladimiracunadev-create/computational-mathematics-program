# Intuición — k-means como optimización

## La pregunta antes de la fórmula

¿Qué problema resuelve **k-means como optimización**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `kmeans`: k-means como minimización de la inercia (lloyd).
