...
**Motor:** `computational_math.engines.part14` · demostración `kmeans`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `kmeans` del motor de la parte.
...
- `k`
- `iteraciones_hasta_converger`
- `centroides`
- `historial_de_inercia`
- `la_inercia_nunca_sube`
- `objetivo`
- `converge_a_un_optimo_local`
- `sensible_a_la_inicializacion`
- `semilla`
