# Intuición — Capstone: derivar y comparar 6 algoritmos ML

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: derivar y comparar 6 algoritmos ML**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Matemática de Machine Learning**. Derivación matemática de los algoritmos clásicos: regresión, regularización, clasificación, kernels, árboles, ensambles, clustering, EM y compromiso sesgo-varianza.
...
El laboratorio ejecuta `capstone_six_algorithms`: capstone: seis algoritmos derivados y comparados sobre los mismos datos.
