# Ejercicios — Capstone: derivar y comparar 6 algoritmos ML

## Básico

1. Define **Capstone: derivar y comparar 6 algoritmos ML** con tus palabras y da un ejemplo válido y uno inválido.
...
7. Conecta esta clase con scoring crediticio, detección de fraude, segmentación y predicción tabular mediante un caso concreto y realista.
