# Evaluación — Capstone: derivar y comparar 6 algoritmos ML
...
| Implementación y verificación | 25 % | ejecuta `capstone_six_algorithms`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con scoring crediticio o con IA |
...
5. ¿Dónde aparece este concepto en scoring crediticio?
