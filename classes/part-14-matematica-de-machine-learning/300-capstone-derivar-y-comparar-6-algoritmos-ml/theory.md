# Teoría — Capstone: derivar y comparar 6 algoritmos ML

## Definición operativa

En esta clase, **Capstone: derivar y comparar 6 algoritmos ML** se trata como un objeto con tres capas
separadas:
...
## Ideas centrales de la parte 14
...
ningún paso quede oculto. En la práctica profesional se usa: math, random, numpy (opcional), scikit-learn (opcional).
...
El laboratorio (`capstone_six_algorithms`) devuelve 7 valores. Varios de ellos
