# Evaluación — Variational inference avanzada
...
| Implementación y verificación | 25 % | ejecuta `advanced_variational_inference`, interpreta sus salidas y comprueba al menos un invariante |
