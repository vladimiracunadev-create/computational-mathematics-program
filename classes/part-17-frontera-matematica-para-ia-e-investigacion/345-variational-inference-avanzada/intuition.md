# Intuición — Variational inference avanzada

## La pregunta antes de la fórmula

¿Qué problema resuelve **Variational inference avanzada**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `advanced_variational_inference`: inferencia variacional: optimizar en lugar de muestrear.
