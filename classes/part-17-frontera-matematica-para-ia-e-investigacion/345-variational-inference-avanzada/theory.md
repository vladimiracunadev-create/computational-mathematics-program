# Teoría — Variational inference avanzada

## Definición operativa

En esta clase, **Variational inference avanzada** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`advanced_variational_inference`) devuelve 9 valores. Varios de ellos
