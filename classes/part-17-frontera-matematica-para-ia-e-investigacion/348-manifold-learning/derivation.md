# Derivación y razonamiento — Manifold learning
...
Construye una derivación de 5 a 10 pasos relacionada con **Manifold learning**.
...
La demostración `manifold_learning` recorre este mismo razonamiento en código.
