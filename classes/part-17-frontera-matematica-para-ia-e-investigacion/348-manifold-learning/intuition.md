# Intuición — Manifold learning

## La pregunta antes de la fórmula

¿Qué problema resuelve **Manifold learning**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `manifold_learning`: variedad: dimensión intrínseca menor que la del espacio ambiente.
