...
**Motor:** `computational_math.engines.part17` · demostración `manifold_learning`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `manifold_learning` del motor de la parte.
...
- `puntos`
- `dimension_ambiente`
- `dimension_intrinseca`
- `autovalores_de_la_covarianza`
- `varianza_explicada_%`
- `PCA_no_detecta_1_dimension`
- `distancia_euclidea_extremos`
- `distancia_geodesica_extremos`
- `razon`
- `por_que_falla_PCA`
- `alternativas`
