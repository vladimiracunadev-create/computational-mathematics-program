# Teoría — Manifold learning

## Definición operativa

En esta clase, **Manifold learning** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`manifold_learning`) devuelve 11 valores. Varios de ellos
