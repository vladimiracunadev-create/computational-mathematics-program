# Evaluación — Spectral graph theory
...
| Implementación y verificación | 25 % | ejecuta `spectral_graph_theory`, interpreta sus salidas y comprueba al menos un invariante |
