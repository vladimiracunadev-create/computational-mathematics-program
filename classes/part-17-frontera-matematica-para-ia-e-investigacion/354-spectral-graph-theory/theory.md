# Teoría — Spectral graph theory

## Definición operativa

En esta clase, **Spectral graph theory** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`spectral_graph_theory`) devuelve 11 valores. Varios de ellos
