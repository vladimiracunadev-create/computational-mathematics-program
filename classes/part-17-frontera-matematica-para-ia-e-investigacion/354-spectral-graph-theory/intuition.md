# Intuición — Spectral graph theory

## La pregunta antes de la fórmula

¿Qué problema resuelve **Spectral graph theory**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `spectral_graph_theory`: clustering espectral: el vector de fiedler separa el grafo.
