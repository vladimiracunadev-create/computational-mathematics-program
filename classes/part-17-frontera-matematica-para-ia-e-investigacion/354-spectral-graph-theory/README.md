...
**Motor:** `computational_math.engines.part17` · demostración `spectral_graph_theory`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `spectral_graph_theory` del motor de la parte.
...
- `conectividad_algebraica`
- `grafo_conexo`
- `vector_de_Fiedler`
- `particion`
- `aristas_cortadas`
- `corte_minimo_esperado`
- `particion_correcta`
- `cota_de_Cheeger`
