# Intuición — VC dimension

## La pregunta antes de la fórmula

¿Qué problema resuelve **VC dimension**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `vc_dimension`: dimensión vc: cuántos puntos puede fragmentar una clase de hipótesis.
