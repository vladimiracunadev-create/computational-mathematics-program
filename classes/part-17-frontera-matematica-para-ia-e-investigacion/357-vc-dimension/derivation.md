# Derivación y razonamiento — VC dimension
...
Construye una derivación de 5 a 10 pasos relacionada con **VC dimension**.
...
La demostración `vc_dimension` recorre este mismo razonamiento en código.
