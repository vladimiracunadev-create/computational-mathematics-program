...
**Motor:** `computational_math.engines.part17` · demostración `vc_dimension`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `vc_dimension` del motor de la parte.
...
- `hiperplanos_en_R^d`
- `hiperplanos_en_R^2`
- `por_que_no_4_puntos_en_R2`
- `clase_infinita_con_VC_finita`
- `lema_de_Sauer`
- `cota_de_generalizacion`
- `VC_infinita`
