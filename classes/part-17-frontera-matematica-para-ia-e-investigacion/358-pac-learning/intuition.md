# Intuición — PAC learning

## La pregunta antes de la fórmula

¿Qué problema resuelve **PAC learning**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `pac_learning`: pac: cuántas muestras hacen falta para (ε, δ).
