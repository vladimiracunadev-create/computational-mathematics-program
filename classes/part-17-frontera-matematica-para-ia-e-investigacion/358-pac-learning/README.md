...
**Motor:** `computational_math.engines.part17` · demostración `pac_learning`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `pac_learning` del motor de la parte.
...
- `delta`
- `muestras_necesarias`
- `el_coste_crece_como_1/ε`
- `el_coste_crece_como_log(1/δ)`
- `dependencia_de_la_complejidad`
- `es_una_cota_del_peor_caso`
- `limite_practico`
- `referencia`
