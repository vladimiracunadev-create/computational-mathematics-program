# Derivación y razonamiento — PAC learning
...
Construye una derivación de 5 a 10 pasos relacionada con **PAC learning**.
...
La demostración `pac_learning` recorre este mismo razonamiento en código.
