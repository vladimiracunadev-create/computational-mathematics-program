...
**Motor:** `computational_math.engines.part17` · demostración `gaussian_processes`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `gaussian_processes` del motor de la parte.
...
- `ruido`
- `predicciones`
- `en_un_punto_observado_la_varianza_es_minima`
- `lejos_de_los_datos_vuelve_al_prior`
- `coste`
- `por_que_jitter`
- `referencia`
