# Derivación y razonamiento — Gaussian Processes
...
Construye una derivación de 5 a 10 pasos relacionada con **Gaussian Processes**.
...
La demostración `gaussian_processes` recorre este mismo razonamiento en código.
