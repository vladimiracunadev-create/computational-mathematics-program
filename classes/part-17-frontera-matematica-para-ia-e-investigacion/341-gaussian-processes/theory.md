# Teoría — Gaussian Processes

## Definición operativa

En esta clase, **Gaussian Processes** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`gaussian_processes`) devuelve 9 valores. Varios de ellos
