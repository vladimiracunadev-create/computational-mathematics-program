# Intuición — Gaussian Processes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Gaussian Processes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `gaussian_processes`: gp: distribución sobre funciones, con media y varianza posterior.
