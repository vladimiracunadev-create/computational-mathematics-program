...
**Motor:** `computational_math.engines.part17` · demostración `information_geometry`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `information_geometry` del motor de la parte.
...
- `la_informacion_es_maxima_en_los_extremos`
