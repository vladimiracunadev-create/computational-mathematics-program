...
- [Amari, S. *Information Geometry and Its Applications*, Springer, 2016](https://doi.org/10.1007/978-4-431-55978-8) — Geometría diferencial: el tema de esta clase · ISBN-13 `9784431559788` verificado en International ISBN Agency (2026-08-19).
- [Martens, J. *New insights and perspectives on the natural gradient method*, JMLR, 2020](https://arxiv.org/abs/1412.1193) — Geometría diferencial: el tema de esta clase · DOI `10.48550/arxiv.1412.1193` verificado en DataCite (2026-08-19).
