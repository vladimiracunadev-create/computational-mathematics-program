# Derivación y razonamiento — Information geometry
...
Construye una derivación de 5 a 10 pasos relacionada con **Information geometry**.
...
La demostración `information_geometry` recorre este mismo razonamiento en código.
