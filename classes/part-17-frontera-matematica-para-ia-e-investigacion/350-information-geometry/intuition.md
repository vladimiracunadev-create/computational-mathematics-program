# Intuición — Information geometry

## La pregunta antes de la fórmula

¿Qué problema resuelve **Information geometry**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `information_geometry`: información de fisher: la métrica natural del espacio de parámetros.
