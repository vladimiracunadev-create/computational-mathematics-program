"""Laboratorio 360 — Capstone final: reproducir una idea matemática de un paper.
...
DEMO = "capstone_reproduce_paper_idea"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 360 — Capstone final: reproducir una idea matemática de un paper")
