# Intuición — Capstone final: reproducir una idea matemática de un paper

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone final: reproducir una idea matemática de un paper**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `capstone_reproduce_paper_idea`: capstone: reproducir el núcleo matemático de un resultado publicado.
