# Ejercicios — Capstone final: reproducir una idea matemática de un paper

## Básico

1. Define **Capstone final: reproducir una idea matemática de un paper** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 22 salidas.
...
7. Conecta esta clase con investigación aplicada, optimización bayesiana, modelado generativo y teoría del aprendizaje mediante un caso concreto y realista.
