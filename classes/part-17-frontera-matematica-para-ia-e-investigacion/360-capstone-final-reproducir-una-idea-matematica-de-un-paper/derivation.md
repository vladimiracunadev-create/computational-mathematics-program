# Derivación y razonamiento — Capstone final: reproducir una idea matemática de un paper
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone final: reproducir una idea matemática de un paper**.
...
La demostración `capstone_reproduce_paper_idea` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part17.py` y responde:
