# Teoría — Capstone final: reproducir una idea matemática de un paper

## Definición operativa

En esta clase, **Capstone final: reproducir una idea matemática de un paper** se trata como un objeto con tres capas
separadas:
...
## Ideas centrales de la parte 17
...
ningún paso quede oculto. En la práctica profesional se usa: math, random, numpy (opcional), pymc/jax (opcional).
...
El laboratorio (`capstone_reproduce_paper_idea`) devuelve 22 valores. Varios de ellos
