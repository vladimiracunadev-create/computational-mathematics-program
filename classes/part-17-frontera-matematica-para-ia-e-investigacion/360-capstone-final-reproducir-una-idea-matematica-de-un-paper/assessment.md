# Evaluación — Capstone final: reproducir una idea matemática de un paper
...
| Implementación y verificación | 25 % | ejecuta `capstone_reproduce_paper_idea`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con investigación aplicada o con IA |
...
5. ¿Dónde aparece este concepto en investigación aplicada?
