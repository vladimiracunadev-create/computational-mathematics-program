# Intuición — MCMC avanzado

## La pregunta antes de la fórmula

¿Qué problema resuelve **MCMC avanzado**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `advanced_mcmc`: metropolis-hastings con diagnóstico de aceptación y autocorrelación.
