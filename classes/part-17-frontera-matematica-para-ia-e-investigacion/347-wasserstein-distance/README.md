...
- [Arjovsky, M.; Chintala, S.; Bottou, L. *Wasserstein GAN*, ICML, 2017](https://arxiv.org/abs/1701.07875) — Modelos generativos y Transporte óptimo: el tema de esta clase · DOI `10.48550/arxiv.1701.07875` verificado en DataCite (2026-08-19).
- [Villani, C. *Optimal Transport: Old and New*, Springer, 2009](https://doi.org/10.1007/978-3-540-71050-9) — Transporte óptimo: el tema de esta clase · ISBN-13 `9783540710509` verificado en International ISBN Agency (2026-08-19).
