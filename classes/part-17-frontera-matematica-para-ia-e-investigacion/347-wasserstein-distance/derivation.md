# Derivación y razonamiento — Wasserstein distance
...
Construye una derivación de 5 a 10 pasos relacionada con **Wasserstein distance**.
...
La demostración `wasserstein_distance` recorre este mismo razonamiento en código.
