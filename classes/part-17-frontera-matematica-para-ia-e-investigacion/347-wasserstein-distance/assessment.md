# Evaluación — Wasserstein distance
...
| Implementación y verificación | 25 % | ejecuta `wasserstein_distance`, interpreta sus salidas y comprueba al menos un invariante |
