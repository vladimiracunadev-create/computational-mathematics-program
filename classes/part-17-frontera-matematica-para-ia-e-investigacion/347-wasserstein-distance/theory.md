# Teoría — Wasserstein distance

## Definición operativa

En esta clase, **Wasserstein distance** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`wasserstein_distance`) devuelve 11 valores. Varios de ellos
