# Intuición — Wasserstein distance

## La pregunta antes de la fórmula

¿Qué problema resuelve **Wasserstein distance**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `wasserstein_distance`: wasserstein-1 en 1d: comparar distribuciones sin soporte común.
