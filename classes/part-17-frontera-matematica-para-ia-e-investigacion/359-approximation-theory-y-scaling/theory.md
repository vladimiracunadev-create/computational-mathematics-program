# Teoría — Approximation theory y scaling

## Definición operativa

En esta clase, **Approximation theory y scaling** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`approximation_theory`) devuelve 11 valores. Varios de ellos
