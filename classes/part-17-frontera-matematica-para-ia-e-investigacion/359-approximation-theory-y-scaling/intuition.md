# Intuición — Approximation theory y scaling

## La pregunta antes de la fórmula

¿Qué problema resuelve **Approximation theory y scaling**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `approximation_theory`: teoría de aproximación y leyes de escala: el error como potencia del tamaño.
