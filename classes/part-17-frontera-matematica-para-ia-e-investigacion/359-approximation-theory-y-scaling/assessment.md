# Evaluación — Approximation theory y scaling
...
| Implementación y verificación | 25 % | ejecuta `approximation_theory`, interpreta sus salidas y comprueba al menos un invariante |
