# Ejercicios — Approximation theory y scaling

## Básico

1. Define **Approximation theory y scaling** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 11 salidas.
