...
Esta clase enseña **Deep learning · Modelos de lenguaje**. Cada obra dice qué aporta aquí y cómo se comprobó su localizador:

- [Kaplan, J. et al. *Scaling Laws for Neural Language Models*, 2020](https://arxiv.org/abs/2001.08361) — Deep learning y Modelos de lenguaje: el tema de esta clase · DOI `10.48550/arxiv.2001.08361` verificado en DataCite (2026-08-19).
- [Hoffmann, J. et al. *Training Compute-Optimal Large Language Models*, 2022](https://arxiv.org/abs/2203.15556) — Deep learning y Modelos de lenguaje: el tema de esta clase · DOI `10.48550/arxiv.2203.15556` verificado en DataCite (2026-08-19).
