# Teoría — Score matching

## Definición operativa

En esta clase, **Score matching** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`score_matching`) devuelve 10 valores. Varios de ellos
