# Derivación y razonamiento — Score matching
...
Construye una derivación de 5 a 10 pasos relacionada con **Score matching**.
...
La demostración `score_matching` recorre este mismo razonamiento en código.
