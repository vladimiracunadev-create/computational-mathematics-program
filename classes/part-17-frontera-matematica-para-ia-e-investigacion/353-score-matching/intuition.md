# Intuición — Score matching

## La pregunta antes de la fórmula

¿Qué problema resuelve **Score matching**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `score_matching`: score matching: aprender ∇ log p sin conocer la constante de normalización.
