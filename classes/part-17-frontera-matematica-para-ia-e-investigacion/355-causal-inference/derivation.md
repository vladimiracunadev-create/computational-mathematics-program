# Derivación y razonamiento — Causal inference
...
Construye una derivación de 5 a 10 pasos relacionada con **Causal inference**.
...
La demostración `causal_inference` recorre este mismo razonamiento en código.
