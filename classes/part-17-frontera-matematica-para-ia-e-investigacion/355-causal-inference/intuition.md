# Intuición — Causal inference

## La pregunta antes de la fórmula

¿Qué problema resuelve **Causal inference**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `causal_inference`: confusión, ajuste por backdoor y el sesgo de colisionador.
