# Teoría — Causal inference

## Definición operativa

En esta clase, **Causal inference** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`causal_inference`) devuelve 10 valores. Varios de ellos
