# Intuición — Optimal transport

## La pregunta antes de la fórmula

¿Qué problema resuelve **Optimal transport**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `optimal_transport`: transporte óptimo por sinkhorn: coste de mover una distribución a otra.
