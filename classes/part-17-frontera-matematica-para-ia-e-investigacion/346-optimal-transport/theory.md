# Teoría — Optimal transport

## Definición operativa

En esta clase, **Optimal transport** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`optimal_transport`) devuelve 11 valores. Varios de ellos
