# Derivación y razonamiento — Optimal transport
...
Construye una derivación de 5 a 10 pasos relacionada con **Optimal transport**.
...
La demostración `optimal_transport` recorre este mismo razonamiento en código.
