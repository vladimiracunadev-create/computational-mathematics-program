# Evaluación — Kernel methods avanzados
...
| Implementación y verificación | 25 % | ejecuta `advanced_kernels`, interpreta sus salidas y comprueba al menos un invariante |
