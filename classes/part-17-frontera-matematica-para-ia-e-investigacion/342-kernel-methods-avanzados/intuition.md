# Intuición — Kernel methods avanzados

## La pregunta antes de la fórmula

¿Qué problema resuelve **Kernel methods avanzados**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `advanced_kernels`: familias de kernels y la condición de mercer.
