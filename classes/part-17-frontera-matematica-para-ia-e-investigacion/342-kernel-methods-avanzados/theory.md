# Teoría — Kernel methods avanzados

## Definición operativa

En esta clase, **Kernel methods avanzados** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`advanced_kernels`) devuelve 8 valores. Varios de ellos
