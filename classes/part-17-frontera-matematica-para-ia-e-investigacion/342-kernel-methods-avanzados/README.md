...
**Motor:** `computational_math.engines.part17` · demostración `advanced_kernels`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `advanced_kernels` del motor de la parte.
...
- `matriz_de_Gram_RBF`
- `autovalores_de_Gram`
- `es_semidefinida_positiva`
- `condicion_de_Mercer`
- `suma_de_kernels_es_kernel`
- `producto_de_kernels_es_kernel`
- `matern_es_menos_suave_que_RBF`
