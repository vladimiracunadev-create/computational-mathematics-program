# Evaluación — Geometría diferencial para ML
...
| Implementación y verificación | 25 % | ejecuta `differential_geometry`, interpreta sus salidas y comprueba al menos un invariante |
