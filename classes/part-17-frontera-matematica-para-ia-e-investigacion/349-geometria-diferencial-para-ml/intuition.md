# Intuición — Geometría diferencial para ML

## La pregunta antes de la fórmula

¿Qué problema resuelve **Geometría diferencial para ML**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `differential_geometry`: geometría diferencial: métrica, longitud de curva y curvatura.
