# Derivación y razonamiento — Geometría diferencial para ML
...
Construye una derivación de 5 a 10 pasos relacionada con **Geometría diferencial para ML**.
...
La demostración `differential_geometry` recorre este mismo razonamiento en código.
