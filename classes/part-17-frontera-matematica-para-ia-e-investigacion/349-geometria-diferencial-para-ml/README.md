...
- [do Carmo, M. *Differential Geometry of Curves and Surfaces*, 2ª ed., Dover, 2016](https://store.doverpublications.com/products/9780486806990) — Geometría diferencial: el tema de esta clase · ISBN-13 `9780486806990` verificado en International ISBN Agency (2026-08-19).
- [Bronstein, M. et al. *Geometric Deep Learning*, 2021](https://arxiv.org/abs/2104.13478) — Geometría diferencial: el tema de esta clase · DOI `10.48550/arxiv.2104.13478` verificado en DataCite (2026-08-19).
