...
**Motor:** `computational_math.engines.part17` · demostración `differential_geometry`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `differential_geometry` del motor de la parte.
...
- `velocidad_en_t=1`
- `rapidez`
- `rapidez_teorica_√(1+0.09)`
- `longitud_de_arco_0_a_2π`
- `longitud_teorica`
- `curvatura`
- `curvatura_teorica_1/1.09`
- `metrica_riemanniana`
- `geodesica`
