# Teoría — Geometría diferencial para ML

## Definición operativa

En esta clase, **Geometría diferencial para ML** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`differential_geometry`) devuelve 10 valores. Varios de ellos
