# Derivación y razonamiento — Stochastic differential equations
...
Construye una derivación de 5 a 10 pasos relacionada con **Stochastic differential equations**.
...
La demostración `stochastic_differential_equations` recorre este mismo razonamiento en código.
