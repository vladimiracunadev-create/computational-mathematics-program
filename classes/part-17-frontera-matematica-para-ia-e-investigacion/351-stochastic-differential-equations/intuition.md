# Intuición — Stochastic differential equations

## La pregunta antes de la fórmula

¿Qué problema resuelve **Stochastic differential equations**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `stochastic_differential_equations`: sde: proceso de ornstein-uhlenbeck simulado con euler-maruyama.
