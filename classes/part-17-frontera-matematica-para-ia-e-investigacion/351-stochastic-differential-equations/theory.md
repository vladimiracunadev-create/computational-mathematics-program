# Teoría — Stochastic differential equations

## Definición operativa

En esta clase, **Stochastic differential equations** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`stochastic_differential_equations`) devuelve 13 valores. Varios de ellos
