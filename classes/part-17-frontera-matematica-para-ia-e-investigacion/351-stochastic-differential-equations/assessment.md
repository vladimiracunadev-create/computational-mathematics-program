# Evaluación — Stochastic differential equations
...
| Implementación y verificación | 25 % | ejecuta `stochastic_differential_equations`, interpreta sus salidas y comprueba al menos un invariante |
