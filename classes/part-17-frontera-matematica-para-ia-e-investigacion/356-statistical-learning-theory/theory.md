# Teoría — Statistical learning theory

## Definición operativa

En esta clase, **Statistical learning theory** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`statistical_learning_theory`) devuelve 8 valores. Varios de ellos
