# Intuición — Statistical learning theory

## La pregunta antes de la fórmula

¿Qué problema resuelve **Statistical learning theory**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `statistical_learning_theory`: riesgo empírico frente a riesgo verdadero y la brecha de generalización.
