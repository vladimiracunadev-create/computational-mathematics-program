...
**Motor:** `computational_math.engines.part17` · demostración `statistical_learning_theory`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `statistical_learning_theory` del motor de la parte.
...
- `señal_real_en_los_datos`
- `accuracy_esperada`
- `resultados`
- `mas_parametros_que_datos_memoriza`
- `descomposicion`
- `cota_uniforme`
- `el_riesgo_empirico_solo_no_basta`
- `semilla`
