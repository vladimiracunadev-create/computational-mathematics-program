# Teoría — Hamiltonian Monte Carlo

## Definición operativa

En esta clase, **Hamiltonian Monte Carlo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`hamiltonian_monte_carlo`) devuelve 13 valores. Varios de ellos
