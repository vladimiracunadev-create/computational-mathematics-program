# Evaluación — Hamiltonian Monte Carlo
...
| Implementación y verificación | 25 % | ejecuta `hamiltonian_monte_carlo`, interpreta sus salidas y comprueba al menos un invariante |
