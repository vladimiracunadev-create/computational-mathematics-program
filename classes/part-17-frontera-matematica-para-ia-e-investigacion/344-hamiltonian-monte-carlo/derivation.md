# Derivación y razonamiento — Hamiltonian Monte Carlo
...
Construye una derivación de 5 a 10 pasos relacionada con **Hamiltonian Monte Carlo**.
...
La demostración `hamiltonian_monte_carlo` recorre este mismo razonamiento en código.
