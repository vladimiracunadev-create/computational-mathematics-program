...
- [Neal, R. *MCMC using Hamiltonian dynamics*, Handbook of MCMC, 2011](https://arxiv.org/abs/1206.1901) — Inferencia bayesiana: el tema de esta clase · DOI `10.48550/arxiv.1206.1901` verificado en DataCite (2026-08-19).
- [Betancourt, M. *A Conceptual Introduction to Hamiltonian Monte Carlo*, 2017](https://arxiv.org/abs/1701.02434) — Inferencia bayesiana: el tema de esta clase · DOI `10.48550/arxiv.1701.02434` verificado en DataCite (2026-08-19).
