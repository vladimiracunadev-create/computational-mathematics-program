...
**Motor:** `computational_math.engines.part17` · demostración `hamiltonian_monte_carlo`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `hamiltonian_monte_carlo` del motor de la parte.
...
- `media_estimada`
- `desviacion_estimada`
- `autocorrelacion_lag_1`
- `tamaño_efectivo_aprox`
- `por_que_leapfrog`
- `ventaja_sobre_random_walk`
- `coste`
- `NUTS`
