# Intuición — Neural ODEs

## La pregunta antes de la fórmula

¿Qué problema resuelve **Neural ODEs**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `neural_odes`: neural ode: capas continuas y el método adjunto.
