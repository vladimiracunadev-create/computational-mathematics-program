# Derivación y razonamiento — Neural ODEs
...
Construye una derivación de 5 a 10 pasos relacionada con **Neural ODEs**.
...
La demostración `neural_odes` recorre este mismo razonamiento en código.
