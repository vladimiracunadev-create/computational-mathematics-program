# Intuición — Estadística descriptiva

## La pregunta antes de la fórmula

¿Qué problema resuelve **Estadística descriptiva**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `descriptive_statistics`: centro, dispersión y forma: tres preguntas distintas.
