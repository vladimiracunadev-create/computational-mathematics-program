# Derivación y razonamiento — Estadística descriptiva
...
Construye una derivación de 5 a 10 pasos relacionada con **Estadística descriptiva**.
...
La demostración `descriptive_statistics` recorre este mismo razonamiento en código.
