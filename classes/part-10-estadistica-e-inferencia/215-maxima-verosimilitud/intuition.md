# Intuición — Máxima verosimilitud

## La pregunta antes de la fórmula

¿Qué problema resuelve **Máxima verosimilitud**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `maximum_likelihood`: mle para la normal: la media muestral maximiza la verosimilitud.
