...
3. Ejecutar y modificar `lab.py`, que corre la demostración `maximum_likelihood` del motor de la parte.
...
- `mu_MLE`
- `sigma_MLE`
- `log_verosimilitud_maxima`
- `barrido_en_mu`
- `el_maximo_esta_en_la_media`
- `sigma_MLE_es_sesgado`
- `conexion_con_ML`
