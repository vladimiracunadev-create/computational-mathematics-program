# Derivación y razonamiento — Máxima verosimilitud
...
Construye una derivación de 5 a 10 pasos relacionada con **Máxima verosimilitud**.
...
La demostración `maximum_likelihood` recorre este mismo razonamiento en código.
