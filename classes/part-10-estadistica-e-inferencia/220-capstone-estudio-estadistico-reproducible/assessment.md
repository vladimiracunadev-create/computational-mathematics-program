# Evaluación — Capstone: estudio estadístico reproducible
...
| Implementación y verificación | 25 % | ejecuta `capstone_reproducible_study`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con experimentación de producto o con IA |
...
5. ¿Dónde aparece este concepto en experimentación de producto?
