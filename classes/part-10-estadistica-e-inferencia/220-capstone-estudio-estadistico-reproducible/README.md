...
**Motor:** `computational_math.engines.part10` · demostración `capstone_reproducible_study`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `capstone_reproducible_study` del motor de la parte.
