# Teoría — Capstone: estudio estadístico reproducible

## Definición operativa

En esta clase, **Capstone: estudio estadístico reproducible** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_reproducible_study`) devuelve 13 valores. Varios de ellos
