# Ejercicios — Capstone: estudio estadístico reproducible

## Básico

1. Define **Capstone: estudio estadístico reproducible** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 13 salidas.
...
7. Conecta esta clase con experimentación de producto, control de calidad, epidemiología y ciencia de datos mediante un caso concreto y realista.
