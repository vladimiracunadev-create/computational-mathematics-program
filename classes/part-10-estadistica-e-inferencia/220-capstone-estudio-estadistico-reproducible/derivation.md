# Derivación y razonamiento — Capstone: estudio estadístico reproducible
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: estudio estadístico reproducible**.
...
La demostración `capstone_reproducible_study` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part10.py` y responde:
