# Intuición — Capstone: estudio estadístico reproducible

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: estudio estadístico reproducible**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Estadística e inferencia**. Descriptiva, muestreo, estimadores, intervalos de confianza, pruebas de hipótesis, p-value, potencia, verosimilitud, MAP, inferencia bayesiana, bootstrap y A/B testing.
...
El laboratorio ejecuta `capstone_reproducible_study`: capstone: estudio completo, reproducible y con límites declarados.
