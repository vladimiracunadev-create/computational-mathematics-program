# Intuición — Estimación MAP

## La pregunta antes de la fórmula

¿Qué problema resuelve **Estimación MAP**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `map_estimation`: map: verosimilitud más prior, y su límite con muchos datos.
