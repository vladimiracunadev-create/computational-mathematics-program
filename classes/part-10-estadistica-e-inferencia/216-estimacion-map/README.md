...
3. Ejecutar y modificar `lab.py`, que corre la demostración `map_estimation` del motor de la parte.
...
- `informe`
- `MAP_converge_al_MLE`
- `el_prior_domina_con_pocos_datos`
- `MAP_con_prior_uniforme_es_MLE`
