# Derivación y razonamiento — Estimación MAP
...
Construye una derivación de 5 a 10 pasos relacionada con **Estimación MAP**.
...
La demostración `map_estimation` recorre este mismo razonamiento en código.
