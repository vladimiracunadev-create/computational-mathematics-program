# Evaluación — Correlación frente a causalidad
...
| Implementación y verificación | 25 % | ejecuta `correlation_causation`, interpreta sus salidas y comprueba al menos un invariante |
