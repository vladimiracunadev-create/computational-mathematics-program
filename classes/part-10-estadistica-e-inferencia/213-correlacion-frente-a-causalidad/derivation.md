# Derivación y razonamiento — Correlación frente a causalidad
...
Construye una derivación de 5 a 10 pasos relacionada con **Correlación frente a causalidad**.
...
La demostración `correlation_causation` recorre este mismo razonamiento en código.
