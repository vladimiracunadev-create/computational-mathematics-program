# Teoría — Correlación frente a causalidad

## Definición operativa

En esta clase, **Correlación frente a causalidad** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`correlation_causation`) devuelve 6 valores. Varios de ellos
