...
- [Pearl, J.; Mackenzie, D. *The Book of Why*, Basic Books, 2018](https://bayes.cs.ucla.edu/WHY/) — Inferencia causal: conexión declarada de esta parte · ISBN-13 `9781543695267` verificado en International ISBN Agency (2026-08-19).
- [Hernán, M.; Robins, J. *Causal Inference: What If*, CRC, 2020](https://miguelhernan.org/whatifbook) — Estadística e inferencia: el tema de esta clase · URL de la fuente primaria comprobada en miguelhernan.org (2026-08-19).
