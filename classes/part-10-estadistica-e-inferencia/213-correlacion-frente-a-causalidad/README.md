...
3. Ejecutar y modificar `lab.py`, que corre la demostración `correlation_causation` del motor de la parte.
...
- `corr(helados, ahogamientos)`
- `corr(temperatura, helados)`
- `corr(temperatura, ahogamientos)`
- `confusor`
- `hay_flecha_causal_helados→ahogamientos`
- `como_se_detecta`
