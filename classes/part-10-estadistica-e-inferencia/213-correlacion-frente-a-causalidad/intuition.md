# Intuición — Correlación frente a causalidad

## La pregunta antes de la fórmula

¿Qué problema resuelve **Correlación frente a causalidad**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `correlation_causation`: una variable de confusión genera correlación sin causalidad.
