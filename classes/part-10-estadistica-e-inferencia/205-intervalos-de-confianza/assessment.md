# Evaluación — Intervalos de confianza
...
| Implementación y verificación | 25 % | ejecuta `confidence_intervals`, interpreta sus salidas y comprueba al menos un invariante |
