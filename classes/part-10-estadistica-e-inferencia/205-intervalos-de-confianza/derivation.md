# Derivación y razonamiento — Intervalos de confianza
...
Construye una derivación de 5 a 10 pasos relacionada con **Intervalos de confianza**.
...
La demostración `confidence_intervals` recorre este mismo razonamiento en código.
