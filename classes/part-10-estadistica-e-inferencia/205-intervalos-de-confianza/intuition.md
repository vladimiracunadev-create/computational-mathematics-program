# Intuición — Intervalos de confianza

## La pregunta antes de la fórmula

¿Qué problema resuelve **Intervalos de confianza**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `confidence_intervals`: un ic 95 % describe el procedimiento, no una probabilidad del parámetro.
