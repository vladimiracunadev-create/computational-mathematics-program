# Teoría — Intervalos de confianza

## Definición operativa

En esta clase, **Intervalos de confianza** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`confidence_intervals`) devuelve 8 valores. Varios de ellos
