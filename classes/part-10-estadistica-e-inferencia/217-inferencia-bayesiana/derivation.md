# Derivación y razonamiento — Inferencia bayesiana
...
Construye una derivación de 5 a 10 pasos relacionada con **Inferencia bayesiana**.
...
La demostración `bayesian_inference` recorre este mismo razonamiento en código.
