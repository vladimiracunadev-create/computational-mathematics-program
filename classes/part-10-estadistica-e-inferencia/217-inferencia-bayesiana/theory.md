# Teoría — Inferencia bayesiana

## Definición operativa

En esta clase, **Inferencia bayesiana** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`bayesian_inference`) devuelve 6 valores. Varios de ellos
