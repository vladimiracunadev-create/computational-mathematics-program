# Derivación y razonamiento — ANOVA
...
Construye una derivación de 5 a 10 pasos relacionada con **ANOVA**.
...
La demostración `anova` recorre este mismo razonamiento en código.
