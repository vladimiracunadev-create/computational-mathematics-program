# Teoría — Pruebas de hipótesis

## Definición operativa

En esta clase, **Pruebas de hipótesis** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`hypothesis_testing`) devuelve 9 valores. Varios de ellos
