# Intuición — Pruebas de hipótesis

## La pregunta antes de la fórmula

¿Qué problema resuelve **Pruebas de hipótesis**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `hypothesis_testing`: estructura completa de una prueba de hipótesis.
