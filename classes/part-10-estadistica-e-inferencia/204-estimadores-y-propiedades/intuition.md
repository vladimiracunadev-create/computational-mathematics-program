# Intuición — Estimadores y propiedades

## La pregunta antes de la fórmula

¿Qué problema resuelve **Estimadores y propiedades**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `estimators`: sesgo, varianza y consistencia de dos estimadores de la varianza.
