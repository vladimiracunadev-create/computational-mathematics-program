# Teoría — Estimadores y propiedades

## Definición operativa

En esta clase, **Estimadores y propiedades** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`estimators`) devuelve 8 valores. Varios de ellos
