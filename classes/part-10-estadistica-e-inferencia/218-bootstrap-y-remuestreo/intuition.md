# Intuición — Bootstrap y remuestreo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Bootstrap y remuestreo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bootstrap`: bootstrap: estimar la variabilidad sin suponer la distribución.
