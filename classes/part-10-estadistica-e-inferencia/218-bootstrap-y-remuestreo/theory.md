# Teoría — Bootstrap y remuestreo

## Definición operativa

En esta clase, **Bootstrap y remuestreo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`bootstrap`) devuelve 8 valores. Varios de ellos
