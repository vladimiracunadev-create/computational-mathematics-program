# Derivación y razonamiento — Bootstrap y remuestreo
...
Construye una derivación de 5 a 10 pasos relacionada con **Bootstrap y remuestreo**.
...
La demostración `bootstrap` recorre este mismo razonamiento en código.
