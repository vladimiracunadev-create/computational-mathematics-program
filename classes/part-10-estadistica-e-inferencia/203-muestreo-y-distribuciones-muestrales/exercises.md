# Ejercicios — Muestreo y distribuciones muestrales

## Básico

1. Define **Muestreo y distribuciones muestrales** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 4 salidas.
