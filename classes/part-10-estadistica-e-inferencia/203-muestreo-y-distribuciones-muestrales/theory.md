# Teoría — Muestreo y distribuciones muestrales

## Definición operativa

En esta clase, **Muestreo y distribuciones muestrales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sampling_distributions`) devuelve 4 valores. Varios de ellos
