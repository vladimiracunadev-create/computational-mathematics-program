# Intuición — Muestreo y distribuciones muestrales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Muestreo y distribuciones muestrales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sampling_distributions`: la distribución de la media muestral y su error estándar.
