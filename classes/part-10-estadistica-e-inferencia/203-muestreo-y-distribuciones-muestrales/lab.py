"""Laboratorio 203 — Muestreo y distribuciones muestrales.

Parte 10 · Estadística e inferencia
Motor: computational_math.engines.part10 · demostración `sampling_distributions`
...
from computational_math.engines import part10 as motor  # noqa: E402

DEMO = "sampling_distributions"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 203 — Muestreo y distribuciones muestrales")
    print(f"Parte 10 · Estadística e inferencia")
