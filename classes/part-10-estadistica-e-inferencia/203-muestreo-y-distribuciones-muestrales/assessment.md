# Evaluación — Muestreo y distribuciones muestrales
...
| Implementación y verificación | 25 % | ejecuta `sampling_distributions`, interpreta sus salidas y comprueba al menos un invariante |
