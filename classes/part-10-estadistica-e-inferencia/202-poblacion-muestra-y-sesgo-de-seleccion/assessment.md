# Evaluación — Población, muestra y sesgo de selección
...
| Implementación y verificación | 25 % | ejecuta `population_sample`, interpreta sus salidas y comprueba al menos un invariante |
