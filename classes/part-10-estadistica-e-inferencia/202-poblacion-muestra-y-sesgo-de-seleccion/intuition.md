# Intuición — Población, muestra y sesgo de selección

## La pregunta antes de la fórmula

¿Qué problema resuelve **Población, muestra y sesgo de selección**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `population_sample`: sesgo de selección: la muestra no representa a la población.
