# Teoría — Población, muestra y sesgo de selección

## Definición operativa

En esta clase, **Población, muestra y sesgo de selección** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`population_sample`) devuelve 7 valores. Varios de ellos
