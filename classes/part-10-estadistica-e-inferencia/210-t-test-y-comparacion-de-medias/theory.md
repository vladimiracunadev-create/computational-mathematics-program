# Teoría — t-test y comparación de medias

## Definición operativa

En esta clase, **t-test y comparación de medias** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`t_test`) devuelve 9 valores. Varios de ellos
