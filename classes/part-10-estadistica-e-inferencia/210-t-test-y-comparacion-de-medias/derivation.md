# Derivación y razonamiento — t-test y comparación de medias
...
Construye una derivación de 5 a 10 pasos relacionada con **t-test y comparación de medias**.
...
La demostración `t_test` recorre este mismo razonamiento en código.
