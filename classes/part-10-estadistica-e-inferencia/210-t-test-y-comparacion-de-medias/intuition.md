# Intuición — t-test y comparación de medias

## La pregunta antes de la fórmula

¿Qué problema resuelve **t-test y comparación de medias**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `t_test`: t-test de dos muestras independientes.
