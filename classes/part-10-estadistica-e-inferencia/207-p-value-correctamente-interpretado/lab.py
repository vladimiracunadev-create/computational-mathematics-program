"""Laboratorio 207 — p-value correctamente interpretado.

Parte 10 · Estadística e inferencia
Motor: computational_math.engines.part10 · demostración `p_value`
...
def main() -> dict:
    ...
    print(f"Clase 207 — p-value correctamente interpretado")
