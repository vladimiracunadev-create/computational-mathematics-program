# Intuición — p-value correctamente interpretado

## La pregunta antes de la fórmula

¿Qué problema resuelve **p-value correctamente interpretado**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `p_value`: qué mide y qué no mide un p-value.
