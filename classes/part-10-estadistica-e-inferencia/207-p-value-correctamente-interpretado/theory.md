# Teoría — p-value correctamente interpretado

## Definición operativa

En esta clase, **p-value correctamente interpretado** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`p_value`) devuelve 8 valores. Varios de ellos
