# Evaluación — p-value correctamente interpretado
...
| Implementación y verificación | 25 % | ejecuta `p_value`, interpreta sus salidas y comprueba al menos un invariante |
