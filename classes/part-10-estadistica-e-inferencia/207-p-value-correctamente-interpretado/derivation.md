# Derivación y razonamiento — p-value correctamente interpretado
...
Construye una derivación de 5 a 10 pasos relacionada con **p-value correctamente interpretado**.
...
La demostración `p_value` recorre este mismo razonamiento en código.
