# Derivación y razonamiento — Potencia estadística
...
Construye una derivación de 5 a 10 pasos relacionada con **Potencia estadística**.
...
La demostración `statistical_power` recorre este mismo razonamiento en código.
