# Intuición — Potencia estadística

## La pregunta antes de la fórmula

¿Qué problema resuelve **Potencia estadística**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `statistical_power`: potencia en función del tamaño muestral.
