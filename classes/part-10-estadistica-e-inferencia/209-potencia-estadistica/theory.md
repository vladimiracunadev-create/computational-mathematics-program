# Teoría — Potencia estadística

## Definición operativa

En esta clase, **Potencia estadística** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`statistical_power`) devuelve 6 valores. Varios de ellos
