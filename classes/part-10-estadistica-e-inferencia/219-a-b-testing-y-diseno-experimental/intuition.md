# Intuición — A/B testing y diseño experimental

## La pregunta antes de la fórmula

¿Qué problema resuelve **A/B testing y diseño experimental**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `ab_testing`: a/b test de proporciones con tamaño muestral y significancia.
