...
**Motor:** `computational_math.engines.part10` · demostración `ab_testing`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `ab_testing` del motor de la parte.
...
- `p_value`
- `significativo_al_5%`
- `n_requerido_para_80%_de_potencia`
- `peligro`
