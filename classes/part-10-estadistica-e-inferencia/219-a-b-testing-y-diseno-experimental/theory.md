# Teoría — A/B testing y diseño experimental

## Definición operativa

En esta clase, **A/B testing y diseño experimental** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`ab_testing`) devuelve 9 valores. Varios de ellos
