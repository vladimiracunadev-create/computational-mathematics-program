# Derivación y razonamiento — A/B testing y diseño experimental
...
Construye una derivación de 5 a 10 pasos relacionada con **A/B testing y diseño experimental**.
...
La demostración `ab_testing` recorre este mismo razonamiento en código.
