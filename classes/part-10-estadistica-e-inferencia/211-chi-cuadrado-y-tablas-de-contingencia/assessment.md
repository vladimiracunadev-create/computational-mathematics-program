# Evaluación — Chi-cuadrado y tablas de contingencia
...
| Implementación y verificación | 25 % | ejecuta `chi_square`, interpreta sus salidas y comprueba al menos un invariante |
