# Derivación y razonamiento — Chi-cuadrado y tablas de contingencia
...
Construye una derivación de 5 a 10 pasos relacionada con **Chi-cuadrado y tablas de contingencia**.
...
La demostración `chi_square` recorre este mismo razonamiento en código.
