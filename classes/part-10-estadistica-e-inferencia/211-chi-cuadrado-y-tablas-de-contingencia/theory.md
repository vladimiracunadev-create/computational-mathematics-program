# Teoría — Chi-cuadrado y tablas de contingencia

## Definición operativa

En esta clase, **Chi-cuadrado y tablas de contingencia** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`chi_square`) devuelve 9 valores. Varios de ellos
