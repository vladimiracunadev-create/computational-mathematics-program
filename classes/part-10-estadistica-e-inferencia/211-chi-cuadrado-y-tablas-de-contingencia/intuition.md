# Intuición — Chi-cuadrado y tablas de contingencia

## La pregunta antes de la fórmula

¿Qué problema resuelve **Chi-cuadrado y tablas de contingencia**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `chi_square`: chi-cuadrado de independencia sobre una tabla de contingencia.
