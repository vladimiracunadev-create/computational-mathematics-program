# Teoría — Errores tipo I y II

## Definición operativa

En esta clase, **Errores tipo I y II** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`type_errors`) devuelve 7 valores. Varios de ellos
