# Intuición — Errores tipo I y II

## La pregunta antes de la fórmula

¿Qué problema resuelve **Errores tipo I y II**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `type_errors`: errores tipo i y ii: el compromiso es inevitable.
