# Derivación y razonamiento — Errores tipo I y II
...
Construye una derivación de 5 a 10 pasos relacionada con **Errores tipo I y II**.
...
La demostración `type_errors` recorre este mismo razonamiento en código.
