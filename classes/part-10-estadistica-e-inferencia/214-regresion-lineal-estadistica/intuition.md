# Intuición — Regresión lineal estadística

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regresión lineal estadística**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_regression_stats`: regresión lineal con r², error estándar y significancia.
