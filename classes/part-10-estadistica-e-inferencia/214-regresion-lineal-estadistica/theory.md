# Teoría — Regresión lineal estadística

## Definición operativa

En esta clase, **Regresión lineal estadística** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_regression_stats`) devuelve 9 valores. Varios de ellos
