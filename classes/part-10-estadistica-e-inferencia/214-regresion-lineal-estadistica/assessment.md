# Evaluación — Regresión lineal estadística
...
| Implementación y verificación | 25 % | ejecuta `linear_regression_stats`, interpreta sus salidas y comprueba al menos un invariante |
