# Evaluación — Reproducibilidad numérica entre plataformas
...
| Implementación y verificación | 25 % | ejecuta `reproducibility`, interpreta sus salidas y comprueba al menos un invariante |
