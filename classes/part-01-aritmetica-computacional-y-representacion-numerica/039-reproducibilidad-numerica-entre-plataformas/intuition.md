# Intuición — Reproducibilidad numérica entre plataformas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Reproducibilidad numérica entre plataformas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `reproducibility`: el orden de la suma cambia el resultado en punto flotante.
