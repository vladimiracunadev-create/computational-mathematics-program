...
- [PyTorch: reproducibilidad](https://pytorch.org/docs/stable/notes/randomness.html) — documentación de la herramienta que ejecuta el laboratorio · URL de la fuente primaria comprobada en PyTorch Foundation (2026-08-19).
