# Teoría — Reproducibilidad numérica entre plataformas

## Definición operativa

En esta clase, **Reproducibilidad numérica entre plataformas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`reproducibility`) devuelve 7 valores. Varios de ellos
