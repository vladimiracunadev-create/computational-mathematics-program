# Ejercicios — Reproducibilidad numérica entre plataformas

## Básico

1. Define **Reproducibilidad numérica entre plataformas** con tus palabras y da un ejemplo válido y uno inválido.
