...
**Motor:** `computational_math.engines.part01` · demostración `absolute_relative_error`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `absolute_relative_error` del motor de la parte.
