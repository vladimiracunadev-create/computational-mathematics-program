# Derivación y razonamiento — Error absoluto y error relativo
...
Construye una derivación de 5 a 10 pasos relacionada con **Error absoluto y error relativo**.
...
La demostración `absolute_relative_error` recorre este mismo razonamiento en código.
