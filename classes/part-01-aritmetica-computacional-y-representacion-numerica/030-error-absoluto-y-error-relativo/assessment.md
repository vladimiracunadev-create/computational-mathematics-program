# Evaluación — Error absoluto y error relativo
...
| Implementación y verificación | 25 % | ejecuta `absolute_relative_error`, interpreta sus salidas y comprueba al menos un invariante |
