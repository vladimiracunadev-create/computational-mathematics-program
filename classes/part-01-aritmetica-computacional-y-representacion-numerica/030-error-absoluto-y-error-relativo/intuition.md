# Intuición — Error absoluto y error relativo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Error absoluto y error relativo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `absolute_relative_error`: el error relativo es el que se propaga; el absoluto engaña con la escala.
