# Teoría — Error absoluto y error relativo

## Definición operativa

En esta clase, **Error absoluto y error relativo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`absolute_relative_error`) devuelve 3 valores. Varios de ellos
