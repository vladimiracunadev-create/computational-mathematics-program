# Derivación y razonamiento — Punto fijo frente a punto flotante
...
Construye una derivación de 5 a 10 pasos relacionada con **Punto fijo frente a punto flotante**.
...
La demostración `fixed_vs_floating` recorre este mismo razonamiento en código.
