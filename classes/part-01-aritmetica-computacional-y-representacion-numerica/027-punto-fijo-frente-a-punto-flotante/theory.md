# Teoría — Punto fijo frente a punto flotante

## Definición operativa

En esta clase, **Punto fijo frente a punto flotante** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`fixed_vs_floating`) devuelve 6 valores. Varios de ellos
