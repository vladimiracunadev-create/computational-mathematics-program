# Intuición — Precisión arbitraria y Decimal

## La pregunta antes de la fórmula

¿Qué problema resuelve **Precisión arbitraria y Decimal**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `arbitrary_precision`: decimal con precisión declarada frente a float.
