# Evaluación — Precisión arbitraria y Decimal
...
| Implementación y verificación | 25 % | ejecuta `arbitrary_precision`, interpreta sus salidas y comprueba al menos un invariante |
