# Teoría — Precisión arbitraria y Decimal

## Definición operativa

En esta clase, **Precisión arbitraria y Decimal** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`arbitrary_precision`) devuelve 6 valores. Varios de ellos
