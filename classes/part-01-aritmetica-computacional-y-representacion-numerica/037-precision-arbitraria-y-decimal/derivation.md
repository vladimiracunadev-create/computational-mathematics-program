# Derivación y razonamiento — Precisión arbitraria y Decimal
...
Construye una derivación de 5 a 10 pasos relacionada con **Precisión arbitraria y Decimal**.
...
La demostración `arbitrary_precision` recorre este mismo razonamiento en código.
