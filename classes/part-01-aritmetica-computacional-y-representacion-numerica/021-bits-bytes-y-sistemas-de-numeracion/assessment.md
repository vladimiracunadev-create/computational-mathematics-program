# Evaluación — Bits, bytes y sistemas de numeración
...
| Implementación y verificación | 25 % | ejecuta `bits_and_bytes`, interpreta sus salidas y comprueba al menos un invariante |
