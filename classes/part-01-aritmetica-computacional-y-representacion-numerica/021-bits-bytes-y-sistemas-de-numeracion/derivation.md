# Derivación y razonamiento — Bits, bytes y sistemas de numeración
...
Construye una derivación de 5 a 10 pasos relacionada con **Bits, bytes y sistemas de numeración**.
...
La demostración `bits_and_bytes` recorre este mismo razonamiento en código.
