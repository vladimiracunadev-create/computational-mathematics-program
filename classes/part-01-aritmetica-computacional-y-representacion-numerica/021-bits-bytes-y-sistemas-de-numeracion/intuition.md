# Intuición — Bits, bytes y sistemas de numeración

## La pregunta antes de la fórmula

¿Qué problema resuelve **Bits, bytes y sistemas de numeración**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bits_and_bytes`: cuántos valores distintos codifica cada ancho de palabra.
