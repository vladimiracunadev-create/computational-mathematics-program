# Intuición — Aritmética binaria

## La pregunta antes de la fórmula

¿Qué problema resuelve **Aritmética binaria**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `binary_arithmetic`: suma y desplazamiento en binario, con acarreo visible.
