# Teoría — Aritmética binaria

## Definición operativa

En esta clase, **Aritmética binaria** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`binary_arithmetic`) devuelve 8 valores. Varios de ellos
