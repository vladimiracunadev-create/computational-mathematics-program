# Derivación y razonamiento — Aritmética binaria
...
Construye una derivación de 5 a 10 pasos relacionada con **Aritmética binaria**.
...
La demostración `binary_arithmetic` recorre este mismo razonamiento en código.
