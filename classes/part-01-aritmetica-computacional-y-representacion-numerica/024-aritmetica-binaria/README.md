...
**Motor:** `computational_math.engines.part01` · demostración `binary_arithmetic`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `binary_arithmetic` del motor de la parte.
