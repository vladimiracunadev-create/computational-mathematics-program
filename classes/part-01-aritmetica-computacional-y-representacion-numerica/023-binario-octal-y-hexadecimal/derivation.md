# Derivación y razonamiento — Binario, octal y hexadecimal
...
Construye una derivación de 5 a 10 pasos relacionada con **Binario, octal y hexadecimal**.
...
La demostración `bases` recorre este mismo razonamiento en código.
