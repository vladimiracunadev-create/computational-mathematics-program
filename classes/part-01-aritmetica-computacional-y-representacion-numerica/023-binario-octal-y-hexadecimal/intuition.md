# Intuición — Binario, octal y hexadecimal

## La pregunta antes de la fórmula

¿Qué problema resuelve **Binario, octal y hexadecimal**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `bases`: la misma cantidad en base 2, 8, 10 y 16.
