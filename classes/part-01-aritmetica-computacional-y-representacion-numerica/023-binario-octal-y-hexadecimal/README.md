...
**Motor:** `computational_math.engines.part01` · demostración `bases`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `bases` del motor de la parte.
...
- `hexadecimal`
- `digitos_binarios`
- `un_hex_equivale_a_bits`
- `un_octal_equivale_a_bits`
