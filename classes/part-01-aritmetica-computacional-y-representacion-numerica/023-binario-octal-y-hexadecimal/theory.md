# Teoría — Binario, octal y hexadecimal

## Definición operativa

En esta clase, **Binario, octal y hexadecimal** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`bases`) devuelve 7 valores. Varios de ellos
