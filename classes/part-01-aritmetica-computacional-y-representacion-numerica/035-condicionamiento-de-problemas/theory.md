# Teoría — Condicionamiento de problemas

## Definición operativa

En esta clase, **Condicionamiento de problemas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`conditioning`) devuelve 4 valores. Varios de ellos
