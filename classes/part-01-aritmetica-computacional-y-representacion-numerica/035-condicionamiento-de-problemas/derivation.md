# Derivación y razonamiento — Condicionamiento de problemas
...
Construye una derivación de 5 a 10 pasos relacionada con **Condicionamiento de problemas**.
...
La demostración `conditioning` recorre este mismo razonamiento en código.
