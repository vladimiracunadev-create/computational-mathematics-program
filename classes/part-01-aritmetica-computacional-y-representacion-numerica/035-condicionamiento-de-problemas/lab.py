"""Laboratorio 035 — Condicionamiento de problemas.

Parte 01 · Aritmética computacional y representación numérica
Motor: computational_math.engines.part01 · demostración `conditioning`
...
def main() -> dict:
    ...
    print(f"Clase 035 — Condicionamiento de problemas")
