# Evaluación — Condicionamiento de problemas
...
| Implementación y verificación | 25 % | ejecuta `conditioning`, interpreta sus salidas y comprueba al menos un invariante |
