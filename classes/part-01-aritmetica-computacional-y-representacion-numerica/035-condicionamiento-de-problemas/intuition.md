# Intuición — Condicionamiento de problemas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Condicionamiento de problemas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `conditioning`: número de condición de una función: sensibilidad del problema.
