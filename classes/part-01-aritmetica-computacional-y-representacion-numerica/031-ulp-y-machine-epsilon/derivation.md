# Derivación y razonamiento — ULP y machine epsilon
...
Construye una derivación de 5 a 10 pasos relacionada con **ULP y machine epsilon**.
...
La demostración `ulp_epsilon` recorre este mismo razonamiento en código.
