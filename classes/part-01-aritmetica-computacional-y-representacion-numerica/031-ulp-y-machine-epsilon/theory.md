# Teoría — ULP y machine epsilon

## Definición operativa

En esta clase, **ULP y machine epsilon** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`ulp_epsilon`) devuelve 8 valores. Varios de ellos
