# Intuición — ULP y machine epsilon

## La pregunta antes de la fórmula

¿Qué problema resuelve **ULP y machine epsilon**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `ulp_epsilon`: machine epsilon y la distancia al float siguiente.
