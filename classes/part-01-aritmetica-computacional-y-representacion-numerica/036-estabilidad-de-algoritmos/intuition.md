# Intuición — Estabilidad de algoritmos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Estabilidad de algoritmos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `stability`: misma raíz cuadrática por dos algoritmos: uno estable, otro no.
