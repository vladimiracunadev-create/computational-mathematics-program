# Teoría — Estabilidad de algoritmos

## Definición operativa

En esta clase, **Estabilidad de algoritmos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`stability`) devuelve 7 valores. Varios de ellos
