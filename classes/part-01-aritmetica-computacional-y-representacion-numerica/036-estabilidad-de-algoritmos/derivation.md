# Derivación y razonamiento — Estabilidad de algoritmos
...
Construye una derivación de 5 a 10 pasos relacionada con **Estabilidad de algoritmos**.
...
La demostración `stability` recorre este mismo razonamiento en código.
