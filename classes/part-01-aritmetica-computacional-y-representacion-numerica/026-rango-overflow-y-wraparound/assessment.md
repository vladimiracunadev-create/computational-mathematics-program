# Evaluación — Rango, overflow y wraparound
...
| Implementación y verificación | 25 % | ejecuta `overflow_wraparound`, interpreta sus salidas y comprueba al menos un invariante |
