# Intuición — Rango, overflow y wraparound

## La pregunta antes de la fórmula

¿Qué problema resuelve **Rango, overflow y wraparound**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `overflow_wraparound`: wraparound en enteros de ancho fijo simulado sobre python.
