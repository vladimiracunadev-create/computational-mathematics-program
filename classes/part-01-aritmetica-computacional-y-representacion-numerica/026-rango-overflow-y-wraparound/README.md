...
**Motor:** `computational_math.engines.part01` · demostración `overflow_wraparound`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `overflow_wraparound` del motor de la parte.
...
- `maximo_int8`
- `maximo+1_con_wraparound`
- `maximo+2_con_wraparound`
- `python_int_es_ilimitado`
- `sys_maxsize`
- `leccion`
