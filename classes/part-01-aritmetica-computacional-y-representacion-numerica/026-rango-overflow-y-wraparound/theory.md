# Teoría — Rango, overflow y wraparound

## Definición operativa

En esta clase, **Rango, overflow y wraparound** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`overflow_wraparound`) devuelve 6 valores. Varios de ellos
