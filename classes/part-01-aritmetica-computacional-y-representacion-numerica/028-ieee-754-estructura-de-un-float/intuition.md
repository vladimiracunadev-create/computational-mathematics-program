# Intuición — IEEE 754: estructura de un float

## La pregunta antes de la fórmula

¿Qué problema resuelve **IEEE 754: estructura de un float**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `ieee754_layout`: signo, exponente y mantisa de un float64.
