# Teoría — IEEE 754: estructura de un float

## Definición operativa

En esta clase, **IEEE 754: estructura de un float** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`ieee754_layout`) devuelve 8 valores. Varios de ellos
