# Derivación y razonamiento — IEEE 754: estructura de un float
...
Construye una derivación de 5 a 10 pasos relacionada con **IEEE 754: estructura de un float**.
...
La demostración `ieee754_layout` recorre este mismo razonamiento en código.
