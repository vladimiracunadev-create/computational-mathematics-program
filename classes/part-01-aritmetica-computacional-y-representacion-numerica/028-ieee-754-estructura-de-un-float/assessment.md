# Evaluación — IEEE 754: estructura de un float
...
| Implementación y verificación | 25 % | ejecuta `ieee754_layout`, interpreta sus salidas y comprueba al menos un invariante |
