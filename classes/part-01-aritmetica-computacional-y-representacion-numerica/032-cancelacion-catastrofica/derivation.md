# Derivación y razonamiento — Cancelación catastrófica
...
Construye una derivación de 5 a 10 pasos relacionada con **Cancelación catastrófica**.
...
La demostración `catastrophic_cancellation` recorre este mismo razonamiento en código.
