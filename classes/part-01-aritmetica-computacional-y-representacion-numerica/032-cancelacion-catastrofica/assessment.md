# Evaluación — Cancelación catastrófica
...
| Implementación y verificación | 25 % | ejecuta `catastrophic_cancellation`, interpreta sus salidas y comprueba al menos un invariante |
