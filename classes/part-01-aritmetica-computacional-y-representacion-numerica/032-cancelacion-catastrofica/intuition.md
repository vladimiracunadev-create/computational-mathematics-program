# Intuición — Cancelación catastrófica

## La pregunta antes de la fórmula

¿Qué problema resuelve **Cancelación catastrófica**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `catastrophic_cancellation`: dos fórmulas algebraicamente iguales con precisión muy distinta.
