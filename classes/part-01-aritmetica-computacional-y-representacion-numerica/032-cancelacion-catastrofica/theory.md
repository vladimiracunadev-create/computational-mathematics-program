# Teoría — Cancelación catastrófica

## Definición operativa

En esta clase, **Cancelación catastrófica** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`catastrophic_cancellation`) devuelve 6 valores. Varios de ellos
