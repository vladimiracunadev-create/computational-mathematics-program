...
**Motor:** `computational_math.engines.part01` · demostración `catastrophic_cancellation`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `catastrophic_cancellation` del motor de la parte.
...
- `x`
- `formula_ingenua_sqrt(x^2+1)-x`
- `formula_estable_1/(sqrt(x^2+1)+x)`
- `diferencia`
- `error_relativo_de_la_ingenua`
- `causa`
