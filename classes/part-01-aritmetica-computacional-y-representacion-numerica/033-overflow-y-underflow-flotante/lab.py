"""Laboratorio 033 — Overflow y underflow flotante.

Parte 01 · Aritmética computacional y representación numérica
Motor: computational_math.engines.part01 · demostración `float_overflow_underflow`
