# Evaluación — Overflow y underflow flotante
...
| Implementación y verificación | 25 % | ejecuta `float_overflow_underflow`, interpreta sus salidas y comprueba al menos un invariante |
