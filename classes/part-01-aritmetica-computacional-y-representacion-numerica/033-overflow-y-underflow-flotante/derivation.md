# Derivación y razonamiento — Overflow y underflow flotante
...
Construye una derivación de 5 a 10 pasos relacionada con **Overflow y underflow flotante**.
...
La demostración `float_overflow_underflow` recorre este mismo razonamiento en código.
