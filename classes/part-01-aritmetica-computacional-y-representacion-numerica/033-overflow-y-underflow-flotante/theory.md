# Teoría — Overflow y underflow flotante

## Definición operativa

En esta clase, **Overflow y underflow flotante** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`float_overflow_underflow`) devuelve 7 valores. Varios de ellos
