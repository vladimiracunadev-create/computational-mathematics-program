# Intuición — Overflow y underflow flotante

## La pregunta antes de la fórmula

¿Qué problema resuelve **Overflow y underflow flotante**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `float_overflow_underflow`: límites del float64 y el paso por subnormales.
