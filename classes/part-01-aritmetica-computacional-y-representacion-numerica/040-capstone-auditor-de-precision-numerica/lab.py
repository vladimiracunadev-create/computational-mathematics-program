"""Laboratorio 040 — Capstone: auditor de precisión numérica.

Parte 01 · Aritmética computacional y representación numérica
Motor: computational_math.engines.part01 · demostración `capstone_precision_auditor`
...
DEMO = "capstone_precision_auditor"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 040 — Capstone: auditor de precisión numérica")
