# Teoría — Capstone: auditor de precisión numérica

## Definición operativa

En esta clase, **Capstone: auditor de precisión numérica** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_precision_auditor`) devuelve 3 valores. Varios de ellos
