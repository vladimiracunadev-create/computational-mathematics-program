# Evaluación — Capstone: auditor de precisión numérica
...
| Implementación y verificación | 25 % | ejecuta `capstone_precision_auditor`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con motores numéricos o con IA |
...
5. ¿Dónde aparece este concepto en motores numéricos?
