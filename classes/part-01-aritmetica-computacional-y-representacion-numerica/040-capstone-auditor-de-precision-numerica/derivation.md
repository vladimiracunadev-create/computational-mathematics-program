# Derivación y razonamiento — Capstone: auditor de precisión numérica
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: auditor de precisión numérica**.
...
La demostración `capstone_precision_auditor` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part01.py` y responde:
