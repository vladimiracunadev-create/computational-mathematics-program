# Intuición — Capstone: auditor de precisión numérica

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: auditor de precisión numérica**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `capstone_precision_auditor`: capstone: auditoría de precisión de una expresión numérica.
