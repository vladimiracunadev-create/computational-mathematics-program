# Ejercicios — Capstone: auditor de precisión numérica

## Básico

1. Define **Capstone: auditor de precisión numérica** con tus palabras y da un ejemplo válido y uno inválido.
