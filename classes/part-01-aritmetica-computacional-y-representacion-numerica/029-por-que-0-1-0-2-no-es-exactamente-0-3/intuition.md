# Intuición — Por qué 0.1 + 0.2 no es exactamente 0.3

## La pregunta antes de la fórmula

¿Qué problema resuelve **Por qué 0.1 + 0.2 no es exactamente 0.3**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `why_point_one`: 0.1 + 0.2 != 0.3 explicado con la fracción binaria real.
