# Derivación y razonamiento — Por qué 0.1 + 0.2 no es exactamente 0.3
...
Construye una derivación de 5 a 10 pasos relacionada con **Por qué 0.1 + 0.2 no es exactamente 0.3**.
...
La demostración `why_point_one` recorre este mismo razonamiento en código.
