# Evaluación — Por qué 0.1 + 0.2 no es exactamente 0.3
...
| Implementación y verificación | 25 % | ejecuta `why_point_one`, interpreta sus salidas y comprueba al menos un invariante |
