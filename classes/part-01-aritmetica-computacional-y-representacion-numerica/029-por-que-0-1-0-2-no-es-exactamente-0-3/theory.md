# Teoría — Por qué 0.1 + 0.2 no es exactamente 0.3

## Definición operativa

En esta clase, **Por qué 0.1 + 0.2 no es exactamente 0.3** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`why_point_one`) devuelve 7 valores. Varios de ellos
