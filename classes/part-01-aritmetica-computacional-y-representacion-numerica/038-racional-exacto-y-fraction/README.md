...
**Motor:** `computational_math.engines.part01` · demostración `exact_rationals`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `exact_rationals` del motor de la parte.
...
- `H_10_exacto`
- `H_10_float`
- `H_10_exacto_como_float`
- `error`
- `denominador`
- `float_desde_fraction`
