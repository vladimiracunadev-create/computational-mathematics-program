# Intuición — Racional exacto y Fraction

## La pregunta antes de la fórmula

¿Qué problema resuelve **Racional exacto y Fraction**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `exact_rationals`: fraction mantiene exactitud donde float ya perdió información.
