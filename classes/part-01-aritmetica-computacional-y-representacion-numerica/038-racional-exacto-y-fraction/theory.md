# Teoría — Racional exacto y Fraction

## Definición operativa

En esta clase, **Racional exacto y Fraction** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`exact_rationals`) devuelve 6 valores. Varios de ellos
