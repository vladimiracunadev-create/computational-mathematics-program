# Derivación y razonamiento — Racional exacto y Fraction
...
Construye una derivación de 5 a 10 pasos relacionada con **Racional exacto y Fraction**.
...
La demostración `exact_rationals` recorre este mismo razonamiento en código.
