# Derivación y razonamiento — Enteros con signo y complemento a dos
...
Construye una derivación de 5 a 10 pasos relacionada con **Enteros con signo y complemento a dos**.
...
La demostración `twos_complement` recorre este mismo razonamiento en código.
