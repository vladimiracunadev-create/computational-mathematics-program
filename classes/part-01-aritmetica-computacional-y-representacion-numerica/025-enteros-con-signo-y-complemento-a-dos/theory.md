# Teoría — Enteros con signo y complemento a dos

## Definición operativa

En esta clase, **Enteros con signo y complemento a dos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`twos_complement`) devuelve 8 valores. Varios de ellos
