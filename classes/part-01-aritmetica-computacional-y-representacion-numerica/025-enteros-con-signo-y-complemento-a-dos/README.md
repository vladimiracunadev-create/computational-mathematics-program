...
**Motor:** `computational_math.engines.part01` · demostración `twos_complement`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `twos_complement` del motor de la parte.
...
- `suma_5_y_-5`
- `decodifica_11111011`
- `minimo_representable`
- `maximo_representable`
- `asimetria`
