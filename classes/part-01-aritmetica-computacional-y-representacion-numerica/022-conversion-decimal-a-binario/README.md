...
Esta clase enseña **Aritmética de máquina · Teoría de números**. Cada obra dice qué aporta aquí y cómo se comprobó su localizador:

- [Python: funciones `bin`, `int` y `format`](https://docs.python.org/3/library/functions.html#bin) — documentación de la herramienta que ejecuta el laboratorio · URL de la fuente primaria comprobada en Python Software Foundation (2026-08-19).
- [Knuth, D. *The Art of Computer Programming*, vol. 2, 3ª ed., 1997, secc. 4.1](https://www-cs-faculty.stanford.edu/~knuth/taocp.html) — Teoría de números: el tema de esta clase · URL de la fuente primaria comprobada en sitio de la obra o de su editorial (2026-08-19).
