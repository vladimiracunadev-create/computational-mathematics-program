# Evaluación — Conversión decimal a binario
...
| Implementación y verificación | 25 % | ejecuta `decimal_to_binary`, interpreta sus salidas y comprueba al menos un invariante |
