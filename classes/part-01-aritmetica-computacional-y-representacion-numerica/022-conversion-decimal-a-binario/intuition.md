# Intuición — Conversión decimal a binario

## La pregunta antes de la fórmula

¿Qué problema resuelve **Conversión decimal a binario**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `decimal_to_binary`: divisiones sucesivas frente a la conversión de la biblioteca.
