# Teoría — Conversión decimal a binario

## Definición operativa

En esta clase, **Conversión decimal a binario** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`decimal_to_binary`) devuelve 6 valores. Varios de ellos
