# Derivación y razonamiento — Propagación de errores
...
Construye una derivación de 5 a 10 pasos relacionada con **Propagación de errores**.
...
La demostración `error_propagation` recorre este mismo razonamiento en código.
