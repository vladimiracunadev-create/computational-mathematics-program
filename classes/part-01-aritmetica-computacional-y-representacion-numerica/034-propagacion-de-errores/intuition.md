# Intuición — Propagación de errores

## La pregunta antes de la fórmula

¿Qué problema resuelve **Propagación de errores**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `error_propagation`: cómo crece el error al sumar 10^6 veces un valor no representable.
