# Teoría — Propagación de errores

## Definición operativa

En esta clase, **Propagación de errores** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`error_propagation`) devuelve 7 valores. Varios de ellos
