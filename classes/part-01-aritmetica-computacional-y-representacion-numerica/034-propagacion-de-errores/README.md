...
- [Kahan, W. *Further remarks on reducing truncation errors*. CACM, 1965](https://dl.acm.org/doi/10.1145/363707.363723) — Aritmética de máquina y Métodos numéricos: el tema de esta clase · DOI `10.1145/363707.363723` verificado en Crossref (2026-08-19).
- [Python: `math.fsum`](https://docs.python.org/3/library/math.html#math.fsum) — documentación de la herramienta que ejecuta el laboratorio · URL de la fuente primaria comprobada en Python Software Foundation (2026-08-19).
