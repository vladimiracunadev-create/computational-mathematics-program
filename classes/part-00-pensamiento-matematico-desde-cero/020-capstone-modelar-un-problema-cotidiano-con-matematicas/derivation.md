# Derivación y razonamiento — Capstone: modelar un problema cotidiano con matemáticas
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: modelar un problema cotidiano con matemáticas**.
...
La demostración `capstone_budget_model` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part00.py` y responde:
