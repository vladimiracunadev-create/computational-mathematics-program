"""Laboratorio 020 — Capstone: modelar un problema cotidiano con matemáticas.
...
DEMO = "capstone_budget_model"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 020 — Capstone: modelar un problema cotidiano con matemáticas")
