# Teoría — Capstone: modelar un problema cotidiano con matemáticas

## Definición operativa

En esta clase, **Capstone: modelar un problema cotidiano con matemáticas** se trata como un objeto con tres capas
separadas:
...
## Ideas centrales de la parte 00
...
ningún paso quede oculto. En la práctica profesional se usa: math, fractions, decimal.
...
El laboratorio (`capstone_budget_model`) devuelve 6 valores. Varios de ellos
