# Ejercicios — Capstone: modelar un problema cotidiano con matemáticas

## Básico

1. Define **Capstone: modelar un problema cotidiano con matemáticas** con tus palabras y da un ejemplo válido y uno inválido.
