# Evaluación — Capstone: modelar un problema cotidiano con matemáticas
...
| Implementación y verificación | 25 % | ejecuta `capstone_budget_model`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con cálculo cotidiano o con IA |
...
5. ¿Dónde aparece este concepto en cálculo cotidiano?
