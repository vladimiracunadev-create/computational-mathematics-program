# Teoría — Decimales y conversiones

## Definición operativa

En esta clase, **Decimales y conversiones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`decimal_conversion`) devuelve 6 valores. Varios de ellos
