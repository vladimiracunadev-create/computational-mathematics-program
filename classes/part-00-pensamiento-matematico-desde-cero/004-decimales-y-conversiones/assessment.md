# Evaluación — Decimales y conversiones
...
| Implementación y verificación | 25 % | ejecuta `decimal_conversion`, interpreta sus salidas y comprueba al menos un invariante |
