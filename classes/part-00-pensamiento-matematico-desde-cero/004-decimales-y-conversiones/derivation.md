# Derivación y razonamiento — Decimales y conversiones
...
Construye una derivación de 5 a 10 pasos relacionada con **Decimales y conversiones**.
...
La demostración `decimal_conversion` recorre este mismo razonamiento en código.
