# Derivación y razonamiento — Notación científica
...
Construye una derivación de 5 a 10 pasos relacionada con **Notación científica**.
...
La demostración `scientific_notation` recorre este mismo razonamiento en código.
