# Intuición — Notación científica

## La pregunta antes de la fórmula

¿Qué problema resuelve **Notación científica**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `scientific_notation`: mantisa, exponente y orden de magnitud.
