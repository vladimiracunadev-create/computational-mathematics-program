...
Esta clase concreta ese objetivo sobre **Notación científica**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `scientific_notation` del motor de la parte.
