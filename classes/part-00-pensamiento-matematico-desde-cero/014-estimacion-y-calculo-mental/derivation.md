# Derivación y razonamiento — Estimación y cálculo mental
...
Construye una derivación de 5 a 10 pasos relacionada con **Estimación y cálculo mental**.
...
La demostración `estimation` recorre este mismo razonamiento en código.
