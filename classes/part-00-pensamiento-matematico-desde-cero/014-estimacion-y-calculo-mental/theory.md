# Teoría — Estimación y cálculo mental

## Definición operativa

En esta clase, **Estimación y cálculo mental** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`estimation`) devuelve 5 valores. Varios de ellos
