"""Laboratorio 014 — Estimación y cálculo mental.

Parte 00 · Pensamiento matemático desde cero
Motor: computational_math.engines.part00 · demostración `estimation`
...
def main() -> dict:
    ...
    print(f"Clase 014 — Estimación y cálculo mental")
