# Intuición — Estimación y cálculo mental

## La pregunta antes de la fórmula

¿Qué problema resuelve **Estimación y cálculo mental**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `estimation`: estimación por orden de magnitud contra el cálculo exacto.
