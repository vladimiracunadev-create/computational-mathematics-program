...
Esta clase concreta ese objetivo sobre **Estimación y cálculo mental**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `estimation` del motor de la parte.
