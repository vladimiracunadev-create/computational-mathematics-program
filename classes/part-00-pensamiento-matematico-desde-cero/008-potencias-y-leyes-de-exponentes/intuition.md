# Intuición — Potencias y leyes de exponentes

## La pregunta antes de la fórmula

¿Qué problema resuelve **Potencias y leyes de exponentes**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `exponent_laws`: leyes de exponentes verificadas numéricamente.
