# Teoría — Potencias y leyes de exponentes

## Definición operativa

En esta clase, **Potencias y leyes de exponentes** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`exponent_laws`) devuelve 8 valores. Varios de ellos
