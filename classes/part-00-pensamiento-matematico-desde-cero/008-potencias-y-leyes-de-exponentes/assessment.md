# Evaluación — Potencias y leyes de exponentes
...
| Implementación y verificación | 25 % | ejecuta `exponent_laws`, interpreta sus salidas y comprueba al menos un invariante |
