# Derivación y razonamiento — Potencias y leyes de exponentes
...
Construye una derivación de 5 a 10 pasos relacionada con **Potencias y leyes de exponentes**.
...
La demostración `exponent_laws` recorre este mismo razonamiento en código.
