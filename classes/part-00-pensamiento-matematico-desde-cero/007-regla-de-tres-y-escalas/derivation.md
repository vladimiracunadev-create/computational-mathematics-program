# Derivación y razonamiento — Regla de tres y escalas
...
Construye una derivación de 5 a 10 pasos relacionada con **Regla de tres y escalas**.
...
La demostración `rule_of_three` recorre este mismo razonamiento en código.
