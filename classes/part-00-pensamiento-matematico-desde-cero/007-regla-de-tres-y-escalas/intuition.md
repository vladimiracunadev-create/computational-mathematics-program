# Intuición — Regla de tres y escalas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regla de tres y escalas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `rule_of_three`: proporcionalidad directa e inversa comparadas sobre el mismo dato.
