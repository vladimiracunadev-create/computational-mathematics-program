# Teoría — Regla de tres y escalas

## Definición operativa

En esta clase, **Regla de tres y escalas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`rule_of_three`) devuelve 5 valores. Varios de ellos
