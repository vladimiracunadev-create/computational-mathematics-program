# Intuición — Orden de operaciones y paréntesis

## La pregunta antes de la fórmula

¿Qué problema resuelve **Orden de operaciones y paréntesis**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `operator_precedence`: precedencia y asociatividad: dos lecturas de la misma cadena.
