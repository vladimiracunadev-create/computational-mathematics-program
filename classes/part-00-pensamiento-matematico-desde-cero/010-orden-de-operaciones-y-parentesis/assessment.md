# Evaluación — Orden de operaciones y paréntesis
...
| Implementación y verificación | 25 % | ejecuta `operator_precedence`, interpreta sus salidas y comprueba al menos un invariante |
