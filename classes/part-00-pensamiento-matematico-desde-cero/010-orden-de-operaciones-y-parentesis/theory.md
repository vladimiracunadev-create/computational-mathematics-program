# Teoría — Orden de operaciones y paréntesis

## Definición operativa

En esta clase, **Orden de operaciones y paréntesis** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`operator_precedence`) devuelve 6 valores. Varios de ellos
