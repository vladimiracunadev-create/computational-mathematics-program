# Evaluación — Aproximación, redondeo y cifras significativas
...
| Implementación y verificación | 25 % | ejecuta `rounding`, interpreta sus salidas y comprueba al menos un invariante |
