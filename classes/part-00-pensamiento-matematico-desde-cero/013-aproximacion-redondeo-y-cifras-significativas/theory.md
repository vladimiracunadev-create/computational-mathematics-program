# Teoría — Aproximación, redondeo y cifras significativas

## Definición operativa

En esta clase, **Aproximación, redondeo y cifras significativas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`rounding`) devuelve 6 valores. Varios de ellos
