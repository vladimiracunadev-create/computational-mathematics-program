# Intuición — Aproximación, redondeo y cifras significativas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Aproximación, redondeo y cifras significativas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `rounding`: redondeo bancario frente a redondeo aritmético.
