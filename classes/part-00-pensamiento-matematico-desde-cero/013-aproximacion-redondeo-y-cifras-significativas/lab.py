"""Laboratorio 013 — Aproximación, redondeo y cifras significativas.

Parte 00 · Pensamiento matemático desde cero
Motor: computational_math.engines.part00 · demostración `rounding`
...
def main() -> dict:
    ...
    print(f"Clase 013 — Aproximación, redondeo y cifras significativas")
