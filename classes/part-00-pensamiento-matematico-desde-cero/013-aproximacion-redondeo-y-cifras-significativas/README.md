...
Esta clase concreta ese objetivo sobre **Aproximación, redondeo y cifras significativas**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `rounding` del motor de la parte.
