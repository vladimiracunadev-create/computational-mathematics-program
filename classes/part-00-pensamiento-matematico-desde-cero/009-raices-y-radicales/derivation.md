# Derivación y razonamiento — Raíces y radicales
...
Construye una derivación de 5 a 10 pasos relacionada con **Raíces y radicales**.
...
La demostración `radicals` recorre este mismo razonamiento en código.
