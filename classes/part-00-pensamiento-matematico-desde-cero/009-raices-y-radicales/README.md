...
- [Python: `math.isqrt` y aritmética de raíces](https://docs.python.org/3/library/math.html#math.isqrt) — *uso:* documentación de la herramienta que ejecuta el laboratorio en «Raíces y radicales».
- [Lang, S. *Basic Mathematics*. Springer, 1988](https://link.springer.com/book/10.1007/978-1-4757-1836-2) — *uso:* desarrollo formal del tema en «Raíces y radicales».
