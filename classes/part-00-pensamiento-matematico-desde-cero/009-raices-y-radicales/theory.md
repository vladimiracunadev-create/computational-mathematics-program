# Teoría — Raíces y radicales

## Definición operativa

En esta clase, **Raíces y radicales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`radicals`) devuelve 7 valores. Varios de ellos
