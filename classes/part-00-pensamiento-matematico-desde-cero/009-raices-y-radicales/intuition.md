# Intuición — Raíces y radicales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Raíces y radicales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `radicals`: raíces como exponentes fraccionarios y su dominio real.
