# Evaluación — Fracciones y números racionales
...
| Implementación y verificación | 25 % | ejecuta `rational_arithmetic`, interpreta sus salidas y comprueba al menos un invariante |
