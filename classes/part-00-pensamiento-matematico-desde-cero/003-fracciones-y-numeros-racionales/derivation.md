# Derivación y razonamiento — Fracciones y números racionales
...
Construye una derivación de 5 a 10 pasos relacionada con **Fracciones y números racionales**.
...
La demostración `rational_arithmetic` recorre este mismo razonamiento en código.
