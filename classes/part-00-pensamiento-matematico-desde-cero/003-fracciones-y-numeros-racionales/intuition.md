# Intuición — Fracciones y números racionales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Fracciones y números racionales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `rational_arithmetic`: un tercio exacto frente a un tercio en punto flotante.
