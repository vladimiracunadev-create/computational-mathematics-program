...
- [OEIS — Enciclopedia en línea de secuencias de enteros](https://oeis.org/) — Teoría de números: el tema de esta clase · URL de la fuente primaria comprobada en OEIS Foundation (2026-08-19).
- [Graham, Knuth & Patashnik. *Concrete Mathematics*, 2ª ed., 1994](https://www-cs-faculty.stanford.edu/~knuth/gkp.html) — Algoritmos y complejidad y Matemática discreta: conexión declarada de esta parte · ISBN-13 `9788131708415` verificado en International ISBN Agency (2026-08-19).
