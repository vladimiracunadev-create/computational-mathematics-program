# Evaluación — Patrones, secuencias y regularidades
...
| Implementación y verificación | 25 % | ejecuta `sequences`, interpreta sus salidas y comprueba al menos un invariante |
