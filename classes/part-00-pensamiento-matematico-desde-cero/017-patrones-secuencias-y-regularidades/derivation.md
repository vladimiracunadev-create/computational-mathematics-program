# Derivación y razonamiento — Patrones, secuencias y regularidades
...
Construye una derivación de 5 a 10 pasos relacionada con **Patrones, secuencias y regularidades**.
...
La demostración `sequences` recorre este mismo razonamiento en código.
