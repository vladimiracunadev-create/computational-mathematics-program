# Intuición — Patrones, secuencias y regularidades

## La pregunta antes de la fórmula

¿Qué problema resuelve **Patrones, secuencias y regularidades**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sequences`: detectar la regla de una secuencia y extrapolarla con cuidado.
