# Teoría — Patrones, secuencias y regularidades

## Definición operativa

En esta clase, **Patrones, secuencias y regularidades** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sequences`) devuelve 8 valores. Varios de ellos
