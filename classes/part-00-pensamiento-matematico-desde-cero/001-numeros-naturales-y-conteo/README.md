...
- [Lang, S. *Basic Mathematics*. Springer, 1988, cap. 1](https://openlibrary.org/isbn/9780387967875) — Álgebra y funciones y Fundamentos y lenguaje matemático: el tema de esta clase · ISBN-13 `9780387967875` verificado en International ISBN Agency (2026-08-20).
- [Graham, Knuth & Patashnik. *Concrete Mathematics*, 2ª ed., 1994, cap. 2 (sumas)](https://www-cs-faculty.stanford.edu/~knuth/gkp.html) — Algoritmos y complejidad y Matemática discreta: conexión declarada de esta parte · ISBN-13 `9788131708415` verificado en International ISBN Agency (2026-08-19).
- [Peano axioms — Encyclopedia of Mathematics](https://encyclopediaofmath.org/wiki/Peano_axioms) — Fundamentos y lenguaje matemático y Lógica y demostración: el tema de esta clase · URL de la fuente primaria comprobada en European Mathematical Society (2026-08-19).
