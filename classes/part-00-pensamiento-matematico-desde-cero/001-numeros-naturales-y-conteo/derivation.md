# Derivación y razonamiento — Números naturales y conteo
...
Construye una derivación de 5 a 10 pasos relacionada con **Números naturales y conteo**.
...
La demostración `counting` recorre este mismo razonamiento en código.
