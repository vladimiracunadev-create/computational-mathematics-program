# Intuición — Números naturales y conteo

## La pregunta antes de la fórmula

¿Qué problema resuelve **Números naturales y conteo**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `counting`: conteo, suma de gauss y verificación cerrada frente a iterativa.
