# Teoría — Números naturales y conteo

## Definición operativa

En esta clase, **Números naturales y conteo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`counting`) devuelve 6 valores. Varios de ellos
