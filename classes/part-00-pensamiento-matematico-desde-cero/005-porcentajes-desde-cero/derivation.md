# Derivación y razonamiento — Porcentajes desde cero
...
Construye una derivación de 5 a 10 pasos relacionada con **Porcentajes desde cero**.
...
La demostración `percentage` recorre este mismo razonamiento en código.
