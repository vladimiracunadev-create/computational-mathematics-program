# Intuición — Porcentajes desde cero

## La pregunta antes de la fórmula

¿Qué problema resuelve **Porcentajes desde cero**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `percentage`: aumento y descuento sucesivos: el orden no cambia, la reversión sí.
