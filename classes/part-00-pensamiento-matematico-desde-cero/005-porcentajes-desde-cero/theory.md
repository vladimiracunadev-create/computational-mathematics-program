# Teoría — Porcentajes desde cero

## Definición operativa

En esta clase, **Porcentajes desde cero** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`percentage`) devuelve 6 valores. Varios de ellos
