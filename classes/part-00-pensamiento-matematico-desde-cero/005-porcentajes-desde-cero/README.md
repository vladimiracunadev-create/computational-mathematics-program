...
Esta clase concreta ese objetivo sobre **Porcentajes desde cero**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `percentage` del motor de la parte.
