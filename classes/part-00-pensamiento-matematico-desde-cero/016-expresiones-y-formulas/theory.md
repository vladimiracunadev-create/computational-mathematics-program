# Teoría — Expresiones y fórmulas

## Definición operativa

En esta clase, **Expresiones y fórmulas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`formula_evaluation`) devuelve 6 valores. Varios de ellos
