...
Esta clase concreta ese objetivo sobre **Expresiones y fórmulas**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `formula_evaluation` del motor de la parte.
