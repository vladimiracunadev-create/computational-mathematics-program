# Intuición — Expresiones y fórmulas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Expresiones y fórmulas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `formula_evaluation`: una fórmula evaluada con dominio y unidades declaradas.
