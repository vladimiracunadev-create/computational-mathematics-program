# Evaluación — Expresiones y fórmulas
...
| Implementación y verificación | 25 % | ejecuta `formula_evaluation`, interpreta sus salidas y comprueba al menos un invariante |
