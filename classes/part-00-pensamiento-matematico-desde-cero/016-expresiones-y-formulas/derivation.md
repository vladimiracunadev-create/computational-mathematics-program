# Derivación y razonamiento — Expresiones y fórmulas
...
Construye una derivación de 5 a 10 pasos relacionada con **Expresiones y fórmulas**.
...
La demostración `formula_evaluation` recorre este mismo razonamiento en código.
