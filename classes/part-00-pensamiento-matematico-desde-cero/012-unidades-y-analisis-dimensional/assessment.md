# Evaluación — Unidades y análisis dimensional
...
| Implementación y verificación | 25 % | ejecuta `dimensional_analysis`, interpreta sus salidas y comprueba al menos un invariante |
