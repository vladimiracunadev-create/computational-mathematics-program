# Derivación y razonamiento — Unidades y análisis dimensional
...
Construye una derivación de 5 a 10 pasos relacionada con **Unidades y análisis dimensional**.
...
La demostración `dimensional_analysis` recorre este mismo razonamiento en código.
