"""Laboratorio 012 — Unidades y análisis dimensional.

Parte 00 · Pensamiento matemático desde cero
Motor: computational_math.engines.part00 · demostración `dimensional_analysis`
...
from computational_math.engines import part00 as motor  # noqa: E402

DEMO = "dimensional_analysis"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 012 — Unidades y análisis dimensional")
    print(f"Parte 00 · Pensamiento matemático desde cero")
