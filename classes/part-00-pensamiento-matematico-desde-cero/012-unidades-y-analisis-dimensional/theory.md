# Teoría — Unidades y análisis dimensional

## Definición operativa

En esta clase, **Unidades y análisis dimensional** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`dimensional_analysis`) devuelve 6 valores. Varios de ellos
