# Intuición — Unidades y análisis dimensional

## La pregunta antes de la fórmula

¿Qué problema resuelve **Unidades y análisis dimensional**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `dimensional_analysis`: conversión de unidades como multiplicación por factores unitarios.
