...
Esta clase concreta ese objetivo sobre **Unidades y análisis dimensional**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `dimensional_analysis` del motor de la parte.
