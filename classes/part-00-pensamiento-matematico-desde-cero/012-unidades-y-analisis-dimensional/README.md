...
- [BIPM. *The International System of Units (SI)*, 9ª ed., 2019](https://www.bipm.org/en/publications/si-brochure) — Fundamentos y lenguaje matemático: el tema de esta clase · URL de la fuente primaria comprobada en Bureau International des Poids et Mesures (2026-08-19).
- [NASA. *Mars Climate Orbiter Mishap Investigation Board Report*, 1999](https://llis.nasa.gov/llis_lib/pdf/1009464main1_0641-mr.pdf) — Fundamentos y lenguaje matemático: el tema de esta clase · URL de la fuente primaria comprobada en llis.nasa.gov (2026-08-19).
