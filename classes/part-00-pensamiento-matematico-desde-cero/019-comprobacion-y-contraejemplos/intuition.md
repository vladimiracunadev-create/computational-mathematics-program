# Intuición — Comprobación y contraejemplos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Comprobación y contraejemplos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `counterexample`: una conjetura plausible destruida por un único contraejemplo.
