# Derivación y razonamiento — Comprobación y contraejemplos
...
Construye una derivación de 5 a 10 pasos relacionada con **Comprobación y contraejemplos**.
...
La demostración `counterexample` recorre este mismo razonamiento en código.
