# Teoría — Comprobación y contraejemplos

## Definición operativa

En esta clase, **Comprobación y contraejemplos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`counterexample`) devuelve 6 valores. Varios de ellos
