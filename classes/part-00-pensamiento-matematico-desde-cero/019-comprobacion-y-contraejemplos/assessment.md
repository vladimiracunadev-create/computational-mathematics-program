# Evaluación — Comprobación y contraejemplos
...
| Implementación y verificación | 25 % | ejecuta `counterexample`, interpreta sus salidas y comprueba al menos un invariante |
