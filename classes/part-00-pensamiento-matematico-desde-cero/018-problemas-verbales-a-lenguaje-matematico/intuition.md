# Intuición — Problemas verbales a lenguaje matemático

## La pregunta antes de la fórmula

¿Qué problema resuelve **Problemas verbales a lenguaje matemático**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `word_problem`: traducir un enunciado a ecuaciones y resolverlo.
