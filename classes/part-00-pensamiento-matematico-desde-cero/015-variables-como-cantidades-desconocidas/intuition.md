# Intuición — Variables como cantidades desconocidas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Variables como cantidades desconocidas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `variables`: una incógnita convierte una pregunta en una ecuación resoluble.
