# Ejercicios — Variables como cantidades desconocidas

## Básico

1. Define **Variables como cantidades desconocidas** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 5 salidas.
...
7. Conecta esta clase con cálculo cotidiano, presupuestos, lectura de fórmulas y validación de entradas en software mediante un caso concreto y realista.
