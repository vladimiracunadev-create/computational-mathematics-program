# Teoría — Variables como cantidades desconocidas

## Definición operativa

En esta clase, **Variables como cantidades desconocidas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`variables`) devuelve 5 valores. Varios de ellos
