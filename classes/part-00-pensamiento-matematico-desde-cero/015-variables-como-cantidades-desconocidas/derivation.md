# Derivación y razonamiento — Variables como cantidades desconocidas
...
Construye una derivación de 5 a 10 pasos relacionada con **Variables como cantidades desconocidas**.
...
La demostración `variables` recorre este mismo razonamiento en código.
