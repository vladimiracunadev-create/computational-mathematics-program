"""Laboratorio 015 — Variables como cantidades desconocidas.

Parte 00 · Pensamiento matemático desde cero
Motor: computational_math.engines.part00 · demostración `variables`
...
def main() -> dict:
    ...
    print(f"Clase 015 — Variables como cantidades desconocidas")
