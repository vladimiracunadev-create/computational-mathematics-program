# Evaluación — Variables como cantidades desconocidas
...
| Implementación y verificación | 25 % | ejecuta `variables`, interpreta sus salidas y comprueba al menos un invariante |
