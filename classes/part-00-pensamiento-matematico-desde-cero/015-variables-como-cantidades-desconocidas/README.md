...
Esta clase concreta ese objetivo sobre **Variables como cantidades desconocidas**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `variables` del motor de la parte.
