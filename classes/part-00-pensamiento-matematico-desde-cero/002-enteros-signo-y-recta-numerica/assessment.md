# Evaluación — Enteros, signo y recta numérica
...
| Implementación y verificación | 25 % | ejecuta `integers_number_line`, interpreta sus salidas y comprueba al menos un invariante |
