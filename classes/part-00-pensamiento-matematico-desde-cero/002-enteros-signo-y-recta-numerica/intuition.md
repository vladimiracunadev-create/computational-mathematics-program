# Intuición — Enteros, signo y recta numérica

## La pregunta antes de la fórmula

¿Qué problema resuelve **Enteros, signo y recta numérica**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `integers_number_line`: signo, valor absoluto y distancia en la recta numérica.
