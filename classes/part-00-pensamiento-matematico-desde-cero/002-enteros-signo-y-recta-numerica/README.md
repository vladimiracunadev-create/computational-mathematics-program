...
- [Gelfand & Shen. *Algebra*. Birkhäuser, 2002, secc. 1](https://link.springer.com/book/10.1007/978-1-4612-0335-5) — Álgebra y funciones: el tema de esta clase · DOI `10.1007/978-1-4612-0335-5`, pendiente de resolver.
- [Lang, S. *Basic Mathematics*. Springer, 1988, cap. 2](https://openlibrary.org/isbn/9780387967875) — Álgebra y funciones y Fundamentos y lenguaje matemático: el tema de esta clase · ISBN-13 `9780387967875` verificado en International ISBN Agency (2026-08-20).
