...
Esta clase concreta ese objetivo sobre **Enteros, signo y recta numérica**: qué es, cómo se
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `integers_number_line` del motor de la parte.
