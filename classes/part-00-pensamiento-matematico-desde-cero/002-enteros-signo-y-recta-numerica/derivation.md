# Derivación y razonamiento — Enteros, signo y recta numérica
...
Construye una derivación de 5 a 10 pasos relacionada con **Enteros, signo y recta numérica**.
...
La demostración `integers_number_line` recorre este mismo razonamiento en código.
