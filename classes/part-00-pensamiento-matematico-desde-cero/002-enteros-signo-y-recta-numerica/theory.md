# Teoría — Enteros, signo y recta numérica

## Definición operativa

En esta clase, **Enteros, signo y recta numérica** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`integers_number_line`) devuelve 7 valores. Varios de ellos
