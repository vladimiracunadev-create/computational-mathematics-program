# Derivación y razonamiento — Razones, tasas y proporciones
...
Construye una derivación de 5 a 10 pasos relacionada con **Razones, tasas y proporciones**.
...
La demostración `ratios` recorre este mismo razonamiento en código.
