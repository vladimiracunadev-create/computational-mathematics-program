# Intuición — Razones, tasas y proporciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **Razones, tasas y proporciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `ratios`: razón, tasa y proporción con unidades explícitas.
