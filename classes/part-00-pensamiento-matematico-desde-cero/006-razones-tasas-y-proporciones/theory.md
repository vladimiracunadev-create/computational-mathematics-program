# Teoría — Razones, tasas y proporciones

## Definición operativa

En esta clase, **Razones, tasas y proporciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`ratios`) devuelve 6 valores. Varios de ellos
