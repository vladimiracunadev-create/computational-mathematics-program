# Derivación y razonamiento — Optimización sin restricciones
...
Construye una derivación de 5 a 10 pasos relacionada con **Optimización sin restricciones**.
...
La demostración `unconstrained_optimization` recorre este mismo razonamiento en código.
