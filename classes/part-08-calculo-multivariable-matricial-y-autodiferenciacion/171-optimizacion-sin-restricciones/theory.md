# Teoría — Optimización sin restricciones

## Definición operativa

En esta clase, **Optimización sin restricciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`unconstrained_optimization`) devuelve 7 valores. Varios de ellos
