# Evaluación — Optimización sin restricciones
...
| Implementación y verificación | 25 % | ejecuta `unconstrained_optimization`, interpreta sus salidas y comprueba al menos un invariante |
