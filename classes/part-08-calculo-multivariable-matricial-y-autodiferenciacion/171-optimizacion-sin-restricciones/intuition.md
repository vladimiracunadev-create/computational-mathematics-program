# Intuición — Optimización sin restricciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **Optimización sin restricciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `unconstrained_optimization`: descenso de gradiente sobre una cuadrática con historial.
