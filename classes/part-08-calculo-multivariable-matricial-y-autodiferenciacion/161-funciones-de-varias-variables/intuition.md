# Intuición — Funciones de varias variables

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones de varias variables**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `multivariable_functions`: una función de dos variables evaluada sobre una malla.
