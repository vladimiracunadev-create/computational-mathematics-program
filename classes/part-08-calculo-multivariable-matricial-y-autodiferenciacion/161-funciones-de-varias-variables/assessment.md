# Evaluación — Funciones de varias variables
...
| Implementación y verificación | 25 % | ejecuta `multivariable_functions`, interpreta sus salidas y comprueba al menos un invariante |
