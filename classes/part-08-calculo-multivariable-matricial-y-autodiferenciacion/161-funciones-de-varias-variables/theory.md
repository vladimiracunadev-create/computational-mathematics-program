...
En esta clase, **Funciones de varias variables** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`multivariable_functions`) devuelve 6 valores. Varios de ellos
