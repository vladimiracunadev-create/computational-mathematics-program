# Evaluación — Multiplicadores de Lagrange
...
| Implementación y verificación | 25 % | ejecuta `lagrange_multipliers`, interpreta sus salidas y comprueba al menos un invariante |
