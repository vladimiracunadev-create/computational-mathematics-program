# Teoría — Multiplicadores de Lagrange

## Definición operativa

En esta clase, **Multiplicadores de Lagrange** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`lagrange_multipliers`) devuelve 8 valores. Varios de ellos
