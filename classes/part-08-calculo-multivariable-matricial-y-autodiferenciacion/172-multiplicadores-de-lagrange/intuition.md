# Intuición — Multiplicadores de Lagrange

## La pregunta antes de la fórmula

¿Qué problema resuelve **Multiplicadores de Lagrange**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `lagrange_multipliers`: maximizar xy sujeto a x+y=10 con multiplicadores de lagrange.
