# Teoría — Plano tangente

## Definición operativa

En esta clase, **Plano tangente** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`tangent_plane`) devuelve 7 valores. Varios de ellos
