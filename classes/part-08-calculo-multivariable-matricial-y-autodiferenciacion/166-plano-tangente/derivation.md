# Derivación y razonamiento — Plano tangente
...
Construye una derivación de 5 a 10 pasos relacionada con **Plano tangente**.
...
La demostración `tangent_plane` recorre este mismo razonamiento en código.
