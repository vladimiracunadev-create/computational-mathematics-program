# Intuición — Plano tangente

## La pregunta antes de la fórmula

¿Qué problema resuelve **Plano tangente**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `tangent_plane`: plano tangente: la aproximación lineal en dos variables.
