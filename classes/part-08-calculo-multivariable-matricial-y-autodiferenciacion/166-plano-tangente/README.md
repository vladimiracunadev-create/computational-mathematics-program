...
**Motor:** `computational_math.engines.part08` · demostración `tangent_plane`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `tangent_plane` del motor de la parte.
...
- `error_cerca`
- `error_lejos`
- `el_error_crece_cuadraticamente`
