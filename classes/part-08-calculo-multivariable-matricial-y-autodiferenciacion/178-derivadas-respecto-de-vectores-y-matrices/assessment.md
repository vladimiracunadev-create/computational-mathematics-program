# Evaluación — Derivadas respecto de vectores y matrices
...
| Implementación y verificación | 25 % | ejecuta `vector_matrix_derivatives`, interpreta sus salidas y comprueba al menos un invariante |
