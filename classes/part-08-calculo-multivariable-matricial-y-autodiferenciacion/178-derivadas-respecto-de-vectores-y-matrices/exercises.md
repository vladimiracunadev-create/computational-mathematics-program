# Ejercicios — Derivadas respecto de vectores y matrices

## Básico

1. Define **Derivadas respecto de vectores y matrices** con tus palabras y da un ejemplo válido y uno inválido.
