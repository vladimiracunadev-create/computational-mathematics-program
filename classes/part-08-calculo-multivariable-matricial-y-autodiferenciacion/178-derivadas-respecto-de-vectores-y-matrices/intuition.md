# Intuición — Derivadas respecto de vectores y matrices

## La pregunta antes de la fórmula

¿Qué problema resuelve **Derivadas respecto de vectores y matrices**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `vector_matrix_derivatives`: gradiente de una pérdida cuadrática respecto de los pesos.
