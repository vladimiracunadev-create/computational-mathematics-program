# Teoría — Derivadas respecto de vectores y matrices

## Definición operativa

En esta clase, **Derivadas respecto de vectores y matrices** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`vector_matrix_derivatives`) devuelve 7 valores. Varios de ellos
