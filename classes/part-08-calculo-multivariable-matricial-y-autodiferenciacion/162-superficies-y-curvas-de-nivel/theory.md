# Teoría — Superficies y curvas de nivel

## Definición operativa

En esta clase, **Superficies y curvas de nivel** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`level_curves`) devuelve 7 valores. Varios de ellos
