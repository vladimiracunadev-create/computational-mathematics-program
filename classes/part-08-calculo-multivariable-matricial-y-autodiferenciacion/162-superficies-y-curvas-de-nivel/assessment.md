# Evaluación — Superficies y curvas de nivel
...
| Implementación y verificación | 25 % | ejecuta `level_curves`, interpreta sus salidas y comprueba al menos un invariante |
