# Derivación y razonamiento — Superficies y curvas de nivel
...
Construye una derivación de 5 a 10 pasos relacionada con **Superficies y curvas de nivel**.
...
La demostración `level_curves` recorre este mismo razonamiento en código.
