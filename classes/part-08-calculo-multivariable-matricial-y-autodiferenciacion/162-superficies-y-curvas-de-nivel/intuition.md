# Intuición — Superficies y curvas de nivel

## La pregunta antes de la fórmula

¿Qué problema resuelve **Superficies y curvas de nivel**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `level_curves`: curvas de nivel: dónde la función vale lo mismo.
