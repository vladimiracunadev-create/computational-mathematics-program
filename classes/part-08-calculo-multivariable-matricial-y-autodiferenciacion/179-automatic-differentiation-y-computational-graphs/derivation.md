# Derivación y razonamiento — Automatic differentiation y computational graphs
...
Construye una derivación de 5 a 10 pasos relacionada con **Automatic differentiation y computational graphs**.
...
La demostración `autodiff` recorre este mismo razonamiento en código.
