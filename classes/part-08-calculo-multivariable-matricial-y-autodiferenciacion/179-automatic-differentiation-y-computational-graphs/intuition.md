# Intuición — Automatic differentiation y computational graphs

## La pregunta antes de la fórmula

¿Qué problema resuelve **Automatic differentiation y computational graphs**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `autodiff`: autodiferenciación en modo reverso sobre el grafo de cómputo.
