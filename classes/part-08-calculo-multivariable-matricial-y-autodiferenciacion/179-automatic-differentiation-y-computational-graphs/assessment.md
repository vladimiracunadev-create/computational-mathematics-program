# Evaluación — Automatic differentiation y computational graphs
...
| Implementación y verificación | 25 % | ejecuta `autodiff`, interpreta sus salidas y comprueba al menos un invariante |
