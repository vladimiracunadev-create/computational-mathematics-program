"""Laboratorio 179 — Automatic differentiation y computational graphs.

Parte 08 · Cálculo multivariable, matricial y autodiferenciación
Motor: computational_math.engines.part08 · demostración `autodiff`
...
def main() -> dict:
    ...
    print(f"Clase 179 — Automatic differentiation y computational graphs")
