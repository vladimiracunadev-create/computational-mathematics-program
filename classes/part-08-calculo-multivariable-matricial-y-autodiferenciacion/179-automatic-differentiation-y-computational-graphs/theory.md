# Teoría — Automatic differentiation y computational graphs

## Definición operativa

En esta clase, **Automatic differentiation y computational graphs** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`autodiff`) devuelve 9 valores. Varios de ellos
