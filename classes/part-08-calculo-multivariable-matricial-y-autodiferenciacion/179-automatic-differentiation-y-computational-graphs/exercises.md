# Ejercicios — Automatic differentiation y computational graphs

## Básico

1. Define **Automatic differentiation y computational graphs** con tus palabras y da un ejemplo válido y uno inválido.
