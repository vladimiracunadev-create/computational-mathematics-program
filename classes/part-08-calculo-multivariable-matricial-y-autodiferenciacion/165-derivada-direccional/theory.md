# Teoría — Derivada direccional

## Definición operativa

En esta clase, **Derivada direccional** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`directional_derivative`) devuelve 6 valores. Varios de ellos
