...
**Motor:** `computational_math.engines.part08` · demostración `directional_derivative`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `directional_derivative` del motor de la parte.
...
- `maxima_posible`
- `minima_posible`
- `nula_en_direccion_perpendicular`
