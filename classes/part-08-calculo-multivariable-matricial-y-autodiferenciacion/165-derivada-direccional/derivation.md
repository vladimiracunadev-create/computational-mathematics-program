# Derivación y razonamiento — Derivada direccional
...
Construye una derivación de 5 a 10 pasos relacionada con **Derivada direccional**.
...
La demostración `directional_derivative` recorre este mismo razonamiento en código.
