# Evaluación — Derivada direccional
...
| Implementación y verificación | 25 % | ejecuta `directional_derivative`, interpreta sus salidas y comprueba al menos un invariante |
