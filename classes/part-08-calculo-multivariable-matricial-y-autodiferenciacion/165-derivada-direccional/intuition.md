# Intuición — Derivada direccional

## La pregunta antes de la fórmula

¿Qué problema resuelve **Derivada direccional**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `directional_derivative`: derivada direccional como proyección del gradiente.
