# Derivación y razonamiento — Gradiente
...
Construye una derivación de 5 a 10 pasos relacionada con **Gradiente**.
...
La demostración `gradient` recorre este mismo razonamiento en código.
