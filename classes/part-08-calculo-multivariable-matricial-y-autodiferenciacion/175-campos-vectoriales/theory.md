# Teoría — Campos vectoriales

## Definición operativa

En esta clase, **Campos vectoriales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`vector_fields`) devuelve 6 valores. Varios de ellos
