# Intuición — Campos vectoriales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Campos vectoriales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `vector_fields`: campo vectorial, líneas de flujo y campo conservativo.
