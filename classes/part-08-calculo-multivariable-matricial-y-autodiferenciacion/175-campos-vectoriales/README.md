...
**Motor:** `computational_math.engines.part08` · demostración `vector_fields`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `vector_fields` del motor de la parte.
...
- `campo_conservativo`
- `valores_G`
- `F_es_perpendicular_al_radio`
- `G_deriva_de_un_potencial`
