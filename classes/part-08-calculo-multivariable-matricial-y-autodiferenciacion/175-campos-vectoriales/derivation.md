# Derivación y razonamiento — Campos vectoriales
...
Construye una derivación de 5 a 10 pasos relacionada con **Campos vectoriales**.
...
La demostración `vector_fields` recorre este mismo razonamiento en código.
