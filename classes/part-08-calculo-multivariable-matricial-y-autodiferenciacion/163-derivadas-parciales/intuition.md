# Intuición — Derivadas parciales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Derivadas parciales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `partial_derivatives`: derivadas parciales: mover una variable congelando el resto.
