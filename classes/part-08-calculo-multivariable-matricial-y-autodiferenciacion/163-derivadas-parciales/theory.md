# Teoría — Derivadas parciales

## Definición operativa

En esta clase, **Derivadas parciales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`partial_derivatives`) devuelve 7 valores. Varios de ellos
