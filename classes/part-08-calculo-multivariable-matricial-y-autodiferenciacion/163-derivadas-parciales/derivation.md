# Derivación y razonamiento — Derivadas parciales
...
Construye una derivación de 5 a 10 pasos relacionada con **Derivadas parciales**.
...
La demostración `partial_derivatives` recorre este mismo razonamiento en código.
