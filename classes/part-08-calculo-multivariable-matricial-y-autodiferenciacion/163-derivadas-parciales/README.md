...
**Motor:** `computational_math.engines.part08` · demostración `partial_derivatives`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `partial_derivatives` del motor de la parte.
