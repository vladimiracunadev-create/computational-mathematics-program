# Intuición — Regla de la cadena multivariable

## La pregunta antes de la fórmula

¿Qué problema resuelve **Regla de la cadena multivariable**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `multivariable_chain_rule`: regla de la cadena con variables intermedias.
