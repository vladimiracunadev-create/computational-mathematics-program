# Teoría — Regla de la cadena multivariable

## Definición operativa

En esta clase, **Regla de la cadena multivariable** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`multivariable_chain_rule`) devuelve 6 valores. Varios de ellos
