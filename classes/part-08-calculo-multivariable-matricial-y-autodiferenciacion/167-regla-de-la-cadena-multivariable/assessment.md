# Evaluación — Regla de la cadena multivariable
...
| Implementación y verificación | 25 % | ejecuta `multivariable_chain_rule`, interpreta sus salidas y comprueba al menos un invariante |
