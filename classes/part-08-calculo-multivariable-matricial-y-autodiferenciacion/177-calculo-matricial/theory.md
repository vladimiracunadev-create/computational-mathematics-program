# Teoría — Cálculo matricial

## Definición operativa

En esta clase, **Cálculo matricial** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`matrix_calculus`) devuelve 6 valores. Varios de ellos
