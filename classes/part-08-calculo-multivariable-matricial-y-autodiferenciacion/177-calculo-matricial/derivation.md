# Derivación y razonamiento — Cálculo matricial
...
Construye una derivación de 5 a 10 pasos relacionada con **Cálculo matricial**.
...
La demostración `matrix_calculus` recorre este mismo razonamiento en código.
