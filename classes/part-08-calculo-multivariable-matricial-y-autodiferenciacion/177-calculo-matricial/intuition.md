# Intuición — Cálculo matricial

## La pregunta antes de la fórmula

¿Qué problema resuelve **Cálculo matricial**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `matrix_calculus`: identidades básicas de cálculo matricial.
