...
**Motor:** `computational_math.engines.part08` · demostración `matrix_calculus`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `matrix_calculus` del motor de la parte.
