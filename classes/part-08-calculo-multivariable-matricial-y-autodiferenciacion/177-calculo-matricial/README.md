...
- [Petersen & Pedersen. *The Matrix Cookbook*, 2012](https://www.math.uwaterloo.ca/~hwolkowi/matrixcookbook.pdf) — Cálculo multivariable y matricial: el tema de esta clase · URL de la fuente primaria comprobada en www.math.uwaterloo.ca (2026-08-19).
- [Magnus & Neudecker. *Matrix Differential Calculus*, 3ª ed., Wiley, 2019](https://www.wiley.com/en-us/Matrix+Differential+Calculus+with+Applications+in+Statistics+and+Econometrics%2C+3rd+Edition-p-9781119541202) — Cálculo multivariable y matricial: el tema de esta clase · ISBN-13 `9781119541202` verificado en International ISBN Agency (2026-08-19).
