...
- [Chung, F. *Spectral Graph Theory*. AMS, 1997](https://mathweb.ucsd.edu/~fan/research/revised.html) — Álgebra lineal y Grafos y redes: conexión declarada de esta parte · URL de la fuente primaria, pendiente de resolver.
