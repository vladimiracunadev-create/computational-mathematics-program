# Teoría — Divergencia y rotacional

## Definición operativa

En esta clase, **Divergencia y rotacional** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`divergence_curl`) devuelve 8 valores. Varios de ellos
