# Derivación y razonamiento — Divergencia y rotacional
...
Construye una derivación de 5 a 10 pasos relacionada con **Divergencia y rotacional**.
...
La demostración `divergence_curl` recorre este mismo razonamiento en código.
