# Intuición — Divergencia y rotacional

## La pregunta antes de la fórmula

¿Qué problema resuelve **Divergencia y rotacional**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `divergence_curl`: divergencia y rotacional calculados numéricamente.
