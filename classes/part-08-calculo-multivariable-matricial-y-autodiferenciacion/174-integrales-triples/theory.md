# Teoría — Integrales triples

## Definición operativa

En esta clase, **Integrales triples** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`triple_integrals`) devuelve 8 valores. Varios de ellos
