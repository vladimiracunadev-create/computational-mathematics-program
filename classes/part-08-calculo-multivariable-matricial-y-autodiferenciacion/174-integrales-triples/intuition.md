# Intuición — Integrales triples

## La pregunta antes de la fórmula

¿Qué problema resuelve **Integrales triples**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `triple_integrals`: volumen y masa de un cubo con densidad variable.
