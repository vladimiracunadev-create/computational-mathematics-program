...
- [Bishop, C. *Pattern Recognition and Machine Learning*. Springer, 2006, cap. 2](https://www.microsoft.com/en-us/research/publication/pattern-recognition-machine-learning/) — Inferencia bayesiana y Machine learning y Probabilidad: conexión declarada de esta parte · URL de la fuente primaria comprobada en www.microsoft.com (2026-08-19).
