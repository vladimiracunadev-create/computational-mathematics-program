...
**Motor:** `computational_math.engines.part08` · demostración `triple_integrals`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `triple_integrals` del motor de la parte.
