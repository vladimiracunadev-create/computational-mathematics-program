# Intuición — Capstone: backpropagation manual y automática

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: backpropagation manual y automática**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Cálculo multivariable, matricial y autodiferenciación**. Derivadas parciales, gradiente, Jacobiano, Hessiano, Taylor multivariable, multiplicadores de Lagrange, cálculo matricial y autodiferenciación.
...
El laboratorio ejecuta `capstone_backpropagation`: capstone: backpropagation manual y automática sobre la misma red.
