"""Laboratorio 180 — Capstone: backpropagation manual y automática.

Parte 08 · Cálculo multivariable, matricial y autodiferenciación
Motor: computational_math.engines.part08 · demostración `capstone_backpropagation`
...
DEMO = "capstone_backpropagation"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 180 — Capstone: backpropagation manual y automática")
