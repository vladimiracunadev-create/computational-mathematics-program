...
- [PyTorch: `torch.autograd.gradcheck`](https://pytorch.org/docs/stable/generated/torch.autograd.gradcheck.html) — Diferenciación automática: el tema de esta clase · URL de la fuente primaria, pendiente de resolver.
