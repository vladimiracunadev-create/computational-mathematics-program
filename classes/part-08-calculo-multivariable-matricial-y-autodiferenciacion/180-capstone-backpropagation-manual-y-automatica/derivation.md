# Derivación y razonamiento — Capstone: backpropagation manual y automática
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: backpropagation manual y automática**.
...
La demostración `capstone_backpropagation` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part08.py` y responde:
