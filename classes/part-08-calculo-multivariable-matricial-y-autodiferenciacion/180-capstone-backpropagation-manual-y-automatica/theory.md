# Teoría — Capstone: backpropagation manual y automática

## Definición operativa

En esta clase, **Capstone: backpropagation manual y automática** se trata como un objeto con tres capas
separadas:
...
## Ideas centrales de la parte 08
...
ningún paso quede oculto. En la práctica profesional se usa: math, numpy (opcional), jax/torch (opcional).
...
El laboratorio (`capstone_backpropagation`) devuelve 9 valores. Varios de ellos
