# Ejercicios — Capstone: backpropagation manual y automática

## Básico

1. Define **Capstone: backpropagation manual y automática** con tus palabras y da un ejemplo válido y uno inválido.
