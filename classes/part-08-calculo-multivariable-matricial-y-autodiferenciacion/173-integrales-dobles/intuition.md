# Intuición — Integrales dobles

## La pregunta antes de la fórmula

¿Qué problema resuelve **Integrales dobles**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `double_integrals`: integral doble sobre un rectángulo por suma de riemann.
