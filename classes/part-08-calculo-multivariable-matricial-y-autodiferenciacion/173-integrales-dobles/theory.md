# Teoría — Integrales dobles

## Definición operativa

En esta clase, **Integrales dobles** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`double_integrals`) devuelve 7 valores. Varios de ellos
