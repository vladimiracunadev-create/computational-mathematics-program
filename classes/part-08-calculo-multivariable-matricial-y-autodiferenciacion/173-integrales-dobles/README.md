...
**Motor:** `computational_math.engines.part08` · demostración `double_integrals`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `double_integrals` del motor de la parte.
