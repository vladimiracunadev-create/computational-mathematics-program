# Derivación y razonamiento — Integrales dobles
...
Construye una derivación de 5 a 10 pasos relacionada con **Integrales dobles**.
...
La demostración `double_integrals` recorre este mismo razonamiento en código.
