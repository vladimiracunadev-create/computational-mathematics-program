# Derivación y razonamiento — Hessiano
...
Construye una derivación de 5 a 10 pasos relacionada con **Hessiano**.
...
La demostración `hessian` recorre este mismo razonamiento en código.
