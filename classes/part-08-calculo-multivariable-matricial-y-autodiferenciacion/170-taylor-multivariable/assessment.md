# Evaluación — Taylor multivariable
...
| Implementación y verificación | 25 % | ejecuta `multivariable_taylor`, interpreta sus salidas y comprueba al menos un invariante |
