# Intuición — Taylor multivariable

## La pregunta antes de la fórmula

¿Qué problema resuelve **Taylor multivariable**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `multivariable_taylor`: taylor de segundo orden en dos variables.
