# Teoría — Taylor multivariable

## Definición operativa

En esta clase, **Taylor multivariable** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`multivariable_taylor`) devuelve 8 valores. Varios de ellos
