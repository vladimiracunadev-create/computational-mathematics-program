...
Esta clase enseña **Cálculo multivariable y matricial · Métodos numéricos**. Cada obra dice qué aporta aquí y cómo se comprobó su localizador:

- [Nocedal & Wright. *Numerical Optimization*, 2ª ed., Springer, 2006, cap. 2](https://link.springer.com/book/10.1007/978-0-387-40065-5) — Métodos numéricos: el tema de esta clase · ISBN-13 `9780387400655` verificado en International ISBN Agency (2026-08-19).
- [Boyd & Vandenberghe. *Convex Optimization*. Cambridge, 2004](https://web.stanford.edu/~boyd/cvxbook/) — Optimización: conexión declarada de esta parte · ISBN-13 `9780511804441` verificado en International ISBN Agency (2026-08-19).
