# Derivación y razonamiento — Jacobiano
...
Construye una derivación de 5 a 10 pasos relacionada con **Jacobiano**.
...
La demostración `jacobian` recorre este mismo razonamiento en código.
