...
**Motor:** `computational_math.engines.part08` · demostración `jacobian`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `jacobian` del motor de la parte.
