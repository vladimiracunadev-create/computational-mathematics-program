# Teoría — Desigualdades lineales

## Definición operativa

En esta clase, **Desigualdades lineales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_inequality`) devuelve 6 valores. Varios de ellos
