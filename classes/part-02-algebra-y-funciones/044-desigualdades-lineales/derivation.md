# Derivación y razonamiento — Desigualdades lineales
...
Construye una derivación de 5 a 10 pasos relacionada con **Desigualdades lineales**.
...
La demostración `linear_inequality` recorre este mismo razonamiento en código.
