# Intuición — Desigualdades lineales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Desigualdades lineales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_inequality`: multiplicar por un negativo invierte el sentido de la desigualdad.
