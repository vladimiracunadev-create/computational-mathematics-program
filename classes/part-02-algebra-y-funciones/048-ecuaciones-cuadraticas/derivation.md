# Derivación y razonamiento — Ecuaciones cuadráticas
...
Construye una derivación de 5 a 10 pasos relacionada con **Ecuaciones cuadráticas**.
...
La demostración `quadratic_equation` recorre este mismo razonamiento en código.
