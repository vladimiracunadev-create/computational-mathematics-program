# Evaluación — Ecuaciones cuadráticas
...
| Implementación y verificación | 25 % | ejecuta `quadratic_equation`, interpreta sus salidas y comprueba al menos un invariante |
