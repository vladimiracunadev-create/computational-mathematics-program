# Intuición — Ecuaciones cuadráticas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Ecuaciones cuadráticas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `quadratic_equation`: resolver una cuadrática y contrastar con la forma de vértice.
