# Teoría — Capstone: construir y comparar modelos funcionales

## Definición operativa

En esta clase, **Capstone: construir y comparar modelos funcionales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`capstone_model_fitting`) devuelve 7 valores. Varios de ellos
