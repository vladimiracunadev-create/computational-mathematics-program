# Ejercicios — Capstone: construir y comparar modelos funcionales

## Básico

1. Define **Capstone: construir y comparar modelos funcionales** con tus palabras y da un ejemplo válido y uno inválido.
...
4. Ejecuta `lab.py` y explica qué comprueba cada una de sus 7 salidas.
...
7. Conecta esta clase con modelado de crecimiento, escalas logarítmicas, tarificación y diseño de features mediante un caso concreto y realista.
