# Evaluación — Capstone: construir y comparar modelos funcionales
...
| Implementación y verificación | 25 % | ejecuta `capstone_model_fitting`, interpreta sus salidas y comprueba al menos un invariante |
| Interpretación y comunicación | 15 % | explica el resultado, su error y su tolerancia |
| Conexión con aplicación real | 10 % | vincula la clase con modelado de crecimiento o con IA |
...
5. ¿Dónde aparece este concepto en modelado de crecimiento?
