"""Laboratorio 060 — Capstone: construir y comparar modelos funcionales.
...
DEMO = "capstone_model_fitting"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 060 — Capstone: construir y comparar modelos funcionales")
