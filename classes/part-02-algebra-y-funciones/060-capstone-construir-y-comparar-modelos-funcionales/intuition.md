# Intuición — Capstone: construir y comparar modelos funcionales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Capstone: construir y comparar modelos funcionales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `capstone_model_fitting`: capstone: ¿lineal, cuadrático o exponencial? decidir con residuos.
