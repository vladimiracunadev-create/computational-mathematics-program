...
- [Hastie, Tibshirani & Friedman. *The Elements of Statistical Learning*, 2ª ed., Springer, 2009](https://hastie.su.domains/ElemStatLearn/) — Estadística e inferencia y Machine learning: conexión declarada de esta parte · ISBN-13 `9780387848570` verificado en International ISBN Agency (2026-08-19).
