# Derivación y razonamiento — Capstone: construir y comparar modelos funcionales
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: construir y comparar modelos funcionales**.
...
La demostración `capstone_model_fitting` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part02.py` y responde:
