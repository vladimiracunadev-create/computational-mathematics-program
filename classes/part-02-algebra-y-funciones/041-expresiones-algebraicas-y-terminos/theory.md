# Teoría — Expresiones algebraicas y términos

## Definición operativa

En esta clase, **Expresiones algebraicas y términos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`algebraic_terms`) devuelve 7 valores. Varios de ellos
