# Intuición — Expresiones algebraicas y términos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Expresiones algebraicas y términos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `algebraic_terms`: términos semejantes y evaluación de una expresión.
