# Derivación y razonamiento — Expresiones algebraicas y términos
...
Construye una derivación de 5 a 10 pasos relacionada con **Expresiones algebraicas y términos**.
...
La demostración `algebraic_terms` recorre este mismo razonamiento en código.
