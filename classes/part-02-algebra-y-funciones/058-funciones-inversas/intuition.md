# Intuición — Funciones inversas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones inversas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `inverse_function`: inversa frente a recíproco: dos objetos distintos.
