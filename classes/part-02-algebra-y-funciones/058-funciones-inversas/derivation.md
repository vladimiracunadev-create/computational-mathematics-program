# Derivación y razonamiento — Funciones inversas
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones inversas**.
...
La demostración `inverse_function` recorre este mismo razonamiento en código.
