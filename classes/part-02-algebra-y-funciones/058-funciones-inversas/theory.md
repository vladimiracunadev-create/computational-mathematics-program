# Teoría — Funciones inversas

## Definición operativa

En esta clase, **Funciones inversas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`inverse_function`) devuelve 8 valores. Varios de ellos
