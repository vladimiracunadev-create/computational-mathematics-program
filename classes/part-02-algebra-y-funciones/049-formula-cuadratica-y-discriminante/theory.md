# Teoría — Fórmula cuadrática y discriminante

## Definición operativa

En esta clase, **Fórmula cuadrática y discriminante** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`discriminant`) devuelve 3 valores. Varios de ellos
