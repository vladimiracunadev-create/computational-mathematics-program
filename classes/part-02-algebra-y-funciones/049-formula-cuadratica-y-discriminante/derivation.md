# Derivación y razonamiento — Fórmula cuadrática y discriminante
...
Construye una derivación de 5 a 10 pasos relacionada con **Fórmula cuadrática y discriminante**.
...
La demostración `discriminant` recorre este mismo razonamiento en código.
