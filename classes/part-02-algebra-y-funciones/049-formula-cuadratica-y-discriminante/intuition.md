# Intuición — Fórmula cuadrática y discriminante

## La pregunta antes de la fórmula

¿Qué problema resuelve **Fórmula cuadrática y discriminante**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `discriminant`: el discriminante clasifica las raíces antes de calcularlas.
