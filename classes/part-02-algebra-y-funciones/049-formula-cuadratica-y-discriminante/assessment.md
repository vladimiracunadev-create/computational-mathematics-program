# Evaluación — Fórmula cuadrática y discriminante
...
| Implementación y verificación | 25 % | ejecuta `discriminant`, interpreta sus salidas y comprueba al menos un invariante |
