# Intuición — Polinomios y operaciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **Polinomios y operaciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `polynomial_ops`: suma, producto y evaluación de polinomios por horner.
