# Teoría — Polinomios y operaciones

## Definición operativa

En esta clase, **Polinomios y operaciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`polynomial_ops`) devuelve 8 valores. Varios de ellos
