# Intuición — Composición de funciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **Composición de funciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `function_composition`: (g∘f) no es (f∘g): la composición no conmuta.
