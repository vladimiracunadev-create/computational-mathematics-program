# Teoría — Composición de funciones

## Definición operativa

En esta clase, **Composición de funciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`function_composition`) devuelve 7 valores. Varios de ellos
