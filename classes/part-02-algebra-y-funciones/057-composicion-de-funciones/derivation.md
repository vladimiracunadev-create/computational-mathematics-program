# Derivación y razonamiento — Composición de funciones
...
Construye una derivación de 5 a 10 pasos relacionada con **Composición de funciones**.
...
La demostración `function_composition` recorre este mismo razonamiento en código.
