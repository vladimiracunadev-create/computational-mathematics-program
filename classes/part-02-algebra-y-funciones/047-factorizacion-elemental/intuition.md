# Intuición — Factorización elemental

## La pregunta antes de la fórmula

¿Qué problema resuelve **Factorización elemental**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `factoring`: factorizar x² - 3x + 2 y comprobar las raíces.
