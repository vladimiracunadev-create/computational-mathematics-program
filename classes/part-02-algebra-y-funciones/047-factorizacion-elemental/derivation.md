# Derivación y razonamiento — Factorización elemental
...
Construye una derivación de 5 a 10 pasos relacionada con **Factorización elemental**.
...
La demostración `factoring` recorre este mismo razonamiento en código.
