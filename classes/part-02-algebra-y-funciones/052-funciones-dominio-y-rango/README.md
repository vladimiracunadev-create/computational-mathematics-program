...
- [Spivak, M. *Calculus*, 4ª ed., 2008, cap. 3](https://www.mathpop.com/calculus) — Análisis matemático y Cálculo: conexión declarada de esta parte · ISBN-13 `9780914098911` verificado en International ISBN Agency (2026-08-19).
- [Gelfand, Glagoleva & Shnol. *Functions and Graphs*. Dover, 2002](https://store.doverpublications.com/products/9780486425641) — Álgebra y funciones: el tema de esta clase · ISBN-13 `9780486425641` verificado en International ISBN Agency (2026-08-19).
