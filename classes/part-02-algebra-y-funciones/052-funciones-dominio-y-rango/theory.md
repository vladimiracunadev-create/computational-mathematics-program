# Teoría — Funciones: dominio y rango

## Definición operativa

En esta clase, **Funciones: dominio y rango** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`domain_range`) devuelve 7 valores. Varios de ellos
