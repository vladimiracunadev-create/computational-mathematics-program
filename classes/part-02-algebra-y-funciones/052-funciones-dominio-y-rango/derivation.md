# Derivación y razonamiento — Funciones: dominio y rango
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones: dominio y rango**.
...
La demostración `domain_range` recorre este mismo razonamiento en código.
