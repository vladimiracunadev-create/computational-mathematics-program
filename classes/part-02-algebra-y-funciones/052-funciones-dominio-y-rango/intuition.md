# Intuición — Funciones: dominio y rango

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones: dominio y rango**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `domain_range`: el dominio forma parte de la definición de la función.
