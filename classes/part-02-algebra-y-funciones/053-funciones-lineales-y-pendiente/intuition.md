# Intuición — Funciones lineales y pendiente

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones lineales y pendiente**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_function`: pendiente como razón de cambio constante.
