# Derivación y razonamiento — Funciones lineales y pendiente
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones lineales y pendiente**.
...
La demostración `linear_function` recorre este mismo razonamiento en código.
