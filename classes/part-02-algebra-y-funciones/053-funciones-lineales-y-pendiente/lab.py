"""Laboratorio 053 — Funciones lineales y pendiente.

Parte 02 · Álgebra y funciones
Motor: computational_math.engines.part02 · demostración `linear_function`
...
from computational_math.engines import part02 as motor  # noqa: E402

DEMO = "linear_function"


def main() -> dict:
    """Ejecuta la demostración de la clase y muestra sus resultados."""
    resultado = motor.DEMOS[DEMO]()
    print(f"Clase 053 — Funciones lineales y pendiente")
    print(f"Parte 02 · Álgebra y funciones")
