# Teoría — Funciones lineales y pendiente

## Definición operativa

En esta clase, **Funciones lineales y pendiente** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_function`) devuelve 6 valores. Varios de ellos
