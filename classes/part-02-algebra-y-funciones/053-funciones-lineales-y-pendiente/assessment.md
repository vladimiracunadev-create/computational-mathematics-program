# Evaluación — Funciones lineales y pendiente
...
| Implementación y verificación | 25 % | ejecuta `linear_function`, interpreta sus salidas y comprueba al menos un invariante |
