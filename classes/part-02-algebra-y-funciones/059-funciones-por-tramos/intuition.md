# Intuición — Funciones por tramos

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones por tramos**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `piecewise_function`: una función por tramos y su continuidad en el punto de corte.
