# Derivación y razonamiento — Funciones por tramos
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones por tramos**.
...
La demostración `piecewise_function` recorre este mismo razonamiento en código.
