# Teoría — Funciones por tramos

## Definición operativa

En esta clase, **Funciones por tramos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`piecewise_function`) devuelve 8 valores. Varios de ellos
