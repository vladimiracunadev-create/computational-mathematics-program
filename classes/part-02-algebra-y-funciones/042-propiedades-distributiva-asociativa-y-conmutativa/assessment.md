# Evaluación — Propiedades distributiva, asociativa y conmutativa
...
| Implementación y verificación | 25 % | ejecuta `algebra_properties`, interpreta sus salidas y comprueba al menos un invariante |
