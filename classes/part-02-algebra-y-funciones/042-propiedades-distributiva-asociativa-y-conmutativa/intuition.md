# Intuición — Propiedades distributiva, asociativa y conmutativa

## La pregunta antes de la fórmula

¿Qué problema resuelve **Propiedades distributiva, asociativa y conmutativa**? Describe, sin símbolos, qué entra,
...
Esta clase pertenece a **Álgebra y funciones**. Manipulación simbólica con criterio y la función como objeto central: dominio, imagen, composición, inversa y familias lineal, cuadrática, exponencial y logarítmica.
...
El laboratorio ejecuta `algebra_properties`: conmutativa, asociativa y distributiva: válidas en ℝ, no siempre en float.
