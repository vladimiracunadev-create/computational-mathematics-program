# Teoría — Propiedades distributiva, asociativa y conmutativa

## Definición operativa

En esta clase, **Propiedades distributiva, asociativa y conmutativa** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`algebra_properties`) devuelve 6 valores. Varios de ellos
