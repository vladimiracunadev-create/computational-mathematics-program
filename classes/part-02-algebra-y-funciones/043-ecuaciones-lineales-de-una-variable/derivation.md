# Derivación y razonamiento — Ecuaciones lineales de una variable
...
Construye una derivación de 5 a 10 pasos relacionada con **Ecuaciones lineales de una variable**.
...
La demostración `linear_equation` recorre este mismo razonamiento en código.
