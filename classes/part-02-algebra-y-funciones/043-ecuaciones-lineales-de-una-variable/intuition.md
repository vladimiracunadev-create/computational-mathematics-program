# Intuición — Ecuaciones lineales de una variable

## La pregunta antes de la fórmula

¿Qué problema resuelve **Ecuaciones lineales de una variable**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `linear_equation`: resolver ax + b = c y verificar el residuo.
