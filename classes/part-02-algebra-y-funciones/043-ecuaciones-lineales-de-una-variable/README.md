...
**Motor:** `computational_math.engines.part02` · demostración `linear_equation`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `linear_equation` del motor de la parte.
