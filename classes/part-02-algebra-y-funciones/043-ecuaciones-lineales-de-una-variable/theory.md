# Teoría — Ecuaciones lineales de una variable

## Definición operativa

En esta clase, **Ecuaciones lineales de una variable** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`linear_equation`) devuelve 6 valores. Varios de ellos
