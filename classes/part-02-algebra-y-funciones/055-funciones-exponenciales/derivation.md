# Derivación y razonamiento — Funciones exponenciales
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones exponenciales**.
...
La demostración `exponential_function` recorre este mismo razonamiento en código.
