# Evaluación — Funciones exponenciales
...
| Implementación y verificación | 25 % | ejecuta `exponential_function`, interpreta sus salidas y comprueba al menos un invariante |
