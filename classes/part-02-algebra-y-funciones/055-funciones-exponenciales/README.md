...
- [Bartlett, A. *Arithmetic, Population and Energy* (conferencia sobre crecimiento exponencial)](https://www.albartlett.org/presentations/arithmetic_population_energy.html) — Álgebra y funciones: el tema de esta clase · URL de la fuente primaria comprobada en www.albartlett.org (2026-08-19).
