...
3. Ejecutar y modificar `lab.py`, que corre la demostración `exponential_function` del motor de la parte.
...
- `modelo`
- `valores`
- `razon_entre_años_consecutivos`
- `tiempo_de_duplicacion`
- `regla_del_72_aproximada`
