# Teoría — Funciones exponenciales

## Definición operativa

En esta clase, **Funciones exponenciales** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`exponential_function`) devuelve 5 valores. Varios de ellos
