# Intuición — Funciones exponenciales

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones exponenciales**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `exponential_function`: crecimiento exponencial: razón constante, no diferencia constante.
