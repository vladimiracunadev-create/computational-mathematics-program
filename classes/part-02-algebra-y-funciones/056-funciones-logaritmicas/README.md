...
3. Ejecutar y modificar `lab.py`, que corre la demostración `logarithmic_function` del motor de la parte.
...
- `10^3`
- `inversa_verificada`
- `escala_decibel_de_1e-3`
- `crecimiento_de_log_entre_1e3_y_1e6`
- `dominio`
