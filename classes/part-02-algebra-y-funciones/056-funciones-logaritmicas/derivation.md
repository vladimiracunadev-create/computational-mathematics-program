# Derivación y razonamiento — Funciones logarítmicas
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones logarítmicas**.
...
La demostración `logarithmic_function` recorre este mismo razonamiento en código.
