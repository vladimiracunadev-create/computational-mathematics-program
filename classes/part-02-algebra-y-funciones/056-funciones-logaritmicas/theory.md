# Teoría — Funciones logarítmicas

## Definición operativa

En esta clase, **Funciones logarítmicas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`logarithmic_function`) devuelve 6 valores. Varios de ellos
