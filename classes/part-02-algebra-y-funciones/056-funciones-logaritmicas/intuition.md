# Intuición — Funciones logarítmicas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones logarítmicas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `logarithmic_function`: el logaritmo como inversa de la exponencial y como escala.
