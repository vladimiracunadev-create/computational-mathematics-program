# Derivación y razonamiento — Funciones cuadráticas y parábolas
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones cuadráticas y parábolas**.
...
La demostración `quadratic_function` recorre este mismo razonamiento en código.
