# Evaluación — Funciones cuadráticas y parábolas
...
| Implementación y verificación | 25 % | ejecuta `quadratic_function`, interpreta sus salidas y comprueba al menos un invariante |
