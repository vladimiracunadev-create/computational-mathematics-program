# Teoría — Funciones cuadráticas y parábolas

## Definición operativa

En esta clase, **Funciones cuadráticas y parábolas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`quadratic_function`) devuelve 8 valores. Varios de ellos
