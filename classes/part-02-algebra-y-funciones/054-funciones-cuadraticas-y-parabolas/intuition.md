# Intuición — Funciones cuadráticas y parábolas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones cuadráticas y parábolas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `quadratic_function`: vértice, eje de simetría y concavidad.
