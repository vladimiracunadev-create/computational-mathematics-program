# Evaluación — Exponentes algebraicos
...
| Implementación y verificación | 25 % | ejecuta `algebraic_exponents`, interpreta sus salidas y comprueba al menos un invariante |
