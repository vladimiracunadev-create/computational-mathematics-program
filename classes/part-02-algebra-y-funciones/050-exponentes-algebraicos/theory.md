# Teoría — Exponentes algebraicos

## Definición operativa

En esta clase, **Exponentes algebraicos** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`algebraic_exponents`) devuelve 7 valores. Varios de ellos
