# Derivación y razonamiento — Exponentes algebraicos
...
Construye una derivación de 5 a 10 pasos relacionada con **Exponentes algebraicos**.
...
La demostración `algebraic_exponents` recorre este mismo razonamiento en código.
