...
**Motor:** `computational_math.engines.part02` · demostración `system_2x2`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `system_2x2` del motor de la parte.
