# Teoría — Sistemas de ecuaciones 2x2

## Definición operativa

En esta clase, **Sistemas de ecuaciones 2x2** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`system_2x2`) devuelve 7 valores. Varios de ellos
