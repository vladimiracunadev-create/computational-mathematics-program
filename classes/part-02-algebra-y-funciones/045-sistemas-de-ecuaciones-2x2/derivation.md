# Derivación y razonamiento — Sistemas de ecuaciones 2x2
...
Construye una derivación de 5 a 10 pasos relacionada con **Sistemas de ecuaciones 2x2**.
...
La demostración `system_2x2` recorre este mismo razonamiento en código.
