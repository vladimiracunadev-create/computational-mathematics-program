# Intuición — Sistemas de ecuaciones 2x2

## La pregunta antes de la fórmula

¿Qué problema resuelve **Sistemas de ecuaciones 2x2**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `system_2x2`: sistema 2x2 por determinantes (regla de cramer) y verificación.
