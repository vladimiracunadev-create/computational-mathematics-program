# Evaluación — Logaritmos y sus propiedades
...
| Implementación y verificación | 25 % | ejecuta `logarithm_laws`, interpreta sus salidas y comprueba al menos un invariante |
