# Teoría — Logaritmos y sus propiedades

## Definición operativa

En esta clase, **Logaritmos y sus propiedades** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`logarithm_laws`) devuelve 9 valores. Varios de ellos
