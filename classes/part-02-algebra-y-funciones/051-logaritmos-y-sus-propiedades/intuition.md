# Intuición — Logaritmos y sus propiedades

## La pregunta antes de la fórmula

¿Qué problema resuelve **Logaritmos y sus propiedades**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `logarithm_laws`: las tres leyes del logaritmo verificadas numéricamente.
