...
**Motor:** `computational_math.engines.part04` · demostración `permutations_demo`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `permutations_demo` del motor de la parte.
