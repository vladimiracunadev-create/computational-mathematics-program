# Teoría — Permutaciones

## Definición operativa

En esta clase, **Permutaciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`permutations_demo`) devuelve 6 valores. Varios de ellos
