# Intuición — Permutaciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **Permutaciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `permutations_demo`: permutaciones: el orden importa.
