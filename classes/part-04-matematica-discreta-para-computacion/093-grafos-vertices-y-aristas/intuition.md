# Intuición — Grafos: vértices y aristas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Grafos: vértices y aristas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `graphs`: grados, aristas y el lema del apretón de manos.
