...
**Motor:** `computational_math.engines.part04` · demostración `graphs`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `graphs` del motor de la parte.
...
- `aristas_dirigidas`
- `suma_de_grados`
- `lema_apreton_de_manos_no_dirigido`
- `densidad`
