# Derivación y razonamiento — Grafos: vértices y aristas
...
Construye una derivación de 5 a 10 pasos relacionada con **Grafos: vértices y aristas**.
...
La demostración `graphs` recorre este mismo razonamiento en código.
