# Teoría — Grafos: vértices y aristas

## Definición operativa

En esta clase, **Grafos: vértices y aristas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`graphs`) devuelve 6 valores. Varios de ellos
