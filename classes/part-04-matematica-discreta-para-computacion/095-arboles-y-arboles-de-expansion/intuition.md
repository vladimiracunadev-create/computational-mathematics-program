# Intuición — Árboles y árboles de expansión

## La pregunta antes de la fórmula

¿Qué problema resuelve **Árboles y árboles de expansión**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `trees`: un árbol con n nodos tiene exactamente n-1 aristas.
