# Teoría — Árboles y árboles de expansión

## Definición operativa

En esta clase, **Árboles y árboles de expansión** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`trees`) devuelve 7 valores. Varios de ellos
