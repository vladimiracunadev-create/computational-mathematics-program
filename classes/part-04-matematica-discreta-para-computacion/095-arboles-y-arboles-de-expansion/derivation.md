# Derivación y razonamiento — Árboles y árboles de expansión
...
Construye una derivación de 5 a 10 pasos relacionada con **Árboles y árboles de expansión**.
...
La demostración `trees` recorre este mismo razonamiento en código.
