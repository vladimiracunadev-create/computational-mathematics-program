# Intuición — DAG y orden topológico

## La pregunta antes de la fórmula

¿Qué problema resuelve **DAG y orden topológico**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `topological_order`: orden topológico y detección de ciclos por conteo de kahn.
