# Derivación y razonamiento — DAG y orden topológico
...
Construye una derivación de 5 a 10 pasos relacionada con **DAG y orden topológico**.
...
La demostración `topological_order` recorre este mismo razonamiento en código.
