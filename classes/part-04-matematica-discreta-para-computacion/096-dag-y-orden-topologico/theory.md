# Teoría — DAG y orden topológico

## Definición operativa

En esta clase, **DAG y orden topológico** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`topological_order`) devuelve 6 valores. Varios de ellos
