# Derivación y razonamiento — Caminos, ciclos y conectividad
...
Construye una derivación de 5 a 10 pasos relacionada con **Caminos, ciclos y conectividad**.
...
La demostración `paths_connectivity` recorre este mismo razonamiento en código.
