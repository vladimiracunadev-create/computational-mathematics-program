# Teoría — Caminos, ciclos y conectividad

## Definición operativa

En esta clase, **Caminos, ciclos y conectividad** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`paths_connectivity`) devuelve 6 valores. Varios de ellos
