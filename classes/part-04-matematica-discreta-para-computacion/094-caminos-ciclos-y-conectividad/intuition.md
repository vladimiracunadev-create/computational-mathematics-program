# Intuición — Caminos, ciclos y conectividad

## La pregunta antes de la fórmula

¿Qué problema resuelve **Caminos, ciclos y conectividad**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `paths_connectivity`: recorrido bfs: alcanzabilidad y distancia en aristas.
