# Evaluación — Caminos, ciclos y conectividad
...
| Implementación y verificación | 25 % | ejecuta `paths_connectivity`, interpreta sus salidas y comprueba al menos un invariante |
