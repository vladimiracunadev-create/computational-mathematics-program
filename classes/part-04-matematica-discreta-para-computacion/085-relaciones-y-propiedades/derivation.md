# Derivación y razonamiento — Relaciones y propiedades
...
Construye una derivación de 5 a 10 pasos relacionada con **Relaciones y propiedades**.
...
La demostración `relations` recorre este mismo razonamiento en código.
