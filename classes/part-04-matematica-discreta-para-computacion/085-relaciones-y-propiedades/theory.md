# Teoría — Relaciones y propiedades

## Definición operativa

En esta clase, **Relaciones y propiedades** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`relations`) devuelve 7 valores. Varios de ellos
