# Intuición — Relaciones y propiedades

## La pregunta antes de la fórmula

¿Qué problema resuelve **Relaciones y propiedades**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `relations`: reflexiva, simétrica y transitiva: la receta de una relación de equivalencia.
