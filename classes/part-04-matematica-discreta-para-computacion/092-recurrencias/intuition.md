# Intuición — Recurrencias

## La pregunta antes de la fórmula

¿Qué problema resuelve **Recurrencias**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `recurrences`: recurrencia lineal: iterativo, memoizado y forma cerrada.
