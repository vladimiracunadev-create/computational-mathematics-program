...
**Motor:** `computational_math.engines.part04` · demostración `recurrences`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `recurrences` del motor de la parte.
