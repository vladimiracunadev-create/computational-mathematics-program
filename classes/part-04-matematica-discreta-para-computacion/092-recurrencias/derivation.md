# Derivación y razonamiento — Recurrencias
...
Construye una derivación de 5 a 10 pasos relacionada con **Recurrencias**.
...
La demostración `recurrences` recorre este mismo razonamiento en código.
