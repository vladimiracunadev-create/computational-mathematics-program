# Derivación y razonamiento — Lógica proposicional
...
Construye una derivación de 5 a 10 pasos relacionada con **Lógica proposicional**.
...
La demostración `propositional_logic` recorre este mismo razonamiento en código.
