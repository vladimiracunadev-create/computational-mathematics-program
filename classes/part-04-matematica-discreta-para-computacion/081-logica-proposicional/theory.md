# Teoría — Lógica proposicional

## Definición operativa

En esta clase, **Lógica proposicional** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`propositional_logic`) devuelve 4 valores. Varios de ellos
