# Intuición — Lógica proposicional

## La pregunta antes de la fórmula

¿Qué problema resuelve **Lógica proposicional**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `propositional_logic`: implicación, contrarrecíproca y recíproca no son lo mismo.
