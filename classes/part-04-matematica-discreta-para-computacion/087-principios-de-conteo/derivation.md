# Derivación y razonamiento — Principios de conteo
...
Construye una derivación de 5 a 10 pasos relacionada con **Principios de conteo**.
...
La demostración `counting_principles` recorre este mismo razonamiento en código.
