# Teoría — Principios de conteo

## Definición operativa

En esta clase, **Principios de conteo** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`counting_principles`) devuelve 6 valores. Varios de ellos
