# Derivación y razonamiento — Combinaciones
...
Construye una derivación de 5 a 10 pasos relacionada con **Combinaciones**.
...
La demostración `combinations_demo` recorre este mismo razonamiento en código.
