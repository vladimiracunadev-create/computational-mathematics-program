# Teoría — Combinaciones

## Definición operativa

En esta clase, **Combinaciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`combinations_demo`) devuelve 7 valores. Varios de ellos
