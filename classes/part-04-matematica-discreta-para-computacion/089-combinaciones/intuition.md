# Intuición — Combinaciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **Combinaciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `combinations_demo`: combinaciones: el orden no importa.
