# Derivación y razonamiento — Capstone: modelar dependencias con grafos
...
Construye una derivación de 5 a 10 pasos relacionada con **Capstone: modelar dependencias con grafos**.
...
La demostración `capstone_dependency_graph` recorre este mismo razonamiento en código.
Después de derivarlo a mano, lee la implementación en
`src/computational_math/engines/part04.py` y responde:
