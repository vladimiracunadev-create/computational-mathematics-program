# Ejercicios — Capstone: modelar dependencias con grafos

## Básico

1. Define **Capstone: modelar dependencias con grafos** con tus palabras y da un ejemplo válido y uno inválido.
