# Teoría — Tablas de verdad y equivalencias

## Definición operativa

En esta clase, **Tablas de verdad y equivalencias** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`truth_tables`) devuelve 6 valores. Varios de ellos
