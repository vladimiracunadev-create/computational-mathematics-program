# Derivación y razonamiento — Tablas de verdad y equivalencias
...
Construye una derivación de 5 a 10 pasos relacionada con **Tablas de verdad y equivalencias**.
...
La demostración `truth_tables` recorre este mismo razonamiento en código.
