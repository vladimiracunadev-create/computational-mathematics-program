# Evaluación — Tablas de verdad y equivalencias
...
| Implementación y verificación | 25 % | ejecuta `truth_tables`, interpreta sus salidas y comprueba al menos un invariante |
