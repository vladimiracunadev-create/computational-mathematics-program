# Intuición — Tablas de verdad y equivalencias

## La pregunta antes de la fórmula

¿Qué problema resuelve **Tablas de verdad y equivalencias**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `truth_tables`: leyes de de morgan verificadas exhaustivamente.
