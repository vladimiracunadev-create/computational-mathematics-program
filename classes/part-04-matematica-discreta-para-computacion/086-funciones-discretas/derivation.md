# Derivación y razonamiento — Funciones discretas
...
Construye una derivación de 5 a 10 pasos relacionada con **Funciones discretas**.
...
La demostración `discrete_functions` recorre este mismo razonamiento en código.
