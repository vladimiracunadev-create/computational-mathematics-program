# Intuición — Funciones discretas

## La pregunta antes de la fórmula

¿Qué problema resuelve **Funciones discretas**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `discrete_functions`: inyectiva, sobreyectiva y biyectiva sobre conjuntos finitos.
