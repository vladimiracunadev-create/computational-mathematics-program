...
**Motor:** `computational_math.engines.part04` · demostración `discrete_functions`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `discrete_functions` del motor de la parte.
...
- `g`
- `g_inyectiva`
- `funciones_totales_posibles`
- `biyecciones_posibles`
