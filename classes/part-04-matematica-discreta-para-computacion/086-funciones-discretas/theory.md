# Teoría — Funciones discretas

## Definición operativa

En esta clase, **Funciones discretas** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`discrete_functions`) devuelve 8 valores. Varios de ellos
