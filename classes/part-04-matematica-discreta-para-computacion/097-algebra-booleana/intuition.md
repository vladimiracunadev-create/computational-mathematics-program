# Intuición — Álgebra booleana

## La pregunta antes de la fórmula

¿Qué problema resuelve **Álgebra booleana**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `boolean_algebra`: álgebra booleana: simplificación y equivalencia funcional.
