# Teoría — Álgebra booleana

## Definición operativa

En esta clase, **Álgebra booleana** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`boolean_algebra`) devuelve 6 valores. Varios de ellos
