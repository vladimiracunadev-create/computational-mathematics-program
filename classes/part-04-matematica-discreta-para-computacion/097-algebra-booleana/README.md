...
**Motor:** `computational_math.engines.part04` · demostración `boolean_algebra`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `boolean_algebra` del motor de la parte.
