# Derivación y razonamiento — Álgebra booleana
...
Construye una derivación de 5 a 10 pasos relacionada con **Álgebra booleana**.
...
La demostración `boolean_algebra` recorre este mismo razonamiento en código.
