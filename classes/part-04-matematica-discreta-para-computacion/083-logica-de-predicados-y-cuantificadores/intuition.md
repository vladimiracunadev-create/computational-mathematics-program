# Intuición — Lógica de predicados y cuantificadores

## La pregunta antes de la fórmula

¿Qué problema resuelve **Lógica de predicados y cuantificadores**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `predicate_logic`: cuantificadores: el orden cambia el significado.
