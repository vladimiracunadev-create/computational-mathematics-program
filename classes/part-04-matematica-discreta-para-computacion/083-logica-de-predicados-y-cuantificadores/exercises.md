# Ejercicios — Lógica de predicados y cuantificadores

## Básico

1. Define **Lógica de predicados y cuantificadores** con tus palabras y da un ejemplo válido y uno inválido.
...
7. Conecta esta clase con algoritmos, bases de datos, criptografía, compiladores y planificación de dependencias mediante un caso concreto y realista.
