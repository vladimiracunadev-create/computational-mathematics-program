# Evaluación — Lógica de predicados y cuantificadores
...
| Implementación y verificación | 25 % | ejecuta `predicate_logic`, interpreta sus salidas y comprueba al menos un invariante |
