# Derivación y razonamiento — Lógica de predicados y cuantificadores
...
Construye una derivación de 5 a 10 pasos relacionada con **Lógica de predicados y cuantificadores**.
...
La demostración `predicate_logic` recorre este mismo razonamiento en código.
