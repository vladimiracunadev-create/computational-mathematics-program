# Teoría — Lógica de predicados y cuantificadores

## Definición operativa

En esta clase, **Lógica de predicados y cuantificadores** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`predicate_logic`) devuelve 7 valores. Varios de ellos
