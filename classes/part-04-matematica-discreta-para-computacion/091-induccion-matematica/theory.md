# Teoría — Inducción matemática

## Definición operativa

En esta clase, **Inducción matemática** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`induction`) devuelve 6 valores. Varios de ellos
