# Derivación y razonamiento — Inducción matemática
...
Construye una derivación de 5 a 10 pasos relacionada con **Inducción matemática**.
...
La demostración `induction` recorre este mismo razonamiento en código.
