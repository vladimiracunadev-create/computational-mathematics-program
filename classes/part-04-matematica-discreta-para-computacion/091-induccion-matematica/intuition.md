# Intuición — Inducción matemática

## La pregunta antes de la fórmula

¿Qué problema resuelve **Inducción matemática**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `induction`: inducción: caso base, paso inductivo y verificación empírica.
