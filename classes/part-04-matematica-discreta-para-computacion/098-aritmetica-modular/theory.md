# Teoría — Aritmética modular

## Definición operativa

En esta clase, **Aritmética modular** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`modular_arithmetic`) devuelve 6 valores. Varios de ellos
