# Derivación y razonamiento — Aritmética modular
...
Construye una derivación de 5 a 10 pasos relacionada con **Aritmética modular**.
...
La demostración `modular_arithmetic` recorre este mismo razonamiento en código.
