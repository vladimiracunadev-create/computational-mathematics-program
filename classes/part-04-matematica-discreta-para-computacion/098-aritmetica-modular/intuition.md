# Intuición — Aritmética modular

## La pregunta antes de la fórmula

¿Qué problema resuelve **Aritmética modular**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `modular_arithmetic`: aritmética modular: exponenciación rápida e inverso modular.
