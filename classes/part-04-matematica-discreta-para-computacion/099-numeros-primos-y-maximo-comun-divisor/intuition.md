# Intuición — Números primos y máximo común divisor

## La pregunta antes de la fórmula

¿Qué problema resuelve **Números primos y máximo común divisor**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `primes_gcd`: criba, mcd por euclides y su relación con el mínimo común múltiplo.
