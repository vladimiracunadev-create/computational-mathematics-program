# Evaluación — Números primos y máximo común divisor
...
| Implementación y verificación | 25 % | ejecuta `primes_gcd`, interpreta sus salidas y comprueba al menos un invariante |
