# Derivación y razonamiento — Números primos y máximo común divisor
...
Construye una derivación de 5 a 10 pasos relacionada con **Números primos y máximo común divisor**.
...
La demostración `primes_gcd` recorre este mismo razonamiento en código.
