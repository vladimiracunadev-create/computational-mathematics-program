# Teoría — Números primos y máximo común divisor

## Definición operativa

En esta clase, **Números primos y máximo común divisor** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`primes_gcd`) devuelve 8 valores. Varios de ellos
