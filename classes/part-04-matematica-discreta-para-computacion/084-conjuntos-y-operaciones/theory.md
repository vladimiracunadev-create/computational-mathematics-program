# Teoría — Conjuntos y operaciones

## Definición operativa

En esta clase, **Conjuntos y operaciones** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`sets`) devuelve 10 valores. Varios de ellos
