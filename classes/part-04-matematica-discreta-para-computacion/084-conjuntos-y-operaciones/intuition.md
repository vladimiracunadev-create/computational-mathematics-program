# Intuición — Conjuntos y operaciones

## La pregunta antes de la fórmula

¿Qué problema resuelve **Conjuntos y operaciones**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `sets`: operaciones de conjuntos e inclusión-exclusión.
