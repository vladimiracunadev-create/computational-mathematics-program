...
**Motor:** `computational_math.engines.part04` · demostración `sets`
...
3. Ejecutar y modificar `lab.py`, que corre la demostración `sets` del motor de la parte.
