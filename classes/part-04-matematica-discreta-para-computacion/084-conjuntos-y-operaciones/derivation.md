# Derivación y razonamiento — Conjuntos y operaciones
...
Construye una derivación de 5 a 10 pasos relacionada con **Conjuntos y operaciones**.
...
La demostración `sets` recorre este mismo razonamiento en código.
