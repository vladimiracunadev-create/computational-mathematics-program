# Teoría — Principio del palomar

## Definición operativa

En esta clase, **Principio del palomar** se trata como un objeto con tres capas
separadas:
...
El laboratorio (`pigeonhole`) devuelve 8 valores. Varios de ellos
