# Intuición — Principio del palomar

## La pregunta antes de la fórmula

¿Qué problema resuelve **Principio del palomar**? Describe, sin símbolos, qué entra,
...
El laboratorio ejecuta `pigeonhole`: principio del palomar: colisiones garantizadas sin construirlas.
