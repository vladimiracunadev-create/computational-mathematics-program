# Derivación y razonamiento — Principio del palomar
...
Construye una derivación de 5 a 10 pasos relacionada con **Principio del palomar**.
...
La demostración `pigeonhole` recorre este mismo razonamiento en código.
