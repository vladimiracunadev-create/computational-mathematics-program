...
Toda la redacción de este programa es original. Estas obras son las referencias
primarias de cada parte: aparecen en las 360 clases generadas y son la vía para la
profundidad formal que el programa declara **no** cubrir.
...
| Situación | Qué leer |
|---|---|
| La clase te resultó demasiado rápida | el capítulo correspondiente del primer título de la parte |
| Necesitas la demostración formal | el segundo o tercer título: son los de mayor rigor |
| Vas a implementar en producción | Higham (parte 01), Golub & Van Loan (06), Press (11), Nocedal & Wright (12) |
| Vas a leer papers | los papers citados en las partes 12, 15, 16 y 17 |

## Papers citados directamente

Las partes 12 y 15–17 citan artículos concretos porque su contenido **es** ese artículo:

- Loshchilov, I.; Hutter, F. *Decoupled Weight Decay Regularization*. ICLR, 2019. — clase 251
- Glorot, X.; Bengio, Y. *Understanding the difficulty of training deep feedforward neural networks*. AISTATS, 2010. — clase 307
- He, K. et al. *Delving Deep into Rectifiers*. ICCV, 2015. — clase 307
- Vaswani, A. et al. *Attention Is All You Need*. NeurIPS, 2017. — clases 325–328
- Kingma, D.; Welling, M. *Auto-Encoding Variational Bayes*. ICLR, 2014. — clases 331–332
- Ho, J.; Jain, A.; Abbeel, P. *Denoising Diffusion Probabilistic Models*. NeurIPS, 2020. — clases 334–335
- Kipf, T.; Welling, M. *Semi-Supervised Classification with Graph Convolutional Networks*. ICLR, 2017. — clase 337
- Cuturi, M. *Sinkhorn Distances: Lightspeed Computation of Optimal Transport*. NIPS, 2013. — clases 346 y 360
- Chen, R. T. Q. et al. *Neural Ordinary Differential Equations*. NeurIPS, 2018. — clase 352
- Hyvärinen, A. *Estimation of Non-Normalized Statistical Models by Score Matching*. JMLR, 2005. — clase 353
- Song, Y.; Ermon, S. *Generative Modeling by Estimating Gradients of the Data Distribution*. NeurIPS, 2019. — clase 353

## Aviso de licencia

Ninguna de estas obras se reproduce ni se resume extensamente en este repositorio. Se
citan como referencia y mantienen sus propias licencias y derechos.
